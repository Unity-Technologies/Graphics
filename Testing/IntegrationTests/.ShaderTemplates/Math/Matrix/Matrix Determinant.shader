	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_MatrixDeterminant_float(float3x3 In, out float Out)
					        {
					            Out = determinant(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float4x4 _MatrixConstruction_76AA618D_4x4;
								float3x3 _MatrixConstruction_76AA618D_3x3;
								float2x2 _MatrixConstruction_76AA618D_2x2;
								Unity_MatrixConstruction_float(float4 (1558,-128,144,2), float4 (28,-2,12,0), float4 (366,62,28,0), float4 (-52,0,0,0), _MatrixConstruction_76AA618D_4x4, _MatrixConstruction_76AA618D_3x3, _MatrixConstruction_76AA618D_2x2);
								
								float _MatrixDeterminant_4F0444DE_Out;
								Unity_MatrixDeterminant_float(_MatrixConstruction_76AA618D_3x3, _MatrixDeterminant_4F0444DE_Out);
								surface.Color = (_MatrixDeterminant_4F0444DE_Out.xxx);
								surface.Alpha = 1;
