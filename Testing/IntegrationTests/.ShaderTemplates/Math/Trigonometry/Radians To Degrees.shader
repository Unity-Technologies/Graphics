		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _RadiansToDegrees_ECF76F79_Out;
								Unity_RadiansToDegrees_float3(_Vector3_9D54CA82_Out, _RadiansToDegrees_ECF76F79_Out);
								surface.Color = _RadiansToDegrees_ECF76F79_Out;
								surface.Alpha = 1;
