	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_HyperbolicTangent_float3(float3 In, out float3 Out)
					        {
					            Out = tanh(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_9D54CA82_Out = float3(-74,18,22);
								float3 _HyperbolicTangent_25729C95_Out;
								Unity_HyperbolicTangent_float3(_Vector3_9D54CA82_Out, _HyperbolicTangent_25729C95_Out);
								surface.Color = _HyperbolicTangent_25729C95_Out;
								surface.Alpha = 1;
