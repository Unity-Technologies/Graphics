	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_Cosine_float3(float3 In, out float3 Out)
					        {
					            Out = cos(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_9D54CA82_Out = float3(-74,144,184);
								float3 _Cosine_847FCFE3_Out;
								Unity_Cosine_float3(_Vector3_9D54CA82_Out, _Cosine_847FCFE3_Out);
								surface.Color = _Cosine_847FCFE3_Out;
								surface.Alpha = 1;
