	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_HyperbolicCosine_float3(float3 In, out float3 Out)
					        {
					            Out = sinh(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _HyperbolicCosine_D8E02875_Out;
								Unity_HyperbolicCosine_float3(_Vector3_9D54CA82_Out, _HyperbolicCosine_D8E02875_Out);
								surface.Color = _HyperbolicCosine_D8E02875_Out;
								surface.Alpha = 1;
