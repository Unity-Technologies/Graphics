	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_Arccosine_float3(float3 In, out float3 Out)
					        {
					            Out = acos(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_9D54CA82_Out = float3(-16,122,14);
								float3 _Arccosine_CA001029_Out;
								Unity_Arccosine_float3(_Vector3_9D54CA82_Out, _Arccosine_CA001029_Out);
								surface.Color = _Arccosine_CA001029_Out;
								surface.Alpha = 1;
