	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_Arctangent_float3(float3 In, out float3 Out)
					        {
					            Out = atan(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Arctangent_53375180_Out;
								Unity_Arctangent_float3(_Vector3_9D54CA82_Out, _Arctangent_53375180_Out);
								surface.Color = _Arctangent_53375180_Out;
								surface.Alpha = 1;
