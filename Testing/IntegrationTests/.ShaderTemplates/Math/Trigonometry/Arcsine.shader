	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_Arcsine_float3(float3 In, out float3 Out)
					        {
					            Out = asin(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Arcsine_5B71B284_Out;
								Unity_Arcsine_float3(_Vector3_9D54CA82_Out, _Arcsine_5B71B284_Out);
								surface.Color = _Arcsine_5B71B284_Out;
								surface.Alpha = 1;
