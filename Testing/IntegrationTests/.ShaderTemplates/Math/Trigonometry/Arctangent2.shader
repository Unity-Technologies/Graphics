		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Arctangent2_DA4793BA_Out;
								Unity_Arctangent2_float3(_Vector3_9D54CA82_Out, float3(0, 0, 0), _Arctangent2_DA4793BA_Out);
								surface.Color = _Arctangent2_DA4793BA_Out;
								surface.Alpha = 1;
