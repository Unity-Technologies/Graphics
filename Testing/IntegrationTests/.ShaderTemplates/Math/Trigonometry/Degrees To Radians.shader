		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_9D54CA82_Out = float3(214,118,274);
								float3 _DegreesToRadians_D1934F8A_Out;
								Unity_DegreesToRadians_float3(_Vector3_9D54CA82_Out, _DegreesToRadians_D1934F8A_Out);
								surface.Color = _DegreesToRadians_D1934F8A_Out;
								surface.Alpha = 1;
