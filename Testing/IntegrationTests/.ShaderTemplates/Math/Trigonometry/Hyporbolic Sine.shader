	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_HyperbolicSine_float3(float3 In, out float3 Out)
					        {
					            Out = sinh(In);
					        }
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _HyperbolicSine_1A498A62_Out;
								Unity_HyperbolicSine_float3(_Vector3_9D54CA82_Out, _HyperbolicSine_1A498A62_Out);
								surface.Color = _HyperbolicSine_1A498A62_Out;
								surface.Alpha = 1;
