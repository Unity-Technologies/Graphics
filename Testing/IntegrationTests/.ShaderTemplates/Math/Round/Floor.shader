		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_D6EB005F_Out = float3(4,11,108);
								float3 _Floor_851E33B9_Out;
								Unity_Floor_float3(_Vector3_D6EB005F_Out, _Floor_851E33B9_Out);
								surface.Color = _Floor_851E33B9_Out;
								surface.Alpha = 1;
