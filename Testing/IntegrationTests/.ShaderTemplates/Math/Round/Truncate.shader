		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_496DBE23_Out = float3(116,1,58);
								float3 _Truncate_27965AD5_Out;
								Unity_Truncate_float3(_Vector3_496DBE23_Out, _Truncate_27965AD5_Out);
								surface.Color = _Truncate_27965AD5_Out;
								surface.Alpha = 1;
