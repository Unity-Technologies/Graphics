		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_F5ACDE78_Out = float3(5,62,64);
								float3 _Round_80F41B5F_Out;
								Unity_Round_float3(_Vector3_F5ACDE78_Out, _Round_80F41B5F_Out);
								surface.Color = _Round_80F41B5F_Out;
								surface.Alpha = 1;
