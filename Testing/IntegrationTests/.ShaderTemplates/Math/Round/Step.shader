		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_8EDDB8B7_Out = float3(-74,18,22);
								float3 _Step_42A47E49_Out;
								Unity_Step_float3(_Vector3_8EDDB8B7_Out, float3(0, 0, 0), _Step_42A47E49_Out);
								surface.Color = _Step_42A47E49_Out;
								surface.Alpha = 1;
