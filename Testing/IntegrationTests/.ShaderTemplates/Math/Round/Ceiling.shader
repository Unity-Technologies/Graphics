		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_C2925460_Out = float3(-74,18,22);
								float3 _Ceiling_6F778D41_Out;
								Unity_Ceiling_float3(_Vector3_C2925460_Out, _Ceiling_6F778D41_Out);
								surface.Color = _Ceiling_6F778D41_Out;
								surface.Alpha = 1;
