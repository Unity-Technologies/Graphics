		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_4C025D41_Out = float3(3,42,118);
								float _RandomRange_1473128A_Out;
								Unity_RandomRange_float(float2 (36,142), 4, (_Vector3_4C025D41_Out).x, _RandomRange_1473128A_Out);
								surface.Color = (_RandomRange_1473128A_Out.xxx);
								surface.Alpha = 1;
