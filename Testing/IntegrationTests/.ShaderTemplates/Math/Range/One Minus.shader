		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_1A95935C_Out = float3(22,42,118);
								float3 _OneMinus_A595FD47_Out;
								Unity_OneMinus_float3(_Vector3_1A95935C_Out, _OneMinus_A595FD47_Out);
								surface.Color = _OneMinus_A595FD47_Out;
								surface.Alpha = 1;
