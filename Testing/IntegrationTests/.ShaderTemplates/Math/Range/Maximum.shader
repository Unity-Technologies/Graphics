		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_3BAA9EB0_Out = float3(3,42,118);
								float3 _Maximum_C38461A7_Out;
								Unity_Maximum_float3(_Vector3_3BAA9EB0_Out, float3(0, 0, 0), _Maximum_C38461A7_Out);
								surface.Color = _Maximum_C38461A7_Out;
								surface.Alpha = 1;
