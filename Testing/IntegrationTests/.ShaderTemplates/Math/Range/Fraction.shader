		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_D09F8887_Out = float3(3,42,118);
								float3 _Fraction_9DAB0DB0_Out;
								Unity_Fraction_float3(_Vector3_D09F8887_Out, _Fraction_9DAB0DB0_Out);
								surface.Color = _Fraction_9DAB0DB0_Out;
								surface.Alpha = 1;
