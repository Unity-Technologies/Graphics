		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_C50B41AA_Out = float3(3,42,118);
								float3 _Minimum_27307B3D_Out;
								Unity_Minimum_float3(_Vector3_C50B41AA_Out, float3(1, 1, 1), _Minimum_27307B3D_Out);
								surface.Color = _Minimum_27307B3D_Out;
								surface.Alpha = 1;
