		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_979868F5_Out = float3(3,9,118);
								float3 _Saturate_92495AF8_Out;
								Unity_Saturate_float3(_Vector3_979868F5_Out, _Saturate_92495AF8_Out);
								surface.Color = _Saturate_92495AF8_Out;
								surface.Alpha = 1;
