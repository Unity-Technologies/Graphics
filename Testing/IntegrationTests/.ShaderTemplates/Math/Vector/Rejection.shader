	...
	SubShader
	{
		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
					        ...
					        void Unity_Rejection_float3(float3 A, float3 B, out float3 Out)
					        {
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_E6BCC763_Out = float3(66,72,36);
								float3 _Vector3_77A9EB86_Out = float3(36,2,74);
								float3 _Rejection_29B614B0_Out;
								Unity_Rejection_float3(_Vector3_E6BCC763_Out, _Vector3_77A9EB86_Out, _Rejection_29B614B0_Out);
								surface.Color = _Rejection_29B614B0_Out;
								surface.Alpha = 1;
