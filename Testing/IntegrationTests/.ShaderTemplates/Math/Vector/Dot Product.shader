		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_7CF64269_Out = float3(32,-18,-22);
								float3 _Vector3_AB09DF12_Out = float3(62,54,-1);
								float _DotProduct_43CE9D17_Out;
								Unity_DotProduct_float3(_Vector3_7CF64269_Out, _Vector3_AB09DF12_Out, _DotProduct_43CE9D17_Out);
								surface.Color = (_DotProduct_43CE9D17_Out.xxx);
								surface.Alpha = 1;
