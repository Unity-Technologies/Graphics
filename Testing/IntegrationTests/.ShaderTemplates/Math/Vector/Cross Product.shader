		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_9D54CA82_Out = float3(32,72,22);
								float3 _Vector3_F03190BF_Out = float3(-74,18,22);
								float3 _CrossProduct_ED3D0D23_Out;
								Unity_CrossProduct_float(_Vector3_9D54CA82_Out, _Vector3_F03190BF_Out, _CrossProduct_ED3D0D23_Out);
								surface.Color = _CrossProduct_ED3D0D23_Out;
								surface.Alpha = 1;
