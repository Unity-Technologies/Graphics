		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_27C20335_Out = float3(66,72,36);
								float3 _Vector3_6D383D40_Out = float3(36,2,74);
								float3 _Projection_B98700BC_Out;
								Unity_Projection_float3(_Vector3_27C20335_Out, _Vector3_6D383D40_Out, _Projection_B98700BC_Out);
								surface.Color = _Projection_B98700BC_Out;
								surface.Alpha = 1;
