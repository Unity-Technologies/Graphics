		...
		Pass
		{
		    ...
		    #include "ShaderGraphLibrary/Functions.hlsl"
							...
							SurfaceDescription PopulateSurfaceData(SurfaceInputs IN) {
								...
								float3 _Vector3_EF54EA3C_Out = float3(66,72,36);
								float3 _Transform_F1D918FF_Out = TransformObjectToWorld(_Vector3_EF54EA3C_Out.xyz);
								surface.Color = _Transform_F1D918FF_Out;
								surface.Alpha = 1;
