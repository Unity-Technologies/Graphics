...
namespace UnityEditor.LightBaking.Tests
{
    ...
    internal class InputExtractionMaterials
    {
        ...
        private static readonly MetaPassSceneTest[] metaPassTests = {
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "default", MetaPassType = MetaPassType.Albedo, TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "default", MetaPassType = MetaPassType.Emission, TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "emissive", MetaPassType = MetaPassType.Emission, TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedo", MetaPassType = MetaPassType.Albedo, TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "emissiveTex", MetaPassType = MetaPassType.Emission, TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedoTex", MetaPassType = MetaPassType.Albedo , TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedoTexTriplanarWorldSpace", MetaPassType = MetaPassType.Albedo , TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedoTexPlanarWorldSpace", MetaPassType = MetaPassType.Albedo , TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedoTexTriplanarObjectSpace", MetaPassType = MetaPassType.Albedo , TextureCount = 13 },
            new() { SceneName = "Metapass_BasicMaterials", ObjectName = "albedoTexPlanarObjectSpace", MetaPassType = MetaPassType.Albedo , TextureCount = 13 },
        ...
        public void MetaPassTemplateTests([ValueSource(nameof(metaPassTests))]MetaPassSceneTest metaPassTest)
        {
            ...
            using LightBaker.LightmapRequests lightmapRequests = new();
            using LightBaker.LightProbeRequests probeRequests = new();
            using SourceMap map = new();
            var result = ExtractFromScene(FileUtil.LightBakerTempOutputPath, bakeInput, lightmapRequests, probeRequests, map);
