...
{
    /// <summary>
    /// This test loads the scene Tests/ShaderGraph/TestScene.unity which contains a camera aligned quad.
    /// The quad is rendered with a shader that does alpha testing specifically for the picking pass via
    ...
    /// </summary>
    /// <remarks>
    /// There is an identical unit test exists in the UniversalGraphicsTest_Foundation test project to ensure
    /// the same behavior on URP.
    /// </remarks>
    class CustomAlphaTestedPickingPass_HDRP
    {
        ...
        {
            EditorSceneManager.OpenScene("Assets/Tests/ShaderGraph/TestScene.unity", OpenSceneMode.Single);
            yield return null;
