...
namespace UnityEngine.VFX.Test
{
    public static class CustomIndexerUtilities
    {
        ...
        public static object CreateSearchDatabaseSettings(string root, string indexType, bool types, bool properties,
        ...
        public static ObjectIndexer CreateIndexer(string root, string indexType, bool types, bool properties,
            bool dependencies, bool extended, string[] includes = null)
        {
            var settings =
