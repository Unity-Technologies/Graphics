...
public class Deferred_GBuffer_Visualization_RenderFeature : ScriptableRendererFeature
{
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            ExecutePass(cmd, m_Material, renderer.cameraColorTargetHandle.referenceSize, m_ShaderKeywords);
        ...
        static void ExecutePass(CommandBuffer cmd, Material material, Vector2Int targetSize, LocalKeyword[] shaderKeywords)
        {
            if (material == null)
                return;
