Shader "Character/Subsurface"
{
	Properties
	{
		Texture_182faa0c_4b84_44f9_8526_6a2b5d1bfceb_Uniform("Albedo", 2D) = "white" {}
	Color_14397097_d99f_4fb0_84c5_307d9e0d6ea9_Uniform("Color", Color) = (1,1,1,0)
		Texture_fa598f24_b328_4d21_a9aa_ded3cd2600dd_Uniform("Normal", 2D) = "bump" {}
	Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce_Uniform("Metallic Tex", 2D) = "white" {}
	Vector1_66d312ef_3451_4b07_9f27_d37785582eb7_Uniform("Metallic", Range(0, 1)) = 1
		Vector1_d429c42e_84f9_4cd9_aeff_2b5531f4227d_Uniform("Smoothness", Range(0, 1)) = 1
		Vector1_078dba25_d724_4a74_99fe_078c8dc7ebf6_Uniform("Anisotropy", Range(0, 1)) = 0.5
		Texture_6bba204c_5a19_44ba_9609_fc2dce308020_Uniform("Thickness", 2D) = "white" {}
	Color_edaba26b_8c62_4e4c_8e17_5626c4a01b5c_Uniform("Subsurface Color", Color) = (0.5808823,0.3391033,0.1195934,0)
...
#define SHADINGMODELID_SUBSURFACE
...
#	endif
	...
	float3 SubsurfaceShadingSimple(float3 diffColor, float3 normal, float3 viewDir, float3 thickness, UnityLight light)
	{
		...
		half3 fLT = 1 * (fLTDot + 2) * (thickness);
...
#pragma debug
	...
	sampler2D Texture_182faa0c_4b84_44f9_8526_6a2b5d1bfceb_Uniform;
	float4 Color_14397097_d99f_4fb0_84c5_307d9e0d6ea9_Uniform;
	sampler2D Texture_fa598f24_b328_4d21_a9aa_ded3cd2600dd_Uniform;
	sampler2D Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce_Uniform;
	float Vector1_66d312ef_3451_4b07_9f27_d37785582eb7_Uniform;
	float Vector1_d429c42e_84f9_4cd9_aeff_2b5531f4227d_Uniform;
	float Vector1_078dba25_d724_4a74_99fe_078c8dc7ebf6_Uniform;
	sampler2D Texture_6bba204c_5a19_44ba_9609_fc2dce308020_Uniform;
	float4 Color_edaba26b_8c62_4e4c_8e17_5626c4a01b5c_Uniform;
	...
	void surf(Input IN, inout SurfaceOutputAdvanced o)
	{
		...
		float4 UV_2d892868_f0a3_42b8_a8aa_131ecb6b3b88_UV = uv0;
		float4 Texture_182faa0c_4b84_44f9_8526_6a2b5d1bfceb = tex2D(Texture_182faa0c_4b84_44f9_8526_6a2b5d1bfceb_Uniform, (UV_2d892868_f0a3_42b8_a8aa_131ecb6b3b88_UV.xy));
		float4 Multiply_24b106c6_e725_4e76_b49d_7e16a5f8b4cd_Output = unity_multiply_float(Texture_182faa0c_4b84_44f9_8526_6a2b5d1bfceb, Color_14397097_d99f_4fb0_84c5_307d9e0d6ea9_Uniform);
		float4 Texture_fa598f24_b328_4d21_a9aa_ded3cd2600dd = float4(UnpackNormal(tex2D(Texture_fa598f24_b328_4d21_a9aa_ded3cd2600dd_Uniform, uv0.xy)), 0);
		float4 Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce = tex2D(Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce_Uniform, uv0.xy);
		float Multiply_a6852a24_0a26_4dc5_a5dd_d9ebca72d7f7_Output = unity_multiply_float(Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce.r, Vector1_66d312ef_3451_4b07_9f27_d37785582eb7_Uniform);
		float Multiply_3b598945_371c_42f0_a475_8734e4082bcd_Output = unity_multiply_float(Texture_11a92303_cad4_4ed7_b9a2_01fe39187cce.a, Vector1_d429c42e_84f9_4cd9_aeff_2b5531f4227d_Uniform);
		float4 Texture_6bba204c_5a19_44ba_9609_fc2dce308020 = tex2D(Texture_6bba204c_5a19_44ba_9609_fc2dce308020_Uniform, uv0.xy);
		float4 Remap_131b45c5_4f35_4053_9b66_6a0ad4d4feca_Output = unity_remap_float(Texture_6bba204c_5a19_44ba_9609_fc2dce308020, float2 (0,1), float2 (0.05,1));
		float4 Multiply_0b13da15_eda7_44aa_a517_e6fc77a51419_Output = unity_multiply_float(Remap_131b45c5_4f35_4053_9b66_6a0ad4d4feca_Output, Color_edaba26b_8c62_4e4c_8e17_5626c4a01b5c_Uniform);
		o.Albedo = Multiply_24b106c6_e725_4e76_b49d_7e16a5f8b4cd_Output;
		o.Normal = Texture_fa598f24_b328_4d21_a9aa_ded3cd2600dd;
		o.Normal += 1e-6;
		o.Metallic = Multiply_a6852a24_0a26_4dc5_a5dd_d9ebca72d7f7_Output;
		o.Smoothness = Multiply_3b598945_371c_42f0_a475_8734e4082bcd_Output;
		o.WorldVectors = float3x3(worldSpaceTangent, worldSpaceBitangent, worldSpaceNormal);
		o.Anisotropy = Vector1_078dba25_d724_4a74_99fe_078c8dc7ebf6_Uniform;
		o.CustomData = float4(Multiply_0b13da15_eda7_44aa_a517_e6fc77a51419_Output.rgb, 0);
