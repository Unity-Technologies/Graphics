...
public static class GameViewUtils
{
    ...
    public static void SetTestGameViewSize(int width, int height)
    {
        ...
        GameViewUtils.AddCustomSize( GameViewUtils.GameViewSizeType.FixedResolution, GameViewSizeGroupType.Standalone, width, height, testGameViewSize );
