Shader "TestRenderPipeline/BasicShader"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "RenderType" = "Opaque"  "RenderPipeline" = "TestRenderPipeline" "Queue" = "Geometry" }
        LOD 100
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                return float4(result * color * _LightColor, 1.0);
            }
            ENDCG
        }
    }
