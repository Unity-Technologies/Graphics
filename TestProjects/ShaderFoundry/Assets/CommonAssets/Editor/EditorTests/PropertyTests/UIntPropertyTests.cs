...
namespace UnityEditor.ShaderFoundry.UnitTests
{
    class UIntPropertyTests : BlockTestRenderer
    {
        ...
        [UnityTest]
        public IEnumerator UIntProperty_DefaultPropertyValueUsed_IsExpectedColor()
        {
            var expectedColor = new Color(1, 0, 0, 0);

            var container = CreateContainer();
            var propBuilder = BuildWithoutNameOverrides("1");
            var block = propBuilder.Build(container, container._uint);
        ...
        [UnityTest]
        public IEnumerator UIntProperty_MaterialColorSet_IsExpectedColor()
        {
            var inputValue = 1;
        ...
        [Test]
        public void UIntProperty_NoPropertyNameOverrides_ShaderPropertiesAreValid()
        {
        ...
        [Test]
        public void UIntProperty_RangeProperty_VerifyIsIntRange()
        {
            ...
            var block = propBuilder.BuildWithAttributeOverrides(container, container._uint, attributes);
