...
#ifdef REQUEST_DISABLE_OPTIMISTIC_SCALAR_ALLOCATION
#define __XBOX_DISABLE_OPTIMISTIC_SCALAR_ALLOCATION
#endif
...
bool WaveIsFirstLane()
{
    ...
    uint2 mask = __XB_Ballot64(true) & __XB_GetEntryActiveMask64();

    return __XB_V_CNDMASK_B32(mask & -mask, uint2(0, 1));
#else
    return (__XB_MBCNT64(__XB_Ballot64(true))) == 0;
#endif
}
...
*/
#define GENERATE_INT_FLOAT_1_ARG_1_IGNORED_UINT2(FunctionName, Parameter1, FunctionBody) \
    float  FunctionName(float  Parameter1, uint2 ignored) { FunctionBody; } \
    uint   FunctionName(uint  Parameter1, uint2 ignored) { FunctionBody; } \
    int    FunctionName(int  Parameter1, uint2 ignored) { FunctionBody; } 

GENERATE_INT_FLOAT_1_ARG_1_IGNORED_UINT2(QuadReadAcrossX, value,        return __XB_LaneSwizzle(value, 32945)); // offset: 1000 0000 1011 0001
GENERATE_INT_FLOAT_1_ARG_1_IGNORED_UINT2(QuadReadAcrossY, value,        return __XB_LaneSwizzle(value, 32846)); // offset: 1000 0000 0100 1110
GENERATE_INT_FLOAT_1_ARG_1_IGNORED_UINT2(QuadReadAcrossDiagonal, value, return __XB_LaneSwizzle(value, 32795)); // offset: 1000 0000 0001 1011
