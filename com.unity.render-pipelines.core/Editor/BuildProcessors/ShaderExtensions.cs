...
namespace UnityEditor.Rendering
{
    ...
    public static class ShaderExtensions
    {
        ...
        /// <param name="shader"><see cref="Shader"/> The shader to look for the tag</param>
        /// <param name="snippetData"><see cref="ShaderSnippetData"/></param>
        /// <returns><see cref="string"/> containing the value of the tag "RenderPipeline"</returns>
        public static string GetRenderPipelineTag([DisallowNull] this Shader shader, ShaderSnippetData snippetData)
        {
            shader.TryGetRenderPipelineTag(snippetData, out string renderPipelineTag);
            return renderPipelineTag;
        }
