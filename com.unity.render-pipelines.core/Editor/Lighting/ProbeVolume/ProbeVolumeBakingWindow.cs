...
namespace UnityEngine.Rendering
{
    class ProbeVolumeBakingWindow : EditorWindow
    {
        ...
        {
            k_Foldouts.SetExpandedAreas(expandable, EditorGUILayout.Foldout(k_Foldouts.GetExpandedAreas(expandable), label, true, style ?? Styles.boldFoldout));
            return k_Foldouts.GetExpandedAreas(expandable);
        }
