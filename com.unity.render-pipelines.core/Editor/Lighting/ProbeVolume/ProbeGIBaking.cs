...
namespace UnityEngine.Rendering
{
    ...
    internal class ProbeGIBaking
    {
        ...
        public static void BakeCells(ProbeReferenceVolumeAuthoring refVolume, bool writeBakingData = true)
        {
            ...
            var CellSize = refVolume.cellSize;
            ...
            // TODO: there are too many useless cells generated by these loops
            // for (var x = -xCells; x < xCells; ++x)
            //     for (var y = -yCells; y < yCells; ++y)
            //         for (var z = -zCells; z < zCells; ++z)
            //             cellPositions.Add(new Vector3Int(x, y, z));

            cellPositions.Add(new Vector3Int(xCells - 1, yCells - 1, zCells - 2));
