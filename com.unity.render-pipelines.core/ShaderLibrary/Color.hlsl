...
real3 ApplyLut3D(TEXTURE3D(tex), SAMPLER(samplerTex), float3 uvw, float2 scaleOffset)
{    
...
real3 ApplyLut2D(TEXTURE2D(tex), SAMPLER(samplerTex), float3 uvw, float3 scaleOffset)
{
