...
namespace UnityEngine.Rendering
{
    ...
    public static class RemoveRangeExtensions
    {
        ...
        [MustUseReturnValue] public static bool TryRemoveElementsInRange<TList, TValue>([DisallowNull] this TList list, int index, int count, [NotNullWhen(false)] out Exception error)
