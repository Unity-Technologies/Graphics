...
namespace UnityEngine.Rendering
{
    public struct FrustumPlanes
    {
        ...
        public static NativeArray<PlanePacket4> BuildSOAPlanePackets(NativeArray<Plane> cullingPlanes, NativeArray<int> splitCounts, Allocator allocator)
        {
        ...
        static public uint Intersect2NoPartial(NativeArray<PlanePacket4> cullingPlanePackets, NativeArray<int> splitCounts, AABB a)
        {
