...
// TODO: Remove when breaking changes (introduced in 7.x.x)
...
namespace Utilities
{
    ...
    /// </summary>
    [Flags]
    [Obsolete("Use UnityEngine.Rendering.MaterialQuality")]
    public enum MaterialQuality
    {
        /// <summary>Low Material Quality.</summary>
        Low = 1 << 0,
    ...
    /// Material Quality utility class.
    /// </summary>
    [Obsolete("Use UnityEngine.Rendering.MaterialQualityUtilities")]
    public static class MaterialQualityUtilities
    {
        /// <summary>
        /// Keywords strings for Material Quality levels.
