...
namespace UnityEngine.Rendering
{
    ...
    public static class FSRUtils
    {
        ...
        /// <summary>
        /// AMD's FidelityFX Super Resolution integration guide recommends a value of 0.2 for the RCAS sharpness parameter when specified in exponential "stops"
        /// </summary>
        ...
        /// Sets the constant values required by the FSR RCAS shader on the provided command buffer
        ///
        /// Equivalent to SetRcasConstants(), but handles the sharpness parameter as a linear value instead of an exponential one.
