...
namespace UnityEngine.Experimental.Rendering.RenderGraphModule
{
    ...
    public struct RenderGraphBuilder : IDisposable
    {
        ...
        /// <summary>
        /// Specify that the pass should use a Texture resource as a color render target.
        ...
        /// <summary>
        /// Specify that the pass should use a Texture resource as a depth buffer.
        /// </summary>
        /// <param name="input">The Texture resource to use as a depth buffer during the pass.</param>
        /// <param name="flags">Specify the access level for the depth buffer. This allows you to say whether you can read from or write to the depth buffer, or do both.</param>
        /// <returns>An updated resource handle to the input resource</returns>
