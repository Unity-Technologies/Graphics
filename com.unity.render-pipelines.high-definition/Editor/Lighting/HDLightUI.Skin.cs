...
namespace UnityEditor.Rendering.HighDefinition
{
    partial class HDLightUI
    {
        sealed class Styles
        {
            ...
            // Layers
            public readonly GUIContent unlinkLightAndShadowLayersText = new GUIContent("Custom Shadow Layers", "When enabled, you can use the Layer property below to specify the light layers for shadows seperately to lighting. When disabled, the Light Layer property in the General section specifies the light layers for both lighting and for shadows. ");
