...
namespace UnityEditor.Rendering.HighDefinition
{
    partial class HDLightUI
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent includeLightForRayTracing = new GUIContent("Include For RayTracing", "When checked, the light will affect the scene for a camera that has the Ray-Tracing frame setting enabled.");
