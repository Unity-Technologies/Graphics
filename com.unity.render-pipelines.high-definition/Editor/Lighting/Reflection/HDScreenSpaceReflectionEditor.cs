...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDScreenSpaceReflectionEditor : VolumeComponentWithQualityEditor
    {
        ...
        static public readonly GUIContent k_BiasFactorText = EditorGUIUtility.TrTextContent("Roughness Bias Factor", "Controls the relative roughness offset. A low value means material roughness stays the same, a high value means smoother reflections.");
        static public readonly GUIContent k_SpeedRejectionFactorText = EditorGUIUtility.TrTextContent("Speed Rejection Factor", "Controls the likelihood history will be rejected based on the previous frame motion vectors. A low value favor stability over ghosting, high value can decrease ghosting but can also re-introduces noise.");
