...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDScreenSpaceReflectionEditor : VolumeComponentWithQualityEditor
    {
        ...
        static public readonly GUIContent k_SpeedSurfaceOnlyText = EditorGUIUtility.TrTextContent("Speed from reflecting surface", "When enabled, speed rejection used world space motion of the reflecting surface.");
        static public readonly GUIContent k_SpeedTargetOnlyText = EditorGUIUtility.TrTextContent("Speed from reflected surface", "When enabled, speed rejection used world space motion of the hitted surface by the SSR.");
