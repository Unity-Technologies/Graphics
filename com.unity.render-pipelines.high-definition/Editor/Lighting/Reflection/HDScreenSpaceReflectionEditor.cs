...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDScreenSpaceReflectionEditor : VolumeComponentWithQualityEditor
    {
        ...
        static public readonly GUIContent k_SpeedRejectionFactorText = EditorGUIUtility.TrTextContent("Speed Rejection Factor", "Controls the likelihood history will be rejected based on the previous frame motion vectors (both the surface and the hit object).");
