...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDScreenSpaceReflectionEditor : VolumeComponentWithQualityEditor
    {
        ...
        static public readonly GUIContent k_ReflectSkyText = EditorGUIUtility.TrTextContent("Reflect Sky", "When enabled, SSR handles sky reflection (only affects opaque objects).");
