...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDEditorUtils
    {
        ...
        static readonly Action<SerializedProperty, GUIContent> k_DefaultDrawer = (p, l) =>
        ...
        static readonly GUIContent s_OverrideTooltip =
            EditorGUIUtility.TrTextContent("", "Override this setting in component.");
            ...
            where TEnum : struct, IConvertible
        {
            ...
            {
                EditMode.SceneViewEditMode targetMode = EditMode.editMode == toolbarMode[button]
        ...
        internal static void DrawDecalLayerMask_Internal(Rect rect, GUIContent label, SerializedProperty property)
        {
            ...
            EditorGUI.BeginChangeCheck();
            int changedValue = EditorGUI.MaskField(rect, label ?? GUIContent.none, property.intValue,
                HDRenderPipelineGlobalSettings.instance.decalLayerNames);
            if (EditorGUI.EndChangeCheck())
                property.intValue = changedValue;
        ...
        internal static int DrawLightLayerMask(Rect rect, int value, GUIContent label = null)
        {
            ...
            EditorGUI.BeginChangeCheck();
            lightLayer = EditorGUI.MaskField(rect, label ?? GUIContent.none, lightLayer,
                HDRenderPipelineGlobalSettings.instance.lightLayerNames);
            if (EditorGUI.EndChangeCheck())
