...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent supportForceForwardEmissiveContent = EditorGUIUtility.TrTextContent("Force Forward Emissive", "When enabled, HDRP render the emissive contribution of Lit based Materials in a separate forward pass when the Lit Shader Mode is set to **Both** or **Deferred**.");
            public static readonly GUIContent supportForceForwardEmissive = EditorGUIUtility.TrTextContent("Force Forward Emissive", "When enabled, HDRP render the emissive contribution of Lit based Materials in a separate forward pass when the Lit Shader Mode is set to **Both** or **Deferred**.");
