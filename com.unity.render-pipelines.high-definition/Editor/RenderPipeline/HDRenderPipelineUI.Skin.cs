...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent maxProxyPlanesOnScreen = EditorGUIUtility.TrTextContent("Max Reflection Proxy Planes On Screen", "Sets the maximum number of planes for convex shaped reflection proxies HDRP can handle on screen at once.");
