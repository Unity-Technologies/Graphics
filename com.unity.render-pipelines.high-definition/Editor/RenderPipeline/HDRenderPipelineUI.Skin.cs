...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    static partial class HDRenderPipelineUI
    {
        ...
        static readonly GUIContent k_UILayerContent = EditorGUIUtility.TrTextContent("UI Layer", "Specifies the layer used for UI elements, this is needed to properly render UI to a separate render target, which is necessary for HDR outputs.");
