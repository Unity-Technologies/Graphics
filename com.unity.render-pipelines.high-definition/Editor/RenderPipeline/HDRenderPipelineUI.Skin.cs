    ...
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            public class GeneralSection
            {
                ...
                public static readonly GUIContent enableRendererListCullingContent = EditorGUIUtility.TrTextContent("Enable RendererList Culling", "When enabled, RenderGraph passes are dynamically culled based on scene visibility.");
            }
