...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent enableLowResTransparencyThreshold = EditorGUIUtility.TrTextContent("Enable Low Res Transparency Threshold", "Enable the checkbox to support Low Res Transparency Min Threshold.");
            public static readonly GUIContent lowResTransparencyMinimumThreshold = EditorGUIUtility.TrTextContent("Low Res Transparency Min Threshold", "The minimum percentage threshold allowed to support low resolution transparency. When the resolution percentage falls below this threshold, HDRP will turn off low resolution transparency.");
