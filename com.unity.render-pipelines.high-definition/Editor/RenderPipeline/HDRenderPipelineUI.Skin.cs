...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent RTAORayLength = EditorGUIUtility.TrTextContent("Ray Length");
            ...
            public static readonly GUIContent RTRMinSmoothness = EditorGUIUtility.TrTextContent("Min Smoothness");
            public static readonly GUIContent RTRSmoothnessFadeStart = EditorGUIUtility.TrTextContent("Smoothness Fade Start");
            public static readonly GUIContent RTRRayLength = EditorGUIUtility.TrTextContent("Ray Length");
            ...
            public static readonly GUIContent RTRSmoothDenoising = EditorGUIUtility.TrTextContent("Smooth Denoising");
            ...
            public static readonly GUIContent RTGIRayLength = EditorGUIUtility.TrTextContent("Ray Length");
            ...
            public static readonly GUIContent RTGISecondDenoise = EditorGUIUtility.TrTextContent("Second Denoiser");
