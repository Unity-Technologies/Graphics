...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent reflectionProbeFormatContent = EditorGUIUtility.TrTextContent("Reflection Probes Format", "Color format used for reflection probes. Keep in mind that probes are not pre-exposed when selecting the format.");
