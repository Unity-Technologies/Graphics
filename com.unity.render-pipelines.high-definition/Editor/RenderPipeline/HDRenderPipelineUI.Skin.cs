...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent maxPlanarReflectionOnScreen = EditorGUIUtility.TrTextContent("Max Planar Reflection On Screen", "Sets the maximum number of Planar Reflection HDRP can handle on screen at once.");
            public static readonly GUIContent maxProxyPlanesOnScreen = EditorGUIUtility.TrTextContent("Max Convex Reflection Probe Planes On Screen", "Sets the maximum number of planes for convex shaped influence volumes HDRP can handle on screen at once.");
