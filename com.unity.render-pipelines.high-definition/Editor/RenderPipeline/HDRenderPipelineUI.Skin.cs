...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent probeCacheFormat = EditorGUIUtility.TrTextContent("Cubemap probes format", "Color format used for reflection probe. Keep in mind that probes are not pre-exposed when selecting the format.");
