...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDRenderPipelineUI
    {
        public class Styles
        {
            ...
            public static readonly GUIContent enableLowResTransparencyThreshold = EditorGUIUtility.TrTextContent("Enable Low Res Transparency Threshold", "Toggle a threshold to turn off low res transparency when the resolution scale falls below a certain percentage.");
            public static readonly GUIContent lowResTransparencyMinimumThreshold = EditorGUIUtility.TrTextContent("Low Res Transparency Min Threshold", "When enableLowResTransparencyThreshold is enabled and the resolution percentage falls below this threshold, half res transparency is turned off.");
