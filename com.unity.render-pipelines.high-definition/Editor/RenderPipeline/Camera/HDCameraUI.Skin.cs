...
namespace UnityEditor.Rendering.HighDefinition
{
    static partial class HDCameraUI
    {
        ...
        static readonly GUIContent shutterSpeedContent = EditorGUIUtility.TrTextContent("Shutter Speed", "The amount of time the Canera sensor us capturing light.");
        ...
        static readonly GUIContent curvatureContent = EditorGUIUtility.TrTextContent("Curvature", "Controls the curvuture of the lens aperture blades. The minimum value results in fully-curved, perfectly-circular bokeh, and the maximum value results in visible aperture blades.");
        static readonly GUIContent barrelClippingContent = EditorGUIUtility.TrTextContent("Barrel Clipping", "Controls the self-occlusion of the lens, creating a cat's eye efect: the edges of the lens aperture are occluded by the geometry of the lens.");
