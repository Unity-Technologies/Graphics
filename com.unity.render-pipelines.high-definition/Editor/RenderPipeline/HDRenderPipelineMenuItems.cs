                    ...
                    if (materialArray.Count > meshIdx)
                    {
                        ...
                        if (currentMaterial != null)
                        {
                            bool materialIsTransparent = currentMaterial.IsKeywordEnabled("_SURFACE_TYPE_TRANSPARENT")
                                || (HDRenderQueue.k_RenderQueue_AllTransparent.lowerBound <= currentMaterial.renderQueue
                                && HDRenderQueue.k_RenderQueue_AllTransparent.upperBound >= currentMaterial.renderQueue);
