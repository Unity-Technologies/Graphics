...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class VolumetricFogEditor : AtmosphericScatteringEditor
    {
        ...
        SerializedDataParameter m_MaxHeight;
        ...
        static GUIContent s_MaxHeightLabel              = new GUIContent("Max Height", "Max height of the fog layer. Controls the rate of height-based density falloff. Units: m.");
        ...
        public override void OnEnable()
        {
            ...
            m_MaxHeight              = Unpack(o.Find(x => x.maxHeight));
        ...
        public override void OnInspectorGUI()
        {
            ...
            PropertyField(m_MaxHeight,              s_MaxHeightLabel);
            ...
            if (m_MaxHeight.value.floatValue < m_BaseHeight.value.floatValue)
            {
                m_MaxHeight.value.floatValue = m_BaseHeight.value.floatValue;
