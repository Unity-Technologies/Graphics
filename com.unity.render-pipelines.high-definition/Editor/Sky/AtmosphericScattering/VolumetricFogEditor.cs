...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    public class VolumetricFogEditor : AtmosphericScatteringEditor
    {
        ...
        private SerializedDataParameter m_HeightExponent;
        ...
        static GUIContent s_HeightExponentLabel         = new GUIContent("Height Exponent", "Controls the rate of falloff of height fog.");
        ...
        public override void OnEnable()
        {
            ...
            m_HeightExponent         = Unpack(o.Find(x => x.heightExponent));
