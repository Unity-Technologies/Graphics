...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    [VolumeComponentEditor(typeof(PhysicallyBasedSkySettings))]
    public class PhysicallyBasedSkySettingsEditor : VolumeComponentEditor
    {
        ...
        public override void OnEnable()
        {
            ...
            var o = new PropertyFetcher<PhysicallyBasedSkySettings>(serializedObject);
