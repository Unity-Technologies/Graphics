    ...
    if (_DebugMipMapMode != DEBUGMIPMAPMODE_NONE)
    {
        // TODO
            ...
            // And mix color to consider the Color & ShadowColor alpha (from texture or/and color picker)
                ...
                surfaceData.color = lerp(shadowColor.rgb * surfaceData.color.rgb, lerp(lerp(shadowColor.rgb, surfaceData.color.rgb, 1.0 - surfaceDescription.ShadowTint.a), surfaceData.color.rgb, shadow.a), surfaceDescription.Alpha);
            #else
                surfaceData.color = lerp(lerp(shadowColor.rgb, surfaceData.color.rgb, 1.0 - surfaceDescription.ShadowTint.a), surfaceData.color.rgb, shadow.a);
            #endif
