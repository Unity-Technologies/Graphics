...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class PackVertexData_Water : AbstractMaterialNode, IGeneratesBodyCode
    {
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            AddSlot(new Vector1MaterialSlot(kFoamFromHeightInputSlotId, kFoamFromHeightInputSlotName, kFoamFromHeightInputSlotName, SlotType.Input, 0, ShaderStageCapability.Vertex));
