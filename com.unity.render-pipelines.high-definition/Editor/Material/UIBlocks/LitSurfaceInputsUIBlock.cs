...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    public class LitSurfaceInputsUIBlock : MaterialUIBlock
    {
        ...
        internal class Styles
        {
            ...
            public static GUIContent iridescenceThicknessMapText = new GUIContent("Iridescence Layer Thickness map", "Specifies the Thickness map (R) of the thin iridescence layer over the material. Unit is micrometer multiply by 3. A value of 1 will be remap to 3 micrometer or 3000 nanometer.");
