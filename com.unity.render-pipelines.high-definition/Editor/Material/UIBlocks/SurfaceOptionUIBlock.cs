...
namespace UnityEditor.Rendering.HighDefinition
{
    internal class SurfaceOptionUIBlock : MaterialUIBlock
    {
        ...
        internal static class Styles
        {
            ...
            public static GUIContent rayTracingTextInfo = new GUIContent("When this option is enabled and a recursive rendering volume override is active, the object will be rendered using recursive rendering.");
