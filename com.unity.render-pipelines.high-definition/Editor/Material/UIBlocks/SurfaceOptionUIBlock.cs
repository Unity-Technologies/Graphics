...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    public class SurfaceOptionUIBlock : MaterialUIBlock
    {
        ...
        internal static class Styles
        {
            ...
            public static GUIContent customVelocityText = new GUIContent("Add Custom Velocity", "When enabled, the provided custom velocity is added to the motion vector calculation.");            
