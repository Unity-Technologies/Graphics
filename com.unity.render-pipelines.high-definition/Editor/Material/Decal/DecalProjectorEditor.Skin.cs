...
namespace UnityEditor.Rendering.HighDefinition
{
    partial class DecalProjectorEditor
    {
        ...
        static readonly GUIContent k_DecalLayerMaskContent = EditorGUIUtility.TrTextContent("Decal Layer Mask", "Material compatible with this value will receive the decal.");
