...
namespace UnityEditor.Rendering.HighDefinition
{
    partial class DecalProjectorEditor
    {
        ...
        static readonly GUIContent k_DecalLayerMaskContent = EditorGUIUtility.TrTextContent("Decal Layer Mask", "Specify the decal layer mask to use for this projector. RenderingLayerMask of Mesh matching this value will receive the decal. Enable DecalLayers in HDRP settings to access it.");
