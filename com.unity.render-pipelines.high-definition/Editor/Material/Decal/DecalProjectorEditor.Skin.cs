...
namespace UnityEditor.Rendering.HighDefinition
{
    partial class DecalProjectorEditor
    {
        ...
        static readonly GUIContent[] k_SizeSubContent = new[] {
            EditorGUIUtility.TrTextContent("W", "Sets the width of the projector."),
            EditorGUIUtility.TrTextContent("H", "Sets the height of the projector."),
            EditorGUIUtility.TrTextContent("D", "Sets the projection depth of the projector.")
        };
