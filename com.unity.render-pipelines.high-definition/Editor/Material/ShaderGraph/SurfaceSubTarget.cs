...
namespace UnityEditor.Rendering.HighDefinition.ShaderGraph
{
    abstract class SurfaceSubTarget : HDSubTarget, IRequiresData<BuiltinData>
    {
        ...
        protected virtual SubShaderDescriptor GetSubShaderDescriptor()
        {
            ...
            PassCollection GetPasses()
            {
                var passes = new PassCollection
                {
                    ...
                    HDShaderPasses.GenerateTransparentDepthPrepass(supportLighting),
        ...
        public override void GetActiveBlocks(ref TargetActiveBlockContext context)
        {
            ...
            // Alpha Test
            context.AddBlock(HDBlockFields.SurfaceDescription.AlphaClipThresholdDepthPrepass, systemData.alphaTest && systemData.alphaTestDepthPrepass);
            context.AddBlock(HDBlockFields.SurfaceDescription.AlphaClipThresholdDepthPostpass, systemData.alphaTest && systemData.alphaTestDepthPostpass);
