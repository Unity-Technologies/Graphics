...
{
    class SpeedTreeLitSettingsView : VisualElement
    {
        SpeedTreeLitMasterNode m_Node;
        ...
        public SpeedTreeLitSettingsView(SpeedTreeLitMasterNode node)
        {
            m_Node = node;
            ...
            if (m_Node.surfaceType == SurfaceType.Transparent)
            {
                ...
                if (!m_Node.HasRefraction())
                {
                    ...
                    {
                        row.Add(new EnumField(SpeedTreeLitMasterNode.AlphaModeLit.Additive), (field) =>
                        {
            ...
            {
                row.Add(new EnumField(SpeedTreeLitMasterNode.MaterialType.Standard), (field) =>
                {
            ...
            ++indentLevel;
            if (m_Node.materialType == SpeedTreeLitMasterNode.MaterialType.SubsurfaceScattering)
            {
            ...
            if (m_Node.materialType == SpeedTreeLitMasterNode.MaterialType.SpecularColor)
            {
            ...
            {
                row.Add(new EnumField(SpeedTreeLitMasterNode.SpeedTreeVersion.SpeedTree7), (e) =>
                {
        ...
        void ChangeMaterialType(ChangeEvent<Enum> evt)
        {
            ...
            m_Node.materialType = (SpeedTreeLitMasterNode.MaterialType)evt.newValue;
        }
        ...
        void ChangeBlendMode(ChangeEvent<Enum> evt)
        {
            ...
            AlphaMode alphaMode = GetAlphaMode((SpeedTreeLitMasterNode.AlphaModeLit)evt.newValue);
        ...
        public AlphaMode GetAlphaMode(SpeedTreeLitMasterNode.AlphaModeLit alphaModeLit)
        {
            switch (alphaModeLit)
            {
                case SpeedTreeLitMasterNode.AlphaModeLit.Alpha:
                    return AlphaMode.Alpha;
                case SpeedTreeLitMasterNode.AlphaModeLit.Premultiply:
                    return AlphaMode.Premultiply;
                case SpeedTreeLitMasterNode.AlphaModeLit.Additive:
        ...
        public SpeedTreeLitMasterNode.AlphaModeLit GetAlphaModeLit(AlphaMode alphaMode)
        {
            switch (alphaMode)
            {
                case AlphaMode.Alpha:
                    return SpeedTreeLitMasterNode.AlphaModeLit.Alpha;
                case AlphaMode.Premultiply:
                    return SpeedTreeLitMasterNode.AlphaModeLit.Premultiply;
                case AlphaMode.Additive:
                    return SpeedTreeLitMasterNode.AlphaModeLit.Additive;
                default:
                    {
        ...
        void ChangeSpeedTreeVersion(ChangeEvent<Enum> evt)
        {
            ...
            m_Node.speedTreeVersion = (SpeedTreeLitMasterNode.SpeedTreeVersion)evt.newValue;
        }
