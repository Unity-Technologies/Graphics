...
{
    sealed partial class HDLitImpostorSubTarget : LightingSubTarget, IRequiresData<HDLitData>
    {
        HDLitData m_LitData;
        ...
        public HDLitImpostorSubTarget() => displayName = "LitImpostor";
        ...
        public override void GetActiveBlocks(ref TargetActiveBlockContext context)
        {
            ...
            //context.AddBlock(HDBlockFields.SurfaceDescription.GBuffer0);
        }
