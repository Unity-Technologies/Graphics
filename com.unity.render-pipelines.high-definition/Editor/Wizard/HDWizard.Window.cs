    ...
    partial class HDWizard : EditorWindow
    {
        static class Style
        {
            ...
            public static readonly ConfigStyle dxr64bits = new ConfigStyle(
                ...
                error: "Your architecture is currently 32 bits. To build your Project to a Unity Player, ray tracing requires that the build uses 64 bit architecture. To set your build to use 64 bit architecture, Open the Build Settings window (menu: File > Build Settings). From the Architecture drop-down, select x86_64.", messageType: MessageType.Info);
