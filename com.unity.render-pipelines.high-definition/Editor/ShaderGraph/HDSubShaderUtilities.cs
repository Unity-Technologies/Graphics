...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    static class HDSubShaderUtilities
    {
        public static bool GenerateShaderPass(AbstractMaterialNode masterNode, Pass pass, GenerationMode mode, HashSet<string> activeFields, ShaderGenerator result, List<string> sourceAssetDependencyPaths, bool vertexActive)
        {
            ...
            // pragmas generated by nodes
            PragmaCollector pragmaCollector = new PragmaCollector();
            ...
            ShaderGenerator defines = new ShaderGenerator();
            {
                ...
                // Should we add a separate "pragmas" chunk instead of surfing along with defines?
                foreach (var pragma in pragmaCollector.pragmas)
                {
                    Debug.Log("Adding pragma: " + pragma.GetPragmaString());
                    defines.AddShaderChunk(pragma.GetPragmaString());
                }
            }
