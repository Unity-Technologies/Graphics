...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    static class HDSubShaderUtilities
    {
        ...
        public static System.Collections.Generic.List<HDRenderQueue.RenderQueueType> GetRenderingPassList(bool opaque, bool needAfterPostProcess)
        {
            ...
            bool supportsRayTracing = false; // HDRenderPipeline.AggreateRayTracingSupport(HDRenderPipeline.currentAsset.currentPlatformRenderPipelineSettings); // TODO: Undo this hackweek hack
