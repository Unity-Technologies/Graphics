...
//SensorSDK - Begin - Lidar intensity support
        const string kPassLidarPathTracing = "Packages/com.unity.render-pipelines.high-definition/Runtime/SensorSDK/SensorShaderPassPathTracing.hlsl";
...
//SensorSDK - Begin - Lidar intensity support
        public static IncludeCollection LidarRaytracing = new IncludeCollection
        {
            // Pregraph includes
            { kCommon, IncludeLocation.Pregraph },
            { kTextureStack, IncludeLocation.Pregraph },
            ...
            { kPassRaytracingForward, IncludeLocation.Postgraph, new FieldCondition(HDFields.ShaderPass.RaytracingForward, true) },
            { kPassRaytracingGBuffer, IncludeLocation.Postgraph, new FieldCondition(HDFields.ShaderPass.RayTracingGBuffer, true) },
            { kPassLidarPathTracing, IncludeLocation.Postgraph, new FieldCondition(HDFields.ShaderPass.RaytracingPathTracing, true) },
            { kPassRaytracingSubSurface, IncludeLocation.Postgraph,  new FieldCondition(HDFields.ShaderPass.RaytracingSubSurface, true) }
        };
//SensorSDK - End - Lidar intensity support
    }
