...
- Screen space refraction will now default to a spherical projection at ten meters instead of infinity, when no reflection probe proxy is available (1379733).
