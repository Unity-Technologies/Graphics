...
- Added a new sample to showcase examples on how to setup properly transparents shadows using different rendering methods (Rasterization, Ray Tracing, Path Tracing).
