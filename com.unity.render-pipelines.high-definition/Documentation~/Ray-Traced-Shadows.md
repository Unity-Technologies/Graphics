...
| - **Denoiser Radius** | Controls the radius of the spatio-temporal filter.           |
| - **Distance Based Denoising** | Takes the distance to the occluder into account when denoising the shadow, but increase the denoiser quality but also its cost.|
