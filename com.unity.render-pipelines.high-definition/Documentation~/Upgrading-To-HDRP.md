...
* **Upgrade Scene Terrains to High Definition Terrains**: Replaces the built-in default standard terrain Material in every terrain in the scene with HDRP default HDRP Terrain Material.
