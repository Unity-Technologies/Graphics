...
| **Start Angle Fade**    | Use the slider to set the angle from the Decal backward direction at which the projector begins to fade out the decal. Scales from 0 to 180 and represents an angle in degree. |
| **End Angle Fade**      | Use the slider to set the angle from the Decal backward direction at which the projector stop to fade out the decal. Scales from 0 to 180 and represents an angle in degree. |
