...
| **Decal Layer Mask**    | The layer mask that specifies the Materials to project the decal onto. Any Mesh Renderers or Terrain that uses a matching Decal Layer Mask receives the decal. |
