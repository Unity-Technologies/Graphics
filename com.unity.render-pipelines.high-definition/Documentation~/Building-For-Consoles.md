...
To build a Project for the **PlayStation 4**, **PlayStation 5**, **Xbox One** or **Xbox Series**, you need to install an additional package for each platform you want to support. The packages for each platform are:
