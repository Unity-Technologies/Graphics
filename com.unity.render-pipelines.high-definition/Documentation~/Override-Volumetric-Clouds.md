...
| **Ghosting Reduction**           | Indicates whether to remove the ghosting induced by the temporal accumulation. When active, it may introduce some flickering at lower temporal accumulation factors. |
