...
| **Cloud Type**   | Use the drop-down to select the type of clouds that HDRP renders when this Volume affects a Camera. The options are:<br/>&#8226; **None**: Does not render any clouds.<<br/>&#8226; [Cloud Layer](override-cloud-layer.md): Renders clouds using the Cloud Layer system.<br/>This list automatically updates when you [create custom clouds](creating-custom-clouds.md). |
