...
| **Cloud Type**   | Use the drop-down to select the type of clouds that HDRP renders when this Volume affects a Camera. This list automatically updates when you [create custom Clouds](Creating-custom-clouds). |
