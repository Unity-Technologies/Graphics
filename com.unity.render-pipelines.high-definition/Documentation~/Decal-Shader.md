...
| **Affect Emissive**             | Enable the checkbox to make this decal emissive. When enabled, this Material appears self-illuminated and acts as a visible source of light. This property does not work with transparent receiving Materials. Decal Emissive is always an additive positive contribution and can't affect the existing emissive properties of the materials assigned to the objects. |
