...
This version of HDRP includes support for the Game Core Xbox Series platform as well the support of Game Core for  Xbox One. For more information, see [building for consoles](Building-For-Consoles.md).
