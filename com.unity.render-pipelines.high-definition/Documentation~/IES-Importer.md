...
| **Maximum Intensity**        | The intensity Unity uses on the preface generated as the sub-asset. |
...
| **Light Type**        | The [Light](Light-Component.md) type to use for the Prefab the importer generates. |
