...
If the referenced Material gets modified, you can synchronize the properties by pressing the **Reset** button. This copies all of the properties from the referenced Material into the relevant Layered Material layer.

![](Images/LayeredLit1.png)

If you choose to use a Material made from a Shader Graph as a **Layer Material**, make sure the Reference of the properties match the name of the corresponding properties in the LayeredLit Material.
You can see an example with the **Base Map** in the screenshot below.
