...
| **- Base**                      | Use the slider to set the base for the **Height Map**. This is the value of the level 0 in the height map. If this is set to 0.5 and **Amplitude** is set to 100, the minimum value is -50 and the maximum value is 50. |
