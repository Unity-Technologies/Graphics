...
| **Penumbra Tint**          | Defines if the tint should only affect the penumbra. This option affect dynamic shadows, contact shadows and shadow mask.<br />This property only appears when you enable [more options](More-Options.html) for this section. |
