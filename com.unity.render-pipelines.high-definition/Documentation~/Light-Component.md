...
| **IES Profile**                   | An IES File that describe the light profile. If cookie and and IES is setuped a linear average of them is used (exception Rectangular-Area Light, only one of them is used with the priority of the IES). |
