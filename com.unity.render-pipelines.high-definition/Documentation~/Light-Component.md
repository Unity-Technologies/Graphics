...
| **Area**        | Projects light from a surface. Light shines in all directions uniformly from the surface of the rectangle.<br/>Area Lights use rasterized shadows on the reverse side of transmissive GameObjects when ray tracing is enabled. |
