...
| **Screen Space Shadow (Default Camera Frame Settings)** |  |
| **Reflections (Default Camera Frame Settings)** |  |
| **Screen Space Reflection (Default Camera Frame Settings)** |                                                              |
| **Global Illumination (Default Camera Frame Settings)** |  |
...
| **Screen Space Reflection (Asset)** |                                                              |
| **Global Illumination (Asset)**     |                                                              |
