...
| **Assigned - HDRP Settings** | Checks to make sure you have assigned an **HDRenderPipelineGlobalSettings** to the **HDRP Settings** field (menu: **Edit** > **Project Settings** > **HDRP Graphics**).<br />Press the **Fix** button will try to find first one available. If no one is available, it will create one in the **Default Resources Folder**. |
