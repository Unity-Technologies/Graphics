...
| **Speed Rejection**               | Controls the likelihood history will be rejected based on the previous frame motion vectors of both the surface and the hit object in world space.<br/>This property only appears if you enable **World Space Speed Rejection**. |
| **Speed Rejection Scaler Factor** | Controls the upper range of speed. The faster the objects or camera are moving, the higher this number should be.<br/>This property only appears if you enable **World Space Speed Rejection**. |
...
| **Speed From Reflecting Surface** | When enabled, the reflecting surface movement is considered as a valid rejection condition. At least one of the two conditions must be checked.<br/>This property only appears if you enable **World Space Speed Rejection**. |
| **Speed From Reflected Surface**  | When enabled, the reflected surface movement is considered as a valid rejection condition. At least one of the two conditions must be checked.<br/>This property only appears if you enable **World Space Speed Rejection**. |
