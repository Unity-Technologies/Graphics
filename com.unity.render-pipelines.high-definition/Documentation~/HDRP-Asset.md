...
These settings define the quality levels (low, medium, high) related to post processing effects in HDRP. For a detailed description of each setting, see the Post Processing [Post-processing in HDRP](Post-Processing-Main) section of the documentation.
