...
| **AOVs**                | Specifies the type of output variable in this layer. Aside from Color, you can also output variables like **Albedo**, **Normal**, or **Smoothness**. This option affects all Cameras stacked in this layer. For this functionnality to work in the player, it is required to enable **Runtime AOV API** in the [HDRP Asset](HDRP-Asset.md)  |
