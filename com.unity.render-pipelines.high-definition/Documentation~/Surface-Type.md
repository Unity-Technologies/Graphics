...
| **- Refraction Thickness**              | Use the slider to set the overall thickness of the refractive object between 0 and 1. The thicker the Material, the more visible the effect is.<br /> To expose this property, select **Box** or **Sphere** from the **Refraction Model** drop-down. |
