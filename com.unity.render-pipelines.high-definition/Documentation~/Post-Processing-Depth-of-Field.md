...
| **Focus Distance Mode** | Controls where the focus distance is specified.<br /> &#8226; **Volume**: The focus distance is read from the volume. <br /> &#8226; **Camera**: The focus distance is read from the physical camera. <br /> This property only appears when you select **Physical Camera** from the **Focus Mode** drop-down. |
