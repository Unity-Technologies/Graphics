...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    sealed partial class PostProcessSystem
    {
        ...
        void DoDynamicExposure(CommandBuffer cmd, HDCamera camera, RTHandle colorBuffer)
        {
            ...
            cmd.SetComputeVectorParam(cs, HDShaderIDs._ExposureParams2, new Vector4(0.0f, 0.0f, 0.0f, ColorUtils.s_LightMeterCalibrationConstant));
            ...
            else if (m_Exposure.mode.value == ExposureMode.CurveMapping)
            {
                ...
                cmd.SetComputeVectorParam(cs, HDShaderIDs._ExposureParams2, new Vector4(min, max, 0f, ColorUtils.s_LightMeterCalibrationConstant));
