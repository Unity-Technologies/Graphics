...
#define DEBUGVIEW_EYE_SURFACEDATA_IRIS_NORMAL_WS (1304)
#define DEBUGVIEW_EYE_SURFACEDATA_GEOMETRIC_NORMAL (1305)
#define DEBUGVIEW_EYE_SURFACEDATA_GEOMETRIC_NORMAL_VIEW_SPACE (1306)
#define DEBUGVIEW_EYE_SURFACEDATA_SMOOTHNESS (1307)
#define DEBUGVIEW_EYE_SURFACEDATA_AMBIENT_OCCLUSION (1308)
#define DEBUGVIEW_EYE_SURFACEDATA_REFRACTION_MASK (1309)
#define DEBUGVIEW_EYE_SURFACEDATA_DIFFUSION_PROFILE_HASH (1310)
#define DEBUGVIEW_EYE_SURFACEDATA_SUBSURFACE_MASK (1311)
#define DEBUGVIEW_EYE_SURFACEDATA_THICKNESS (1312)
#define DEBUGVIEW_EYE_SURFACEDATA_TANGENT (1313)
#define DEBUGVIEW_EYE_SURFACEDATA_ANISOTROPY (1314)
