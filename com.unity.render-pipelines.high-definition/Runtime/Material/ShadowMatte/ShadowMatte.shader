Shader "HDRP/ShadowMatte"
{
    ...
    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/ShadowMatte/ShadowMatteProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassForwardShadowMatte.hlsl"
