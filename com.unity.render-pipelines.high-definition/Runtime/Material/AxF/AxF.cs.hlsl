...
#define FEATUREFLAGS_AXF_LTC_PSEUDO_REFRACTION (1024)
#define FEATUREFLAGS_AXF_LTC_FLAKE_MODE (2048)
#define FEATUREFLAGS_AXF_LTC_BRDFCOLOR_MODE (8192)
#define FEATUREFLAGS_AXF_ENVIRONMENT_MODE (32768)

//
// UnityEngine.Rendering.HighDefinition.AxF+AxFDefinitions:  static fields
//
#define AXF_LTC_FLAKE_MODE_NUMBITS (2)
#define AXF_LTC_BRDFCOLOR_MODE_NUMBITS (2)
#define AXF_ENVIRONMENT_MODE_NUMBITS (2)
