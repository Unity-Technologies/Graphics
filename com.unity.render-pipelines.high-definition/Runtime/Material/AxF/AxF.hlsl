...
PreLightData    GetPreLightData(float3 viewWS_Clearcoat, PositionInputs posInput, inout BSDFData bsdfData)
{
    ...
    for (uint lobeIndex = 0; lobeIndex < CARPAINT2_LOBE_COUNT; lobeIndex++)
    {
        ...
        preLightData.ltcTransformSpecularCT[lobeIndex] = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_COOK_TORRANCE);
#endif
    }
    ...
    IFNOT_FLAKES_JUST_BTF(preLightData.ltcTransformFlakes = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_GGX));
...
// Construct a right-handed view-dependent orthogonal basis around the normal
    ...
    {
        preLightData.ltcTransformDiffuse = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_OREN_NAYAR);
    }
    else
    {
    ...
    //
    case 0: preLightData.ltcTransformSpecular = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_WARD); break;
    case 2: preLightData.ltcTransformSpecular = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_COOK_TORRANCE); break;
    case 3: preLightData.ltcTransformSpecular = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_GGX); break;
    case 1: // BLINN-PHONG
    case 4: // PHONG;
    {
        preLightData.ltcTransformSpecular = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_COOK_TORRANCE);
        break;
    }
    ...
    if (HasClearcoat())
    {
        ...
        preLightData.ltcTransformClearcoat = LTCSampleMatrix(UV, LTCLIGHTINGMODELS_GGX);
#if defined(_AXF_BRDF_TYPE_CAR_PAINT)
