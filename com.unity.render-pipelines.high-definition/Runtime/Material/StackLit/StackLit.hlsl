...
//    #endif
    ...
    for (i = 0; i < TOTAL_NB_LOBES; ++i)
    {
        ...
        float4 preLD = SampleEnv(lightLoopContext, lightData.envIndex, R[i], PerceptualRoughnessToMipmapLevel(preLightData.iblPerceptualRoughness[i]), lightData.rangeCompressionFactorCompensation, 0, posInput.positionNDC);
