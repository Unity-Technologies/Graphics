...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _UVDetail)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _TexWorldScale)
    UNITY_DOTS_INSTANCED_PROP(float , _InvTilingScale)
    UNITY_DOTS_INSTANCED_PROP(float4, _UVMappingMask)
    UNITY_DOTS_INSTANCED_PROP(float4, _UVDetailsMappingMask)
    UNITY_DOTS_INSTANCED_PROP(float , _LinkDetailsWithBase)
