...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float, _DistortionVectorScale)
    UNITY_DOTS_INSTANCED_PROP(float, _DistortionVectorBias)
...
#define _DistortionVectorScale        UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__DistortionVectorScale)
#define _DistortionVectorBias        UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__DistortionVectorBias)
