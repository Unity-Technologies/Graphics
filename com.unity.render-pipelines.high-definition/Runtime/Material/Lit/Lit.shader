Shader "HDRP/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "VBufferLightingOffscreen"
            Tags{ "LightMode" = "VBufferLightingOffscreen"}
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassVBufferLightingOffscreen.hlsl"
