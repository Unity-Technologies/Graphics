...
{
    return ((UnpackUIntToFloat(bsdfdata.anisoDataAndFlags, 24, 8) * 2)  -1);
}
float GetRoughnessT(in BSDFData bsdfdata)
{
    return ((UnpackUIntToFloat(bsdfdata.anisoDataAndFlags, 16, 8) * 2)  -0);
}
float GetRoughnessB(in BSDFData bsdfdata)
{
    return ((UnpackUIntToFloat(bsdfdata.anisoDataAndFlags, 8, 8) * 2)  -0);
}
...
{
    return ((UnpackFromR11G11B10f(bsdfdata.tangentWS) * 2)  -1);
}
float3 GetBitangentWS(in BSDFData bsdfdata)
{
    return ((UnpackFromR11G11B10f(bsdfdata.bitangentWS) * 2)  -1);
}
...
{
    bsdfdata.SSSData = BitFieldInsert(65535 , UnpackInt(((newIOR * 0.6666667)  - 0.6666667), 16) , bsdfdata.SSSData);
}
void SetAnisotropy(float newAnisotropy, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags = BitFieldInsert(255 << 24, UnpackInt(((newAnisotropy * 0.5)  + 0.5), 8) << 24, bsdfdata.anisoDataAndFlags);
}
void SetRoughnessT(float newRoughnessT, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags = BitFieldInsert(255 << 16, UnpackInt(((newRoughnessT * 0.5)  + 0), 8) << 16, bsdfdata.anisoDataAndFlags);
}
void SetRoughnessB(float newRoughnessB, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags = BitFieldInsert(255 << 8, UnpackInt(((newRoughnessB * 0.5)  + 0), 8) << 8, bsdfdata.anisoDataAndFlags);
}
...
{
    bsdfdata.tangentWS = PackToR11G11B10f(((newTangentWS * 0.5)  + 0.5));
}
void SetBitangentWS(float3 newBitangentWS, inout BSDFData bsdfdata)
{
    bsdfdata.bitangentWS = PackToR11G11B10f(((newBitangentWS * 0.5)  + 0.5));
}
...
{
    bsdfdata.SSSData |= UnpackInt(((newIOR * 0.6666667)  - 0.6666667), 16) ; 
}
void InitAnisotropy(float newAnisotropy, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags |= UnpackInt(((newAnisotropy * 0.5)  + 0.5), 8) << 24; 
}
void InitRoughnessT(float newRoughnessT, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags |= UnpackInt(((newRoughnessT * 0.5)  + 0), 8) << 16; 
}
void InitRoughnessB(float newRoughnessB, inout BSDFData bsdfdata)
{
    bsdfdata.anisoDataAndFlags |= UnpackInt(((newRoughnessB * 0.5)  + 0), 8) << 8; 
}
