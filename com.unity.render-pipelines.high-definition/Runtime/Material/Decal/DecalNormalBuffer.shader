Shader "Hidden/HDRP/Material/Decal/DecalNormalBuffer"
{
    ...
    HLSLINCLUDE
        ...
        void FragNearest(Varyings input)
        {
            ...
            normalData.perceptualRoughness = normalData.perceptualRoughness * decalSurfaceData.mask.w + PerceptualSmoothnessToPerceptualRoughness(decalSurfaceData.mask.z);
