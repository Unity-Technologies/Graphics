                                    ...
                                    inout float hierarchyWeight)
{
    ...
    float4 preLD = SampleEnv(lightLoopContext, lightData.envIndex, R, PerceptualRoughnessToMipmapLevel_LODFlag(preLightData.iblPerceptualRoughness, lightData.hasMipMaps), lightData.rangeCompressionFactorCompensation, posInput.positionNDC, sliceIndex);
