...
#define UNITY_MATRIX_I_M Inverse(GetRawUnityObjectToWorld())

#undef UNITY_PREV_MATRIX_M
//#define UNITY_PREV_MATRIX_M unity_MatrixPreviousM
#define UNITY_PREV_MATRIX_M GetRawUnityPrevObjectToWorld()

#undef UNITY_PREV_MATRIX_I_M
//#define UNITY_PREV_MATRIX_I_M Inverse(unity_MatrixPreviousM)
#define UNITY_PREV_MATRIX_I_M Inverse(GetRawUnityPrevObjectToWorld())
