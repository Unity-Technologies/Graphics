...
#define RAY_TRACING_LIGHT_DATA_REGISTER                         t2
#define RAY_TRACING_ENV_LIGHT_DATA_REGISTER                     t3
#define RAY_TRACING_CACHED_AREA_LIGHT_SHADOWMAP_ATLAS_REGISTER  t4
#define RAY_TRACING_CACHED_SHADOWMAP_ATLAS_REGISTER             t5
#define RAY_TRACING_SHADOWMAP_AREA_ATLAS_REGISTER               t6
#define RAY_TRACING_SHADOWMAP_ATLAS_REGISTER                    t7
#define RAY_TRACING_SHADOWMAP_CASCADE_ATLAS_REGISTER            t8
#define RAY_TRACING_COOKIE_ATLAS_REGISTER                       t9
#define RAY_TRACING_SKY_TEXTURE_REGISTER                        t10
#define RAY_TRACING_REFLECTION_ATLAS_REGISTER                   t11
#define RAY_TRACING_DIRECTIONAL_LIGHT_DATAS_REGISTER            t12
#define RAY_TRACING_HD_SHADOW_DATAS_REGISTER                    t13
