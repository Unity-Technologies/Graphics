...
#else
                hash = hdriSky.value != null ? hash * 23 + CoreUtils.GetTextureHash(hdriSky.value) : hash;
                hash = flowmap.value != null ? hash * 23 + CoreUtils.GetTextureHash(flowmap.value) : hash;
