...
#define FULLSCREENDEBUGMODE_VBUFFER_TRIANGLE_ID (17)
#define FULLSCREENDEBUGMODE_VBUFFER_GEOMETRY_ID (18)
#define FULLSCREENDEBUGMODE_VBUFFER_MATERIAL_ID (19)
#define FULLSCREENDEBUGMODE_MAX_LIGHTING_FULL_SCREEN_DEBUG (20)
#define FULLSCREENDEBUGMODE_MIN_RENDERING_FULL_SCREEN_DEBUG (21)
#define FULLSCREENDEBUGMODE_MOTION_VECTORS (22)
#define FULLSCREENDEBUGMODE_NAN_TRACKER (23)
#define FULLSCREENDEBUGMODE_COLOR_LOG (24)
#define FULLSCREENDEBUGMODE_DEPTH_OF_FIELD_COC (25)
#define FULLSCREENDEBUGMODE_TRANSPARENCY_OVERDRAW (26)
#define FULLSCREENDEBUGMODE_QUAD_OVERDRAW (27)
#define FULLSCREENDEBUGMODE_VERTEX_DENSITY (28)
#define FULLSCREENDEBUGMODE_REQUESTED_VIRTUAL_TEXTURE_TILES (29)
#define FULLSCREENDEBUGMODE_LENS_FLARE_DATA_DRIVEN (30)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (31)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (32)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (33)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (34)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (35)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (36)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (37)
