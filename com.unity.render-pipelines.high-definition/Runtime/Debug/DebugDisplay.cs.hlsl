...
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_INSTANCES (32)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_PRIMITIVES (33)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_MATERIALS (34)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_BATCH (35)
#define FULLSCREENDEBUGMODE_VISIBILITY_FEATURE_TILE (36)
#define FULLSCREENDEBUGMODE_VISIBILITY_MATERIALS_TILE (37)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUCKET_ID (38)
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER_LIGHTING (39)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITSTENCIL_COUNT (40)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITPRIMITIVES (41)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITHI_Z (42)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITPIXEL_HASH (43)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITGBUFFER (44)
#define FULLSCREENDEBUGMODE_VISIBILITY_OITDEBUG_SSTRACING (45)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (46)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (47)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (48)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (49)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (50)
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (51)
