...
#define FULLSCREENDEBUGMODE_CAPSULE_SOFT_SHADOWS (10)
#define FULLSCREENDEBUGMODE_CAPSULE_SPECULAR_OCCLUSION (11)
#define FULLSCREENDEBUGMODE_LIGHT_CLUSTER (12)
#define FULLSCREENDEBUGMODE_RAY_TRACED_GLOBAL_ILLUMINATION (13)
