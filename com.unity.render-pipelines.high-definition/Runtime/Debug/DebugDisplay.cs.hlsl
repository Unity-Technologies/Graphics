...
#define FULLSCREENDEBUGMODE_RAY_TRACING_ACCELERATION_STRUCTURE (17)
...
#define FULLSCREENDEBUGMODE_VISIBILITY_BUFFER (29)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (30)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (31)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (32)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (33)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (34)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (35)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (36)
