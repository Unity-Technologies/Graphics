...
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (4)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (5)
#define FULLSCREENDEBUGMODE_TRANSPARENT_SCREEN_SPACE_REFLECTIONS (6)
#define FULLSCREENDEBUGMODE_CONTACT_SHADOWS (7)
#define FULLSCREENDEBUGMODE_CONTACT_SHADOWS_FADE (8)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_SHADOWS (9)
#define FULLSCREENDEBUGMODE_PRE_REFRACTION_COLOR_PYRAMID (10)
#define FULLSCREENDEBUGMODE_DEPTH_PYRAMID (11)
#define FULLSCREENDEBUGMODE_FINAL_COLOR_PYRAMID (12)
