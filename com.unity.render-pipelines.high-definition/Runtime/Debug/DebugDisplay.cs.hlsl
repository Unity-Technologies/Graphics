...
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (11)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (12)
#define FULLSCREENDEBUGMODE_LIGHT_CLUSTER (13)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_GLOBAL_ILLUMINATION (14)
#define FULLSCREENDEBUGMODE_RECURSIVE_RAY_TRACING (15)
#define FULLSCREENDEBUGMODE_RAY_TRACED_SUB_SURFACE (16)
#define FULLSCREENDEBUGMODE_VOLUMETRIC_CLOUDS (17)
#define FULLSCREENDEBUGMODE_VOLUMETRIC_CLOUDS_SHADOW (18)
#define FULLSCREENDEBUGMODE_MAX_LIGHTING_FULL_SCREEN_DEBUG (19)
#define FULLSCREENDEBUGMODE_MIN_RENDERING_FULL_SCREEN_DEBUG (20)
#define FULLSCREENDEBUGMODE_MOTION_VECTORS (21)
#define FULLSCREENDEBUGMODE_NAN_TRACKER (22)
#define FULLSCREENDEBUGMODE_COLOR_LOG (23)
#define FULLSCREENDEBUGMODE_DEPTH_OF_FIELD_COC (24)
#define FULLSCREENDEBUGMODE_TRANSPARENCY_OVERDRAW (25)
#define FULLSCREENDEBUGMODE_QUAD_OVERDRAW (26)
#define FULLSCREENDEBUGMODE_VERTEX_DENSITY (27)
#define FULLSCREENDEBUGMODE_REQUESTED_VIRTUAL_TEXTURE_TILES (28)
...
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (34)
