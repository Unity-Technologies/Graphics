...
//
// UnityEngine.Rendering.HighDefinition.MaterialDebugSettings+OITGBufferLayer:  static fields
//
#define OITGBUFFERLAYER_BASE_COLOR (0)
#define OITGBUFFERLAYER_NORMAL (1)
#define OITGBUFFERLAYER_DIFFUSE_ALBEDO (2)
#define OITGBUFFERLAYER_SPECULAR_ALBEDO (3)
#define OITGBUFFERLAYER_ROUGHNESS (4)
#define OITGBUFFERLAYER_METALNESS (5)
#define OITGBUFFERLAYER_ABSORPTION_COEFFICIENT (6)
#define OITGBUFFERLAYER_IOR (7)
