...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
        ...
        void LightLoopNewFrame(HDCameraInfo hdCamera)
        {
        ...
        internal void GetDirectionalLightData(CommandBuffer cmd, HDCameraInfo hdCamera, VisibleLight light, Light lightComponent, int lightIndex, int shadowIndex,
        ...
        internal void GetLightData(CommandBuffer cmd, HDCameraInfo hdCamera, HDShadowSettings shadowSettings, VisibleLight light, Light lightComponent,
        ...
        internal bool GetEnvLightData(CommandBuffer cmd, HDCameraInfo hdCamera, in ProcessedProbeData processedProbe, DebugDisplaySettings debugDisplaySettings, ref EnvLightData envLightData)
        {
        ...
        bool TrivialRejectLight(VisibleLight light, HDCameraInfo hdCamera, in AOVRequestData aovRequest)
        {
        ...
        void PreprocessLightData(ref ProcessedLightData processedData, VisibleLight light, HDCameraInfo hdCamera)
        {
        ...
        int PreprocessVisibleLights(HDCameraInfo hdCamera, CullingResults cullResults, DebugDisplaySettings debugDisplaySettings, in AOVRequestData aovRequest)
        {
        ...
        void PrepareGPULightdata(CommandBuffer cmd, HDCameraInfo hdCamera, CullingResults cullResults, int processedLightCount)
        {
        ...
        bool TrivialRejectProbe(in ProcessedProbeData processedProbe, HDCameraInfo hdCamera)
        {
        ...
        internal static void PreprocessReflectionProbeData(ref ProcessedProbeData processedData, VisibleReflectionProbe probe, HDCameraInfo hdCamera)
        {
        ...
        internal static void PreprocessProbeData(ref ProcessedProbeData processedData, HDProbe probe, HDCameraInfo hdCamera)
        {
        ...
        int PreprocessVisibleProbes(HDCameraInfo hdCamera, CullingResults cullResults, HDProbeCullingResults hdProbeCullingResults, in AOVRequestData aovRequest)
        {
            var debugLightFilter = debugDisplaySettings.GetDebugLightFilterMode();
            var hasDebugLightFilter = debugLightFilter != DebugLightFilterMode.None;
        ...
        void PrepareGPUProbeData(CommandBuffer cmd, HDCameraInfo hdCamera, CullingResults cullResults, HDProbeCullingResults hdProbeCullingResults, int processedLightCount)
        {
            Vector3 camPosWS = hdCamera.mainViewConstants.worldSpaceCameraPos;
        ...
        void ClearLightList(HDCameraInfo camera, CommandBuffer cmd, ComputeBuffer bufferToClear)
        {
