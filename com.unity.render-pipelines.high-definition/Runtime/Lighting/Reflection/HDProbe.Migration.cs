...
namespace UnityEngine.Rendering.HighDefinition
{
    public abstract partial class HDProbe : IVersionable<HDProbe.Version>
    {
        protected enum Version
        {
            ...
            ProbesWithOverrideableFrameSettings,
        }
...
#pragma warning restore 618
            ...
            MigrationStep.New(Version.ProbesWithOverrideableFrameSettings, (HDProbe data) =>
            {
                FrameSettings.MigrateToProbesWithOverrideableFrameSettings(ref data.m_ProbeSettings.cameraSettings.renderingPathCustomFrameSettings);
            })
        );
