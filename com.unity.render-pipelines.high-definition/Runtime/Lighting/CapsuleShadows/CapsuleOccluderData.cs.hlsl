...
#define CAPSULESHADOWFLAGS_LIGHT_LOOP_BIT (8388608)
#define CAPSULESHADOWFLAGS_SPLIT_DEPTH_RANGE_BIT (16777216)
#define CAPSULESHADOWFLAGS_HALF_RES_BIT (33554432)
#define CAPSULESHADOWFLAGS_NEEDS_TILE_CHECK_BIT (67108864)
