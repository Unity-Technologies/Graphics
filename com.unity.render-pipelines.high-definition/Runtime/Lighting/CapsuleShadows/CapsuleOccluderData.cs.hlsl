...
//
#define CAPSULESHADOWMETHOD_ELLIPSOID (0)
#define CAPSULESHADOWMETHOD_CLIP_THEN_ELLIPSOID (1)
#define CAPSULESHADOWMETHOD_CLOSEST_SPHERE (2)
#define CAPSULESHADOWMETHOD_FLATTEN_THEN_CLOSEST_SPHERE (3)
#define CAPSULESHADOWMETHOD_RAY_TRACED_REFERENCE (4)
...
#define CAPSULESHADOWFLAGS_DIRECT_ENABLED_BIT (1048576)
#define CAPSULESHADOWFLAGS_INDIRECT_ENABLED_BIT (2097152)
#define CAPSULESHADOWFLAGS_FADE_SELF_SHADOW_BIT (4194304)
#define CAPSULESHADOWFLAGS_ADJUST_ELLIPSOID_CONE_BIT (8388608)
#define CAPSULESHADOWFLAGS_SOFT_PARTIAL_OCCLUSION_BIT (16777216)
#define CAPSULESHADOWFLAGS_LIGHT_LOOP_BIT (33554432)
#define CAPSULESHADOWFLAGS_SPLIT_DEPTH_RANGE_BIT (67108864)
#define CAPSULESHADOWFLAGS_HALF_RES_BIT (134217728)
#define CAPSULESHADOWFLAGS_NEEDS_TILE_CHECK_BIT (268435456)
