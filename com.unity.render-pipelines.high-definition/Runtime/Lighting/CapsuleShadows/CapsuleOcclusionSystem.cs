...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    partial class CapsuleOcclusionSystem
    {
        ...
        {
            (RenderPipelineManager.currentPipeline as HDRenderPipeline).PushFullScreenDebugTexture(hdCamera, cmd, occlusionTexture, FullScreenDebugMode.ScreenSpaceAmbientOcclusion);
