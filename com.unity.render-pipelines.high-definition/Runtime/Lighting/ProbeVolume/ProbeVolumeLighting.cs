...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
        ...
        unsafe void UpdateShaderVariablesGlobalProbeVolumesDefault(ref ShaderVariablesGlobal cb, HDCamera hdCamera)
        {
            ...
            cb._ProbeVolumeSamplingMode = (int)ProbeVolumesEncodingModes.SphericalHarmonicsL0;
        ...
        unsafe void UpdateShaderVariablesGlobalProbeVolumes(ref ShaderVariablesGlobal cb, HDCamera hdCamera)
        {
            ...
            cb._ProbeVolumeSamplingMode = Mathf.Min(hdCamera.frameSettings.probeVolumeSamplingQuality, (int)ShaderConfig.s_ProbeVolumesEncodingMode);
