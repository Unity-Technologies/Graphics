...
using RegId = UnityEngine.Rendering.HighDefinition.ProbeReferenceVolume.RegId;
...
namespace UnityEngine.Rendering.HighDefinition
{
    public class ProbeBrickIndex
    {
        ...
        internal void AddBricks3( List<Brick> bricks, List<Chunk> allocations, int allocationSize, int poolWidth, int poolHeight )
        {
        ...
        public void AddBricks2(RegId id, List<Brick> bricks, List<Chunk> allocations, int allocationSize, int poolWidth, int poolHeight)
        {
