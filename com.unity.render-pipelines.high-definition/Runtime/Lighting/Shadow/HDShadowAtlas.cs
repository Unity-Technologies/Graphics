...
namespace UnityEngine.Rendering.HighDefinition
{
    abstract class HDShadowAtlas
    {
        ...
        public virtual void InitAtlas(HDShadowAtlasInitParameters initParmas)
        {
            ...
            InitializeRenderGraphOutput(initParmas.renderGraph, initParmas.useSharedTexture);
        }
                ...
                builder.SetRenderFunc(
                    (RenderShadowMapsPassData data, RenderGraphContext ctx) =>
                    {
                        ...
                        foreach (var shadowRequest in data.shadowRequests)
                        {
                            ...
                            m_GlobalConstantBuffer.UpdateData(ctx.cmd, data.globalCB);
                            m_GlobalConstantBuffer.SetGlobal(ctx.cmd, HDShaderIDs._ShaderVariablesGlobal);
