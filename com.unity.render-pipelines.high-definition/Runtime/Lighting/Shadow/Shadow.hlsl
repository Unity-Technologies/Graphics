...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Lighting/Shadow/ShadowBase.cs.hlsl" // ShadowData definition, auto generated (don't modify)
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Lighting/Shadow/ShadowTexFetch.hlsl"              // Resource sampling definitions (don't modify)
...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Lighting/Shadow/ShadowSampling.hlsl"          // sampling patterns (don't modify)
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Lighting/Shadow/ShadowAlgorithms.hlsl"        // engine default algorithms (don't modify)
