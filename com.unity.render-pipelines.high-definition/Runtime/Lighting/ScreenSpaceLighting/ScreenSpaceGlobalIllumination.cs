    ...
    public partial class HDRenderPipeline
    {
        ...
        void RenderSSGI(HDCamera hdCamera, CommandBuffer cmd, ScriptableRenderContext renderContext, int frameCount)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(HDProfileId.SsgiPass)))
            {
                ...
                cmd.SetComputeTextureParam(ssGICS, currentKernel, HDShaderIDs._GBufferTexture[3], (hdCamera.frameSettings.litShaderMode == LitShaderMode.Deferred) ? m_GbufferManager.GetBuffer(3) : TextureXR.GetBlackTexture());
                ...
                if (!giSettings.fullResolutionSS)
                {
                    ...
                    cmd.SetComputeTextureParam(bilateralUpsampleCS, m_BilateralUpSampleColorKernel, HDShaderIDs._LowResolutionTexture, buffer1);
                    ...
                    cmd.SetComputeTextureParam(bilateralUpsampleCS, m_BilateralUpSampleColorKernel, HDShaderIDs._OutputUpscaledTexture, buffer0);
