...
{
    PositionInputs posInput = GetPositionInput(fullResCoord, _ScreenSize.zw, 0.0, UNITY_MATRIX_I_VP, UNITY_MATRIX_V);
    float4 worldPos = float4(posInput.positionWS, 0.0);
...
#define CENTER 4
#define CENTER_WEIGHT 0.410612
#define PLUS_0 1
#define PLUS_1 3
#define PLUS_2 5
#define PLUS_3 4
#define PLUS_WEIGHT  0.115089
#define CROSS_0 0
#define CROSS_1 2
#define CROSS_2 6
#define CROSS_3 8
#define CROSS_WEIGHT 0.032258
