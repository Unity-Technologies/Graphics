...
#define REFLECTION_SAMPLING_MAX_SMOOTHNESS_THRESHOLD 0.99
// TODO note: kept the value as before merge, as a perceptual value == 0.99, but this means
...
{
    bool isSmooth = perceptualRoughness < PerceptualSmoothnessToPerceptualRoughness(REFLECTION_SAMPLING_MAX_SMOOTHNESS_THRESHOLD);
