...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
        ...
        internal void BuildRayTracingAccelerationStructure(HDCameraInfo hdCamera)
        {
        ...
        internal bool ValidRayTracingHistory(HDCameraInfo hdCamera)
        {
        ...
        internal int RayTracingFrameIndex(HDCameraInfo hdCamera)
        {
