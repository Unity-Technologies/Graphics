...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
        ...
        RTHandle m_RayTracingHistoryValidityBuffer;
        ...
        {
            // Init the denoisers
            m_ReflectionDenoiser.Init(m_Asset.renderPipelineResources, m_Asset.renderPipelineRayTracingResources, m_SharedRTManager, this);
        ...
        internal void ReleaseRayTracingManager()
        {
            ...
            if (m_RayTracingDistanceBuffer != null)
                RTHandles.Release(m_RayTracingDistanceBuffer);
            if (m_RayTracingHistoryValidityBuffer != null)
                RTHandles.Release(m_RayTracingHistoryValidityBuffer);
        ...
        internal HDTemporalFilter GetTemporalFilter()
        {
            if (m_TemporalFilter == null)
            {
                ...
                m_TemporalFilter.Init(m_Asset.renderPipelineResources, m_Asset.renderPipelineRayTracingResources, sharedRTManager, this);
            }
        ...
        internal RTHandle AllocateBuffer(InternalRayTracingBuffers bufferID)
        {
            switch (bufferID)
            {
                ...
                case InternalRayTracingBuffers.HistoryValidity:
                {
                    m_RayTracingHistoryValidityBuffer = RTHandles.Alloc(Vector2.one, TextureXR.slices, colorFormat: GraphicsFormat.R8_SNorm, dimension: TextureXR.dimension, enableRandomWrite: true, useDynamicScale: true, useMipMap: false, name: "RaytracingHistoryValidityBuffer");
                    return m_RayTracingHistoryValidityBuffer;
                }
        ...
        internal RTHandle GetRayTracingBuffer(InternalRayTracingBuffers bufferID)
        {
            switch (bufferID)
            {
                ...
                case InternalRayTracingBuffers.HistoryValidity:
                    return m_RayTracingHistoryValidityBuffer != null ? m_RayTracingHistoryValidityBuffer : AllocateBuffer(InternalRayTracingBuffers.HistoryValidity);
                case InternalRayTracingBuffers.R0:
