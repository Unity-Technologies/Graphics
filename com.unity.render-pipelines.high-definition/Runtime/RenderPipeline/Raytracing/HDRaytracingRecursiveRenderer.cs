...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline
    {
        ...
        void EvaluateRaytracingMask(CullingResults cull, HDCameraInfo hdCamera, CommandBuffer cmd, ScriptableRenderContext renderContext, RTHandle flagBuffer)
        {
        ...
        void RaytracingRecursiveRender(HDCameraInfo hdCamera, CommandBuffer cmd, ScriptableRenderContext renderContext, CullingResults cull)
        {
