...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public class HDUtils
    {
        ...
        [NotNull]
        internal static VolumeComponentArchetype hdVolumeArchetype { get; } = VolumeComponentArchetype.FromFilter(IsExplicitlySupportedVolumeComponentFilter.FromType(typeof(HDRenderPipeline)));
