...
namespace UnityEngine.Rendering.HighDefinition
{
    static class ImportanceSampler2D
    {
            ...
            CommandBuffer cmd)
        {
            ...
            RTHandlesDeleter.ScheduleRelease(minMaxSumRows);
            ...
            RTHandlesDeleter.ScheduleRelease(cdfL);
