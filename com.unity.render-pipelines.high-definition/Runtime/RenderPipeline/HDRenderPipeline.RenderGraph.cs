    ...
    public partial class HDRenderPipeline
    {
                                        ...
                                        CommandBuffer           cmd)
        {
            ...
            else
            {
                ...
                BuildGPULightList(m_RenderGraph, hdCamera, prepassOutput.depthBuffer, prepassOutput.stencilBufferCopy, prepassOutput.depthValuesMSAA, prepassOutput.gbuffer);
