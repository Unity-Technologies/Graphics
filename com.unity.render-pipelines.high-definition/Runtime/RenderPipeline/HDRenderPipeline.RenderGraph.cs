...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
                                        ...
                                        CommandBuffer           commandBuffer)
        {
            ...
            TextureHandle postProcessDest = RenderPostProcess(m_RenderGraph, colorBuffer, prepassOutput.resolvedDepthBuffer, prepassOutput.depthPyramidTexture, backBuffer, cullingResults, hdCamera);
