...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline
    {
            ...
            ShadowResult                shadowResult)
        {
            ...
            data.zBinBitArrayBuffer = builder.ReadComputeBuffer(lightLists.zBinBitArrayBuffer);
                ...
                debugDisplay ? ProfilingSampler.Get(HDProfileId.ForwardOpaqueDebug) : ProfilingSampler.Get(HDProfileId.ForwardOpaque)))
            {
                ...
                builder.SetRenderFunc(
                    (ForwardOpaquePassData data, RenderGraphContext context) =>
                    {
                        ...
                        RenderForwardRendererList(data.frameSettings, data.rendererList, mrt, data.depthBuffer, data.fineTileBuffer, data.zBinBuffer, data.zBinBitArrayBuffer, true, context.renderContext, context.cmd);
                    });
            }
        }
            ...
            using (var builder = renderGraph.AddRenderPass<ForwardTransparentPassData>(passName, out var passData, ProfilingSampler.Get(profilingId)))
            {
                ...
                builder.SetRenderFunc(
                    (ForwardTransparentPassData data, RenderGraphContext context) =>
                    {
                        ...
                        RenderForwardRendererList(data.frameSettings, data.rendererList, mrt, data.depthBuffer, data.fineTileBuffer, data.zBinBuffer, data.zBinBitArrayBuffer, false, context.renderContext, context.cmd);
                    });
            }
        }
