    ...
    public partial class HDRenderPipeline
    {
            ...
            CommandBuffer           commandBuffer)
        {
            ...
            else
            {
                ...
                var volumetricDensityBuffer = VolumeVoxelizationPass(m_RenderGraph, hdCamera, gpuLightListOutput.coarseTileBuffer, gpuLightListOutput.zBinBuffer, m_FrameCount);
                ...
                var volumetricLighting = VolumetricLightingPass(m_RenderGraph, hdCamera, prepassOutput.depthPyramidTexture, volumetricDensityBuffer, maxZMask, gpuLightListOutput.coarseTileBuffer, gpuLightListOutput.zBinBuffer, shadowResult, m_FrameCount);
