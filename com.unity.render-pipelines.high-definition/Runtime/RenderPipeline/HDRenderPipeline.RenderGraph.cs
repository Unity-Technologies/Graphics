            ...
            CommandBuffer commandBuffer)
        {
            using (new ProfilingScope(commandBuffer, ProfilingSampler.Get(HDProfileId.RecordRenderGraph)))
            {
                ...
                else
                {
                    ...
                    lightingBuffers.capsuleShadows = RenderCapsuleShadows(m_RenderGraph, hdCamera, prepassOutput.depthPyramidTexture, prepassOutput.resolvedNormalBuffer, hdCamera.depthBufferMipChainInfo, ref capsuleTileDebugTexture);
