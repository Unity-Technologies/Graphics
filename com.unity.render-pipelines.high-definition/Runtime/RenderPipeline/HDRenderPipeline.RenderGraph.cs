                                    ...
                                    CullingResults              cullResults)
        {
                                                                                ...
                                                                                debugDisplay ? ProfilingSampler.Get(HDProfileId.ForwardOpaqueDebug) : ProfilingSampler.Get(HDProfileId.ForwardOpaque)))
            {
                ...
                (ForwardPassData data, RenderGraphContext context) =>
                {
                    ...
                    RenderForwardRendererList(data.frameSettings, data.rendererList, mrt, data.depthBuffer, data.lightListBuffer, true, debugDisplay, context.renderContext, context.cmd);
                });
            }
        }
                                        ...
                                        bool                        preRefractionPass)
        {
            ...
            using (var builder = renderGraph.AddRenderPass<ForwardPassData>(passName, out var passData, ProfilingSampler.Get(profilingId)))
            {
                    ...
                    (ForwardPassData data, RenderGraphContext context) =>
                {
                    ...
                    RenderForwardRendererList(  data.frameSettings, data.rendererList, mrt, data.depthBuffer, data.lightListBuffer, false, debugDisplay, context.renderContext, context.cmd);
                });
            }
        }
