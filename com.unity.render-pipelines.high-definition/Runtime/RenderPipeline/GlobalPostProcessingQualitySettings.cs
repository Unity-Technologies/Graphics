...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public sealed class GlobalPostProcessingQualitySettings
    {
        ...
        internal GlobalPostProcessingQualitySettings()
        {
            ...
            FixManualRangeNearBlend[(int)ScalableSettingLevelParameter.Level.Low] = false;
            FixManualRangeNearBlend[(int)ScalableSettingLevelParameter.Level.Medium] = false;
            FixManualRangeNearBlend[(int)ScalableSettingLevelParameter.Level.High] = false;
        ...
        /// <summary>Adjust near blend CoC based on depth distance when manual, non-physical mode is used for each quality level. The array must have one entry per scalable setting level.</summary>
        public bool[] FixManualRangeNearBlend = new bool[s_QualitySettingCount];
