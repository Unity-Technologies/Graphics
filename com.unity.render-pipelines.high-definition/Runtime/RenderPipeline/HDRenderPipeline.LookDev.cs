...
namespace UnityEngine.Rendering.HighDefinition
{
    public partial class HDRenderPipeline : IDataProvider
    {
        ...
        {
            public HDCameraExtension additionalCameraData;
        ...
        void IDataProvider.FirstInitScene(StageRuntimeInterface SRI)
        {
            ...
            var additionalCameraData = camera.CreateExtension<HDCameraExtension>();
            camera.SwitchActiveExtensionTo<HDCameraExtension>();
            additionalCameraData.clearColorMode = ClearColorMode.Color;
        ...
        void IDataProvider.UpdateSky(Camera camera, Sky sky, StageRuntimeInterface SRI)
        {
            ...
            if (sky.cubemap == null)
            {
                ...
                data.additionalCameraData.clearColorMode = ClearColorMode.Color;
            }
            else
            {
                ...
                data.additionalCameraData.clearColorMode = ClearColorMode.Sky;
            }
        }
