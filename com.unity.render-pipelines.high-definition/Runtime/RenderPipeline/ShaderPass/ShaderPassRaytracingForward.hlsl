...
void ClosestHitForward(inout RayIntersection rayIntersection : SV_RayPayload, AttributeData attributeData : SV_IntersectionAttributes)
{
    ...
    if (rayIntersection.remainingDepth > 0 && dot(refractedDir, surfaceData.normalWS) < 0.0f)
    {
        ...
        TraceRay(_RaytracingAccelerationStructure, RAY_FLAG_CULL_BACK_FACING_TRIANGLES, RAYTRACINGRENDERERFLAG_OPAQUE | RAYTRACINGRENDERERFLAG_TRANSPARENT, 0, 1, 0, transmittedRay, transmittedIntersection);
    ...
    if (rayIntersection.remainingDepth > 0)
    {
        ...
        // Evaluate the ray intersection
        TraceRay(_RaytracingAccelerationStructure, RAY_FLAG_CULL_BACK_FACING_TRIANGLES, RAYTRACINGRENDERERFLAG_OPAQUE | RAYTRACINGRENDERERFLAG_TRANSPARENT, 0, 1, 0, reflectedRay, reflectedIntersection);
