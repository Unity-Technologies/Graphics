...
#define SHADERPASS_VISIBILITY (26)
#define SHADERPASS_VISIBILITY_OIT_COUNT (27)
#define SHADERPASS_VISIBILITY_OIT_STORAGE (28)
#define SHADERPASS_FULL_SCREEN_DEBUG (29)
