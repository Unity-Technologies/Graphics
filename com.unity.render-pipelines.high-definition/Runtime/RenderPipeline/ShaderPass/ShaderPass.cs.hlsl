...
#define SHADERPASS_VBUFFER_LIGHTING (26)
#define SHADERPASS_VBUFFER_LIGHTING_OFFSCREEN (27)
#define SHADERPASS_VISIBILITY (28)
#define SHADERPASS_VISIBILITY_OIT_COUNT (29)
#define SHADERPASS_VISIBILITY_OIT_STORAGE (30)
#define SHADERPASS_FULL_SCREEN_DEBUG (31)
