    ...
    struct FrameSettingsHistory
    {
        ...
        class MinimalHistoryContainer : IFrameSettingsHistoryContainer
        {
            ...
            public MinimalHistoryContainer()
                => m_FrameSettingsHistory.debug = HDRenderPipeline.defaultAsset != null ? HDRenderPipeline.defaultAsset.GetDefaultFrameSettings(FrameSettingsRenderType.Camera) : FrameSettings.NewDefaultCamera();
