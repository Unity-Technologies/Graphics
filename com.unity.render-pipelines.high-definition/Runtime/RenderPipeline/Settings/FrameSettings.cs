...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public enum FrameSettingsField
    {
        ...
        /// <summary>When enabled, Cameras using these Frame Settings render Hierarchical Screen Space Shadows.</summary>
        [FrameSettingsField(1, autoName: HierarchicalVarianceScreenSpaceShadows, customOrderInGroup: 23, tooltip: "When enabled, Cameras using these Frame Settings render Hierarchical Variance Screen Space Shadows (Depends on \"Hierarchical Variance Screen Space Shadows\" in current HDRP Asset). Note that Hierarchical Variance Screen Space Shadows are disabled when MSAA is enabled.")]
        HierarchicalVarianceScreenSpaceShadows = 50,
    ...
    partial struct FrameSettings
    {
        internal static FrameSettings NewDefaultCamera() => new FrameSettings()
        {
            bitDatas = new BitArray128(new uint[] {
                ...
                (uint)FrameSettingsField.HierarchicalVarianceScreenSpaceShadows,
        ...
        /// <summary>Stores ProbeVolumeSamplingQuality on disk.</summary>
        [SerializeField]
        public int probeVolumeSamplingQuality;
        ...
        internal bool HiearchicalVarianceScreenSpaceShadowsRunAsync() => SystemInfo.supportsAsyncCompute && bitDatas[(int)FrameSettingsField.AsyncCompute];
        ...
        internal static void Override(ref FrameSettings overriddenFrameSettings, FrameSettings overridingFrameSettings, FrameSettingsOverrideMask frameSettingsOverideMask)
        {
            ...
            if (frameSettingsOverideMask.mask[(uint) FrameSettingsField.ProbeVolumeSamplingQuality])
                overriddenFrameSettings.probeVolumeSamplingQuality = overridingFrameSettings.probeVolumeSamplingQuality;
        ...
        internal static void Sanitize(ref FrameSettings sanitizedFrameSettings, Camera camera, RenderPipelineSettings renderPipelineSettings)
        {
            ...
            sanitizedFrameSettings.bitDatas[(int)FrameSettingsField.HierarchicalVarianceScreenSpaceShadows] &= renderPipelineSettings.hdShadowInitParams.supportHierarchicalVarianceScreenSpaceShadows && sanitizedFrameSettings.bitDatas[(int)FrameSettingsField.OpaqueObjects] & !msaa;
        ...
        public static bool operator ==(FrameSettings a, FrameSettings b)
            ...
            && a.probeVolumeSamplingQuality                 == b.probeVolumeSamplingQuality
        ...
        public override bool Equals(object obj)
            ...
            && probeVolumeSamplingQuality.Equals(((FrameSettings)obj).probeVolumeSamplingQuality)
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + probeVolumeSamplingQuality.GetHashCode();
            ...
            public DebuggerGroup[] Keys
            {
                get
                {
                    ...
                    groups.Add(new DebuggerGroup("Non Bit data", new DebuggerEntry[] {
                        ...
                        new DebuggerEntry("probeVolumeSamplingQuality", m_FrameSettings.probeVolumeSamplingQuality),
