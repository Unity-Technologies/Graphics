...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public enum FrameSettingsField
    {
        ...
        [FrameSettingsField(1, displayedName: "Transparent receive SSR", customOrderInGroup: 25, positiveDependencies: new[] { SSR }, tooltip: "When enabled, Cameras using these Frame Settings calculate Screen Space Reflections on transparent objects.")]
        TransparentSSR = 94,
