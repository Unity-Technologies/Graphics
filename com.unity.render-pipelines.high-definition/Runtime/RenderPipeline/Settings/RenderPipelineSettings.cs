    ...
    public struct RenderPipelineSettings
    {
        ...
        internal static RenderPipelineSettings NewDefault()
        {
            RenderPipelineSettings settings = new RenderPipelineSettings()
            {
                ...
                planarReflectionResolution = new PlanarReflectionAtlasResolutionScalableSetting(new[] { PlanarReflectionAtlasResolution.PlanarReflectionResolution256,
                                                                                PlanarReflectionAtlasResolution.PlanarReflectionResolution1024,
                                                                                PlanarReflectionAtlasResolution.PlanarReflectionResolution2048 },
