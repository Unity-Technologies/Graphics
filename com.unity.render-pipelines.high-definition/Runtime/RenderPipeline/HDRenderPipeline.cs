...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class HDRenderPipeline : UnityEngine.Rendering.RenderPipeline
    {
        ...
        ShaderTagId[] m_ObjectVelocityPassNames = { HDShaderPassNames.s_MotionVectorsName };
        ShaderTagId[] m_GBufferPassNames = { HDShaderPassNames.s_GBufferName };
        ...
        ShaderTagId[] m_DistortionPassNames = { HDShaderPassNames.s_DistortionVectorsName };
