...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline : RenderPipeline
    {
        ...
        void ConfigureKeywords(bool enableBakeShadowMask, HDCamera hdCamera, CommandBuffer cmd)
        {
            ...
            CoreUtils.SetKeyword(cmd, "PROBE_VOLUMES_OFF", !IsAPVSupported());
            CoreUtils.SetKeyword(cmd, "PROBE_VOLUMES_L1", IsAPVSupported() && m_Asset.currentPlatformRenderPipelineSettings.probeVolumeSHBands == ProbeVolumeSHBands.SphericalHarmonicsL1);
            CoreUtils.SetKeyword(cmd, "PROBE_VOLUMES_L2", IsAPVSupported() && m_Asset.currentPlatformRenderPipelineSettings.probeVolumeSHBands == ProbeVolumeSHBands.SphericalHarmonicsL2);
