...
namespace UnityEngine.Rendering.HighDefinition
{
    public struct XRLayout
    {
        ...
        {
            pass.AddView(viewCreateInfo.projMatrix, viewCreateInfo.viewMatrix, viewCreateInfo.viewport, viewCreateInfo.clusterDisplayParams, viewCreateInfo.textureArraySlice);
        }
    }
}
