...
namespace UnityEditor.ShaderGraph.Defs
{
    ...
    internal class CreateVector4Node : IStandardNode
    {
        public static string Name => "CreateVector4";
