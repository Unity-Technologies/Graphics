...
namespace UnityEditor.ShaderGraph.Defs
{
    ...
    internal class CreateVector2Node : IStandardNode
    {
        public static string Name => "CreateVector2";
