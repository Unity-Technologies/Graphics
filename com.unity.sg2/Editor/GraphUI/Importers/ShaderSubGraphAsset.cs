...
//        private static ShaderGraphAsset CreateBlankAssetGraph()
//        {
//            var model = CreateInstance<ShaderGraphAsset>();
//            model.name = "View";
...
//        public static void HandleSave(string path, ShaderGraphAsset model)
//        {
...
//        {
//            AssetDatabase.ImportAsset(path);
//            var assetModel = AssetDatabase.LoadAssetAtPath(path, typeof(ShaderGraphAsset)) as ShaderGraphAsset;
