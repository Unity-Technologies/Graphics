...
namespace UnityEditor.ShaderGraph.GraphUI
{
    ...
    class SubgraphOutputsInspector : SGFieldsInspector
    {
        ...
        string GetUniqueOutputName(string proposedName)
        {
            ...
            if (!m_ContextNodeModel.graphDataOwner.TryGetNodeHandler(out var nodeHandler)) return proposedName;
        ...
        protected override void UpdatePartFromModel()
        {
            ...
            if (!m_ContextNodeModel.graphDataOwner.TryGetNodeHandler(out var nodeHandler)) return;
