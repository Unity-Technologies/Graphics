...
using System.IO;
using System.Linq;
using UnityEditor.Experimental.ShaderTools.PSSLInternal;
using UnityEngine;
...
namespace UnityEditor.Experimental.ShaderTools.Internal
{
    ...
    public class ShaderBuildReport : ISerializationCallbackReceiver
    {
        ...
        public class GPUProgram
        {
            ...
            [SerializeField]
            int m_CompileWarnings = 0;
            [SerializeField]
            int m_CompileErrors = 0;

            [NonSerialized]
            ShaderBuildReport m_Report = null;
        ...
        public class CompileUnit
        {
            ...
            [NonSerialized]
            ShaderBuildReport m_Owner = null;
        ...
        public class PerformanceUnit
        {
            ...
            string m_RawReport;
            [SerializeField]
            ShaderBuildReport.ProgramPerformanceMetrics m_ParsedReport;
            [NonSerialized]
            ShaderBuildReport m_Owner = null;
            ...
            public ShaderBuildReport.ProgramPerformanceMetrics parsedReport { get { return m_ParsedReport; } }
