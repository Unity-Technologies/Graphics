...
def _unfold_platforms(metafile, shared):
    ...
    for platform_meta in metafile.get('platforms',[]):
        ...
        platform_formatted["extra_utr_flags"] = [] if not platform_formatted.get("extra_utr_flags") else platform_formatted.get("extra_utr_flags")
        platform_formatted["extra_utr_flags_build"] = [] if not platform_formatted.get("extra_utr_flags_build") else platform_formatted.get("extra_utr_flags_build")
