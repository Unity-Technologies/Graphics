...
class Package_AllPackageCiJob():
    ...
    def __init__(self, packages, agent, platforms, package_trigger_editors, editor):
        self.job_id = package_job_id_test_all(editor["version"])
        self.yml = self.get_job_definition(packages, agent, platforms, package_trigger_editors, editor).get_yml()


    def get_job_definition(self, packages, agent, platforms, package_trigger_editors, editor):
        ...
        if editor['version'] in package_trigger_editors:
