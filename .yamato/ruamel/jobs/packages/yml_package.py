...
def create_package_ymls(metafile):
    ...
    for package in metafile["packages"]:
        ...
        job = Package_PublishJob(package, metafile["agent_publish"], metafile["platforms"], metafile["publish_all_track"])
        yml[job.job_id] = job.yml

        job = Package_PublishDryJob(package, metafile["agent_publish"], metafile["platforms"], metafile["publish_all_track"])
        yml[job.job_id] = job.yml
    ...
    for editor in metafile['editors']:
        job = Package_AllPackageCiJob(metafile["packages"], metafile["agent_publish"], metafile["platforms"], metafile["publish_all_track"], metafile["target_branch"], editor)
        yml[job.job_id] = job.yml
