...
class PreviewPublish_AutoVersionJob():
    ...
    def get_job_definition(self, agent, packages, target_branch, auto_version):
        ...
        job.add_commands([
                ...
                f'python ./Tools/standalone/templates_auto_bumper.py --template-name ./com.unity.template-hd --target-dependency com.unity.render-pipelines.high-definition',
                f'python ./Tools/standalone/templates_auto_bumper.py --template-name ./com.unity.template-universal --target-dependency com.unity.render-pipelines.universal',
