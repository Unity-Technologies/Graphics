...
class Editor_PinningMergeRevisionsJob():
    ...
    def get_job_definition(self, editor, agent, target_branch, target_branch_editor_ci, abv):
        ...
        commands = [
            ...
            f'pipenv run python3 .yamato/ruamel/editor_pinning/merge_revisions.py --revision $GIT_REVISION --target-branch { target_branch } --track {editor["track"]} --jobid $YAMATO_JOB_ID --apikey $YAMATO-KEY',
        ]
