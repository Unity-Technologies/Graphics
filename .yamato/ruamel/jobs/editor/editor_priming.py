...
class Editor_PrimingJob():
    ...
    def get_job_definition(self, platform, editor, agent):
        ...
        job.add_commands([
                f'pip install unity-downloader-cli --user --upgrade --index-url https://artifactory.internal.unity3d.com/api/pypi/common-python/simple --upgrade',
        ...
        job.add_artifacts_unity_revision() # TODO remove above command with revison staging
        return job
