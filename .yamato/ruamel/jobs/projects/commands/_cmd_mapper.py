from . import win, osx_openglcore, osx_metal, linux, android, osx_metal_split, linux_split, iphone, uwp
...
cmd_map = {
    ...
    'uwp' : {
        'not_standalone': uwp.cmd_not_standalone,
        'standalone' : uwp.cmd_standalone,
        'standalone_build' : uwp.cmd_standalone_build
    },
    'osx_openglcore' :  {
