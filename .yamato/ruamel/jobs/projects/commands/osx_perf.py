...
def _cmd_base(project_folder, components):
    return [ 
        ...
        f'ssh -i ~/.ssh/id_rsa_macmini -o "StrictHostKeyChecking=no" bokken@$BOKKEN_DEVICE_IP "bash -lc \'pip3 install --user unity-downloader-cli --index-url https://artifactory-slo.bf.unity3d.com/artifactory/api/pypi/pypi/simple --upgrade\'"',
