...
def cmd_standalone(project_folder, platform, api, test_platform_args):
    # Android could be run using only UTR, no need to download editor which takes a lot of time.
    base = ['curl -s https://artifactory.internal.unity3d.com/core-automation/tools/utr-standalone/utr.bat --output utr.bat']
    base.extend([ 
