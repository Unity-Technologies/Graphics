...
class Project_StandaloneBuildJob():
    ...
    def __init__(self, project, editor, platform, api, test_platform):
        ...
        self.job_id = project_job_id_build(project["name"],platform["name"],api["name"],test_platform["name"],editor["track"])
    ...
    def get_job_definition(self, project, editor, platform, api, test_platform):
        ...
        job = _job(project, f'{test_platform["name"]}_build', editor, platform, api, cmd(project_folder, platform, api, test_platform, editor))
