from .constants import VAR_UPM_REGISTRY, PATH_TEST_RESULTS_padded, PATH_PLAYERS_padded, PATH_PACKAGES,PATH_PACKAGES_pack, PATH_UNITY_REVISION, PATH_TEMPLATES
...
class YMLJob():
    ...
    def add_artifacts_packages(self, pack=False):
