...
def get_last_nightly_id(api_key):
    try:
        ...
        url = f"http://yamato-api.cds.internal.unity3d.com/jobs?filter=project eq 902 and branch eq '10.x.x/release' and filename eq '.yamato%252F_abv.yml%2523all_project_ci_nightly_2020.2' and submitted gt '{current_date}'"
