        ...
        */
        ...
        private class DecalSet
        {
            ...
            public void CreateDrawData()
            {
                ...
                ulong sceneCullingMask = GetSceneCullingMaskFromCamera(camera);
            ...
            public void RenderIntoDBuffer(CommandBuffer cmd)
            {
                ...
                {
                    m_PropertyBlock.SetMatrixArray(ShaderIDs._NormalToWorldID, m_NormalToWorld[batchIndex]);
                    m_PropertyBlock.SetFloatArray(MaterialProperties.kDecalLayerMaskFromDecal, m_DecalLayerMasks[batchIndex]);
            ...
            public int DrawOrder
            {
                get
                {
                    if (this.m_Material.HasProperty(ShaderIDs._DrawOrder))
                    {
                        return this.m_Material.GetInt(ShaderIDs._DrawOrder);
                    }
                    else
                    {
                        return 0;
