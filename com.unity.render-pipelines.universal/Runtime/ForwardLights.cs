...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ForwardLights
    {
        ...
        static class LightConstantBuffer
        {
            ...
            public static int _MainLightLightLayers;
            ...
            public static int _AdditionalLightsLightLayers;
        }
        ...
        public ForwardLights()
        {
            ...
            LightConstantBuffer._MainLightLightLayers = Shader.PropertyToID("_MainLightLightLayers");
            ...
            else
            {
                ...
                LightConstantBuffer._AdditionalLightsLightLayers = Shader.PropertyToID("_AdditionalLightsLightLayers");
                ...
                m_AdditionalLightsLightLayers = new float[maxLights];
            }
        }
        ...
        void InitializeLightConstants(NativeArray<VisibleLight> lights, int lightIndex, out Vector4 lightPos, out Vector4 lightColor, out Vector4 lightAttenuation, out Vector4 lightSpotDir, out Vector4 lightOcclusionProbeChannel, out uint lightLayers)
        {
            ...
            lightLayers = (uint)additionalLightData.lightLayersMask;
        }
        ...
        void SetupMainLightConstants(CommandBuffer cmd, ref LightData lightData)
        {
            ...
            uint lightLayers;
            InitializeLightConstants(lightData.visibleLights, lightData.mainLightIndex, out lightPos, out lightColor, out lightAttenuation, out lightSpotDir, out lightOcclusionChannel, out lightLayers);

            cmd.SetGlobalVector(LightConstantBuffer._MainLightPosition, lightPos);
            cmd.SetGlobalVector(LightConstantBuffer._MainLightColor, lightColor);
            cmd.SetGlobalVector(LightConstantBuffer._MainLightOcclusionProbesChannel, lightOcclusionChannel);
            cmd.SetGlobalInt(LightConstantBuffer._MainLightLightLayers, (int)lightLayers);
        }
        ...
        void SetupAdditionalLightConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (additionalLightsCount > 0)
            {
                ...
                else
                {
                    for (int i = 0, lightIter = 0; i < lights.Length && lightIter < maxAdditionalLightsCount; ++i)
                    {
                        ...
                        if (lightData.mainLightIndex != i)
                        {
                            ...
                            InitializeLightConstants(lights, i, out m_AdditionalLightPositions[lightIter],
                                ...
                                out lightLayers);
                            m_AdditionalLightsLightLayers[lightIter] = Unity.Mathematics.math.asfloat(lightLayers);
                            lightIter++;
                        }
                    }
                    ...
                    cmd.SetGlobalFloatArray(LightConstantBuffer._AdditionalLightsLightLayers, m_AdditionalLightsLightLayers);
                }
