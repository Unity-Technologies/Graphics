    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void RenderSingleCamera(ScriptableRenderContext context, CameraData cameraData, bool anyPostProcessingEnabled)
        {
            ...
            using (new ProfilingScope(cmdScope, sampler)) // Enqueues a "BeginSample" command into the CommandBuffer cmd
            {
                ...
                renderer.InitializeRenderingData(asset, ref cameraData, ref cullResults, anyPostProcessingEnabled, out var renderingData);
...
#pragma warning restore 0618
        ...
        static void InitializeStackedCameraData(Camera baseCamera, UniversalAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            ...
            cameraData.upscalingFilter = ResolveUpscalingFilterSelection(new Vector2(cameraData.pixelWidth, cameraData.pixelHeight), cameraData.renderScale, settings.scriptableRenderer.upscalingFilter);
            ...
            cameraData.fsrOverrideSharpness = settings.scriptableRenderer.fsrOverrideSharpness;
            cameraData.fsrSharpness = settings.scriptableRenderer.fsrSharpness;
