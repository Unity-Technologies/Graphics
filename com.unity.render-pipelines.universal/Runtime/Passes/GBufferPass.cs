...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class GBufferPass : ScriptableRenderPass
    {
        ...
        public GBufferPass(RenderPassEvent evt, RenderQueueRange renderQueueRange)
        {
            ...
            m_GBufferDescriptors[1] = new RenderTextureDescriptor(initialWidth, initialHeight, Experimental.Rendering.GraphicsFormat.R8G8B8A8_SRGB, 0);   // specular        specular        specular        encoded-metallic+alpha (sRGB rendertarget)
