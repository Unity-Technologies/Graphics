...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        public void Setup(in RenderTextureDescriptor baseDescriptor, in RTHandle screenRT, in RTHandle depth, in RTHandle internalLut, bool hasFinalPass, bool resolvePostProcessingToCameraTarget)
        {
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
...
#endif
                {
                    ...
                    {
                        cmd.SetGlobalVector(URPShaderIDs._RTHandleScale, new Vector4(1.0f,1.0f,1.0f,1.0f));
                    }
