namespace UnityEngine.Rendering.Universal
{
    ...
    internal class TransparentSettingsPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.MainLightShadowCascades, m_shouldReceiveShadows); //seongdae;oneMainShadow
            CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.MainLightShadowScreen, false); //seongdae;oneMainShadow
