    ...
    public class MainLightShadowCasterPass : ScriptableRenderPass
    {
        ...
        void RenderMainLightCascadeShadowmap(ref ScriptableRenderContext context, ref CullingResults cullResults, ref LightData lightData, ref ShadowData shadowData)
        {
            ...
            using (new ProfilingSample(cmd, m_ProfilerTag))
            {
                ...
                //CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.MainLightShadowCascades, shadowData.mainLightShadowCascadesCount > 1); //seongdae;oneMainShadow
                CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.MainLightShadowScreen, shadowData.requiresScreenSpaceShadowResolve); //seongdae;oneMainShadow
