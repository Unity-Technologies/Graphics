  ...
  //      const int k_RenderPassBlockCount = 4;
        ...
        public void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
           ...
           for (int eyeIndex = 0; eyeIndex < renderingData.cameraData.numberOfXRPasses; ++eyeIndex)
           {
            ...
            ExecuteBlock(RenderPassBlock.MainRendering, blockRanges, context, ref renderingData, eyeIndex, /*RenderPass*/ true);
           ...
           // ExecuteBlock(RenderPassBlock.MainRenderingOpaque, blockRanges, context, ref renderingData, eyeIndex);
            ...
            ExecuteBlock(RenderPassBlock.AfterRendering, blockRanges, context, ref renderingData, eyeIndex, /*RenderPass*/ false);
        ...
        void ExecuteRenderPass(ScriptableRenderContext context, ScriptableRenderPass renderPass, ref RenderingData renderingData, int eyeIndex, bool noRenderPass)
        {
            ref CameraData cameraData = ref renderingData.cameraData;
            Camera camera = cameraData.camera;
