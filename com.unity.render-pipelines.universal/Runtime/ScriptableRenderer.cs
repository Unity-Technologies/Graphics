...
namespace UnityEngine.Rendering.Universal
{
    ...
    [MovedFrom("UnityEngine.Rendering.LWRP")] public abstract class ScriptableRenderer
    {
        ...
        void SetCameraRenderState(CommandBuffer cmd, ref CameraData cameraData)
        {
            ...
            //cmd.DisableShaderKeyword(ShaderKeywordStrings.MainLightShadowCascades); //seongdae;vxsm;origin
            cmd.DisableShaderKeyword(ShaderKeywordStrings.MainLightShadowInScreenSpace); //seongdae;vxsm
