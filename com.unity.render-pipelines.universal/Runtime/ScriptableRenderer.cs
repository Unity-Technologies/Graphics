...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
            ...
            bool anyPostProcessingEnabled, out RenderingData renderingData)
        {
            ...
            CheckAndApplyDebugSettings(settings, ref renderingData);
        }
...
#pragma warning restore 0618
        ...
        static void CheckAndApplyDebugSettings(UniversalRenderPipelineAsset settings, ref RenderingData renderingData)
        {
            ...
            if (debugDisplaySettings.AreAnySettingsActive && !cameraData.isPreviewCamera)
            {
                ...
                cameraData.hdrColorBufferPrecision = settings ? settings.hdrColorBufferPrecision : HDRColorBufferPrecision._32Bits;
