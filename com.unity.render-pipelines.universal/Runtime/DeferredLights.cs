...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class DeferredLights
    {
        ...
        public int GBufferSliceCount { get { return SystemInfo.supportedRenderTargetCount > 4 ? 5 : 4; } }
#else
        public int GBufferSliceCount { get { return 4; } }
#endif
        public AttachmentDescriptor[] GBufferDescriptors;
        ...
        public DeferredLights(Material tileDepthInfoMaterial, Material tileDeferredMaterial, Material stencilDeferredMaterial)
        {
            ...
            GBufferDescriptors = new AttachmentDescriptor[GBufferSliceCount];
        ...
        public void Setup(ref RenderingData renderingData,
            ...
            AttachmentDescriptor[] deferredInputs,
            AttachmentDescriptor deferredDepthInput,
...
#if (UNITY_IOS || UNITY_ANDROID) && !UNITY_EDITOR
            deferredInputs[3] = SystemInfo.supportedRenderTargetCount > 4 ? GBufferDescriptors[GBufferAdditionalDepthIndex] : deferredDepthInput;
#else
