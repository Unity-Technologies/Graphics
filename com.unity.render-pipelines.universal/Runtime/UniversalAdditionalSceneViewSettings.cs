...
namespace UnityEngine.Rendering.Universal
{
    ...
    static class UniversalAdditionalSceneViewSettings
    {
        ...
        static CachedEditorPref<AntialiasingMode> s_SceneViewAntialiasing = new CachedEditorPref<AntialiasingMode>("URP:SceneViewCamera:Antialiasing", AntialiasingMode.None);
        ...
        static CachedEditorPref<bool> s_SceneViewStopNaNs = new CachedEditorPref<bool>("URP:SceneViewCamera:StopNaNs", false);
        ...
        static CachedEditorPref<bool> s_SceneExposureOverride = new CachedEditorPref<bool>("URP:SceneViewCamera:OverrideExposure", false);
        ...
        static CachedEditorPref<float> s_SceneExposure = new CachedEditorPref<float>("URP:SceneViewCamera:Exposure", 10.0f);
