    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            internal ScreenSpaceAmbientOcclusionPass()
            {
                ...
                m_SSAOTexture1 = RTHandles.Alloc(s_SSAOTexture1ID, "_SSAO_OcclusionTexture1");
                m_SSAOTexture2 = RTHandles.Alloc(s_SSAOTexture2ID, "_SSAO_OcclusionTexture2");
                m_SSAOTexture3 = RTHandles.Alloc(s_SSAOTexture3ID, "_SSAO_OcclusionTexture3");
                m_SSAOTextureFinal = RTHandles.Alloc(s_SSAOTextureFinalID, "_SSAO_OcclusionTexture");
            }
