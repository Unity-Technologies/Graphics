    ...
    internal class Render2DLightingPass : ScriptableRenderPass, IRenderPass2D
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            else
            {
                ...
                var cameraSortingLayerBoundsIndex = GetCameraSortingLayerBoundsIndex();
                filterSettings.sortingLayerRange = new SortingLayerRange(short.MinValue, cameraSortingLayerBoundsIndex);                  Render(context, cmd, ref renderingData, ref filterSettings, unlitDrawSettings, debugRender);

                CopyCameraSortingLayerRenderTexture(context, renderingData, storeAction);

                filterSettings.sortingLayerRange = new SortingLayerRange(cameraSortingLayerBoundsIndex, short.MaxValue);                  Render(context, cmd, ref renderingData, ref filterSettings, unlitDrawSettings, debugRender);
                Profiler.EndSample();
            }
