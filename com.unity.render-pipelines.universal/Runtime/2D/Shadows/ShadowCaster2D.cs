...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    public class ShadowCaster2D : ShadowCasterGroup2D
    {
        ...
        {
            ShadowUtility.RemoveFromShadowCasterGroup(this, m_ShadowCasterGroup);
        }
        ...
        public void Update()
        {
            ...
            bool addedToNewGroup = ShadowUtility.AddToShadowCasterGroup(this, ref m_ShadowCasterGroup);
            if (addedToNewGroup && m_ShadowCasterGroup != null)
            {
                if (m_PreviousShadowCasterGroup == this)
                    ShadowCasterGroup2DManager.RemoveGroup(this);

                ShadowUtility.RemoveFromShadowCasterGroup(this, m_PreviousShadowCasterGroup);
