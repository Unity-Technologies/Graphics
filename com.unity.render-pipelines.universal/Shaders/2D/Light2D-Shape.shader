    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes attributes)
            {
                ...
                positionOS.x = positionOS.x + attributes.extrude.z * attributes.extrude.x;
                positionOS.y = positionOS.y + attributes.extrude.z * attributes.extrude.y;
