...
half4 TerrainWaveGrass(inout float4 vertex, float waveAmount, half4 color)
{
    ...
    half4 _waveZSize = half4(0.006, 0.02, 0.02, 0.05) * _WaveAndDistance.y;
    half4 _waveSpeed = half4(1.2, 2.0, 1.6, 4.8);

    half4 _waveXmove = half4(0.024, 0.04, -0.12, 0.096);
    half4 _waveZmove = half4(0.006, 0.02, -0.02, 0.1);
    ...
    waves += _WaveAndDistance.x * _waveSpeed;
