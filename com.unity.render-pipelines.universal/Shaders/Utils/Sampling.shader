Shader "Hidden/Universal Render Pipeline/Sampling"
{
    ...
    half4 DownsampleBox4Tap(TEXTURE2D(tex), SAMPLER(samplerTex), float2 uv, float2 texelSize, float amount)
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                half4 col = DownsampleBox4Tap(_MainTex, sampler_MainTex, input.uv, _MainTex_TexelSize.xy, _SampleOffset);
