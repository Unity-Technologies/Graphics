Shader "Hidden/Universal Render Pipeline/TileDepthInfo"
{
    ...
    #if USE_GATHER_FOR_PASS0 || USE_GATHER_FOR_PASS1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_fragment _ DOWNSAMPLING_SIZE_2 DOWNSAMPLING_SIZE_4 DOWNSAMPLING_SIZE_8 DOWNSAMPLING_SIZE_16
            #pragma multi_compile_fragment _ _DEFERRED_GPU_TILING
        ...
        Pass
        {
            ...
            #pragma multi_compile_fragment _ DOWNSAMPLING_SIZE_2 DOWNSAMPLING_SIZE_4 DOWNSAMPLING_SIZE_8
