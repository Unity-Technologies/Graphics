#ifndef UNIVERSAL_PARTICLES_UNLIT_GBUFER_PASS_INCLUDED
#define UNIVERSAL_PARTICLES_UNLIT_GBUFER_PASS_INCLUDED
...
VaryingsParticle vertParticleUnlitGBuffer(AttributesParticle input)
{
...
FragmentOutput fragParticleUnlitGBuffer(VaryingsParticle input)
{
    UNITY_SETUP_INSTANCE_ID(input);
    ...
    return SurfaceDataToGbuffer(surfaceData, inputData, result, kLightingInvalid);
}

#endif // UNIVERSAL_PARTICLES_UNLIT_GBUFFER_PASS_INCLUDED
