...
namespace UnityEngine.Rendering.Universal.Tests
{
    ...
    {
        // Light2DManagerDeprecated m_LightManager;
        ...
        public void Setup()
        {
            // m_LightManager = new Light2DManagerDeprecated();
        ...
        public void SetupCullingSetsBoundingSpheresAndCullingIndices()
        {
            ...
            //
            // Assert.NotNull(Light2DManagerDeprecated.boundingSpheres);
            // Assert.AreEqual(1024, Light2DManagerDeprecated.boundingSpheres.Length);
        ...
        public IEnumerator ChangingBlendStyleMovesTheLightToTheCorrectListInLightManager()
        {
            ...
            // Assert.AreEqual(0, Light2DManagerDeprecated.lights[0].Count);
            // Assert.AreSame(m_TestLight, Light2DManagerDeprecated.lights[1][0]);
        }
    }
    ...
    class MultipleObjectLight2DTests
    {
        ...
        public IEnumerator LightsAreSortedByLightOrder()
        {
            ...
            // Assert.AreSame(light3, Light2DManagerDeprecated.lights[0][0]);
            // Assert.AreSame(light1, Light2DManagerDeprecated.lights[0][1]);
            // Assert.AreSame(light2, Light2DManagerDeprecated.lights[0][2]);
        }
        ...
        public void DestroyingLastLightAlsoDestroysCullingGroup()
        {
            ...
            // Assert.IsNotNull(Light2DManagerDeprecated.cullingGroup);
            ...
            // Assert.IsNull(Light2DManagerDeprecated.cullingGroup);
        }
    }
}
