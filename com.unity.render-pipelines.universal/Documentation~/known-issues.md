...
## Renaming a URP Renderer asset to a name matching one of the Renderer Feature names causes an error

If a URP Renderer asset has any Renderer Features assigned, renaming the Renderer asset to a name matching one of the Renderer Feature names causes erroneous behavior.
