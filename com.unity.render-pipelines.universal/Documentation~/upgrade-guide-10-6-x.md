# Upgrading to version 10.6.x of the Universal Render Pipeline

This page describes how to upgrade from an older version of the Universal Render Pipeline (URP) to version 10.6.x.

## Upgrading from URP 10.0.x–10.5.x

1. URP 10.6.x does not have breaking changes compared with URP 10.0.x–10.5.x. To upgrade URP to version 10.6.x, install the new version of the package.
