...
| __Scale Post-processing__ | Enable this to allow some post-processing effects to be done downscaled at the render scale resolution. This can improve frame times at the cost of increased GPU bandwidth. The following effects are affected: bloom, chromatic aberration, tonemapping, film grain, FXAA, dithering and vignette. |
