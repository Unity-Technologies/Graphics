...
| __LOD Cross Fade__       | If you disable this option, the URP removes all LOD Cross Fade Shader variants when you build for the Unity Player, which decreases build time. |
