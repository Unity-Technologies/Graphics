...
| __Scale Post-processing__ | When this property is enabled, Unity downscales certain post-processing effects using the render scale resolution. This property affects the following effects: bloom, chromatic aberration, tone mapping, film grain, FXAA, dithering, and vignette. Enabling this option might improve frame times at the cost of increased VRAM bandwidth. |
