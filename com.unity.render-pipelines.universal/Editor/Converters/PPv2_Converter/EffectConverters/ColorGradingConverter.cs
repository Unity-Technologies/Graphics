...
public class ColorGradingConverter : PostProcessEffectSettingsConverter
{
    ...
    protected override void ConvertToTarget(BIRPRendering.PostProcessEffectSettings oldSettings, VolumeProfile targetProfile)
    {
        ...
        oldColorGrading.mixerGreenOutRedIn.Convert(newTargetProfile.greenOutRedIn, enabledState: oldColorGrading.enabled);
        oldColorGrading.mixerGreenOutGreenIn.Convert(newTargetProfile.greenOutGreenIn, enabledState: oldColorGrading.enabled);
        oldColorGrading.mixerGreenOutBlueIn.Convert(newTargetProfile.greenOutBlueIn, enabledState: oldColorGrading.enabled);
