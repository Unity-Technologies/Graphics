...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent updateVolumeFramework = EditorGUIUtility.TrTextContent("Volume Update Mode", "If this setting is on, URP updates the Volume Framework every frame for each camera. Only works in playmode.");
        ...
        void DrawAdvancedSettings()
        {
            ...
            if (m_AdvancedSettingsFoldout.value)
            {
                ...
                EditorGUILayout.PropertyField(m_VolumeFrameworkUpdateModeProp, Styles.updateVolumeFramework);
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
                EditorGUILayout.Space();
            }
