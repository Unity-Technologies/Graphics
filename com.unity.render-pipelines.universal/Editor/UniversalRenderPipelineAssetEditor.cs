...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent volumeFrameworkUpdateMode = EditorGUIUtility.TrTextContent("Volume Update Mode", "If this setting is on, URP updates the Volume Framework every frame for each camera. In the editor, volumes are updated every frame when not in playmode.");
