...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent supportsScreenSpaceShadows = EditorGUIUtility.TrTextContent("Screen Space Shadows", "if enabled resolve shadows for opaque in screen space and force enable depth prepass."); //seongdae;oneMainShadow
        ...
        SerializedProperty m_ScreenSpaceShadowsSupportedProp; //seongdae;oneMainShadow
        ...
        void OnEnable()
        {
            ...
            m_ScreenSpaceShadowsSupportedProp = serializedObject.FindProperty("m_ScreenSpaceShadowsSupported"); //seongdae;oneMainShadow
        ...
        void DrawShadowSettings()
        {
            ...
            if (m_ShadowSettingsFoldout.value)
            {
                ...
                EditorGUILayout.PropertyField(m_ScreenSpaceShadowsSupportedProp, Styles.supportsScreenSpaceShadows); //seongdae;oneMainShadow
