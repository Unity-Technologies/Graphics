...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent updateVolumeFramework = EditorGUIUtility.TrTextContent("Update Volume Framework", "If this setting is on, URP updates the Volume Framework every frame for each camera.");
        ...
        SerializedProperty m_VolumeFrameworkUpdateProp;
        ...
        void OnEnable()
        {
            ...
            m_VolumeFrameworkUpdateProp = serializedObject.FindProperty("m_VolumeFrameworkUpdateSupported");
        ...
        void DrawAdvancedSettings()
        {
            ...
            {
                bool lastVolumeFrameworkUpdateSetting = m_VolumeFrameworkUpdateProp.boolValue;
                ...
                EditorGUILayout.PropertyField(m_VolumeFrameworkUpdateProp, Styles.updateVolumeFramework);
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
                EditorGUILayout.Space();
