...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent updateVolumeFramework = EditorGUIUtility.TrTextContent("Update Volume Framework", "Controls whether the volume framework is updated every frame.");
