...
namespace UnityEditor.Rendering.Universal
{
    partial class DecalProjectorEditor
    {
        ...
        static readonly GUIContent k_DecalLayerMaskContent = EditorGUIUtility.TrTextContent("Rendering Layer Mask", "Specify the rendering layer mask to use for this projector. RenderingLayerMask of Mesh matching this value will receive the decal. Enable Layers in Decal section of HDRP settings to access it.");
