...
namespace UnityEditor.Rendering.Universal
{
    ...
    /// </summary>
    [CustomEditor(typeof(UniversalRendererDataAssetLegacy), true)]
    [Obsolete("UniversalRendererData is not longer an asset")]
    public class UniversalRendererDataAssetLegacyEditor : ScriptableRendererDataAssetLegacyEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorPrefs.GetBool("DeveloperMode"))
            {
                ...
                {
                    var resources = target as UniversalRendererDataAssetLegacy;
