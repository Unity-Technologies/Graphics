...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent supportsLodCrossFadeText = EditorGUIUtility.TrTextContent("LOD Cross Fade", "Controls whether LOD Cross Fade enabled or disabled. When disabled, Universal Rendering Pipeline removes all LOD Cross Fade Shader variants when you build for the Unity Player. This decreases build time.");
