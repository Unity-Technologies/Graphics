...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent hdrFormatText = EditorGUIUtility.TrTextContent("HDR Format", "Controls the camera render target format in HDR. High can alleviate banding artifacts at the cost of memory and performance.");
