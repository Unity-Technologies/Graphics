...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent supportsLodCrossFadeText = EditorGUIUtility.TrTextContent("LOD Cross Fade", "When disabled, Universal Rendering Pipeline removes all LOD Cross Fade Shader variants when you build for the Unity Player. This decreases build time.");
            public static GUIContent lodCrossFadeDitheringTypeText = EditorGUIUtility.TrTextContent("LOD Cross Fade Dithering Type", "Type of the LOD Cross Fade Dithering that is used to draw Renderer LOD when LODGroup has CrossFade Fade Mode selected.");
