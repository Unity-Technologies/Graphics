...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        public static class Styles
        {
            ...
            public static GUIContent softShadowQuality = EditorGUIUtility.TrTextContent("Soft Shadow Quality", "Controls the filtering quality of soft shadows. Higher quality has lower performance.");
