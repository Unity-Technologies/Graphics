...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        public static class Styles
        {
            ...
            public static GUIContent copyColorAndDepthModeText = EditorGUIUtility.TrTextContent("Copy Color And Depth Mode", "Controls if the color and depth textures are copied after the opaque or transparent pass. Affects storage bandwidth and will impact performance on mobile.");
