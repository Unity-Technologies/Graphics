...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        public static readonly CED.IDrawer Inspector = CED.Group(
            CED.AdditionalPropertiesFoldoutGroup(Styles.renderingSettingsText, Expandable.Rendering, k_ExpandedState, ExpandableAdditional.Rendering, k_AdditionalPropertiesState, DrawRendering, DrawRenderingAdditional, Draw),
            ...
            CED.AdditionalPropertiesFoldoutGroup(Styles.advancedSettingsText, Expandable.Lighting)
#if ADAPTIVE_PERFORMANCE_2_0_0_OR_NEWER
        ...
        static void DrawRendering(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            if (ownerEditor is UniversalRenderPipelineAssetEditor urpAssetEditor)
            {
                ...
                EditorGUILayout.PropertyField(serialized.customEditorResourcesAsset, Styles.customEditorResourcesAssetText);
            }
        }
