...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class UniversalRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent DepthPrimingModeInfo = new GUIContent("On certain platforms (Android, iOS and Apple TV) depth priming can only be enabled using the Forced mode. Depth priming can possibly degrade performance on the tiled GPUs common to these platforms when combined with MSAA.");
