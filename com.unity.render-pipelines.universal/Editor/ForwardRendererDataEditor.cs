...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class ForwardRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent volumeFrameworkRefreshModeLabel = EditorGUIUtility.TrTextContent("Refresh Mode", "Controls whether the volume framework is updated every frame or via custom scripts that call VolumeManager.instance.Update().");
        }
