...
namespace UnityEditor.Experimental.Rendering.Universal
{
    ...
    internal class Renderer2DDataEditor : Editor
    {
        class Styles
        {
            ...
            public static readonly GUIContent lightRTMemoryBudget = EditorGUIUtility.TrTextContent("Light RT Budget", "How many concurrent intermediate light render textures. Higher value usually leads to better performance on mobile hardware at the cost of more memory.");
