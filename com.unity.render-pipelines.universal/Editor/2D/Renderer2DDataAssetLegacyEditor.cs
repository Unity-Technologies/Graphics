...
{
    [CustomEditor(typeof(Renderer2DDataAssetLegacy), true)]
    [Obsolete("Renderer2DData is not longer an asset.")]
    internal class Renderer2DDataAssetLegacyEditor : ScriptableRendererDataAssetLegacyEditor
    {
        class Styles
        {
        ...
        Renderer2DDataAssetLegacy m_Renderer2DData;
        bool m_WasModified;
        ...
        {
            m_WasModified = false;
            m_Renderer2DData = (Renderer2DDataAssetLegacy)serializedObject.targetObject;
        ...
        private void DrawGeneral()
        {
            ...
            if (m_DefaultMaterialType.intValue == (int)Renderer2DDataAssetLegacy.Renderer2DDefaultMaterialType.Custom)
