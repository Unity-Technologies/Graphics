...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    internal static class UniversalFields
    {
        ...
        public static FieldDescriptor SurfaceOpaque =         new FieldDescriptor(kSurfaceType, "Opaque",                 "_SURFACE_TYPE_OPAQUE 1");            // not used by uber shader
        public static FieldDescriptor SurfaceTransparent =    new FieldDescriptor(kSurfaceType, "Transparent",            "_SURFACE_TYPE_TRANSPARENT 1");       // not used by uber shader
        public static FieldDescriptor BlendAdd =              new FieldDescriptor(kBlendMode,   "Add",                    "_BLENDMODE_ADD 1");                  // not used by uber shader
        public static FieldDescriptor BlendPremultiply =      new FieldDescriptor(kBlendMode,   "Premultiply",            "_ALPHAPREMULTIPLY_ON 1");            // not used by uber shader
        public static FieldDescriptor BlendMultiply =         new FieldDescriptor(kBlendMode,   "Multiply",               "_BLENDMODE_MULTIPLY 1");             // not used by uber shader
