...
half4 frag(PackedVaryings packedInput) : SV_TARGET
{
    ...
    // Retrieve the normal from the bump map or mesh normal
            ...
            float3 normal = TransformTangentToWorld(surfaceDescription.Normal, half3x3(unpacked.tangentWS.xyz, bitangent, unpacked.normalWS.xyz));
        #elif _NORMAL_DROPOFF_OS
            float3 normal = TransformObjectToWorldNormal(surfaceDescription.Normal);
