...
namespace UnityEditor.Rendering.Universal
{
    ...
    sealed class TonemappingEditor : VolumeComponentEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Tonemapping should only be used when working with HDR. Please enable HDR through the active Render Pipeline Asset.", MessageType.Warning);
                return;
            }
        }
    }
