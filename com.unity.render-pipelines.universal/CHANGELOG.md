...
- Added the option, in the Universal Render Pipeline Asset, to disable updates to the volume framework, which by default happens every frame for each camera.
