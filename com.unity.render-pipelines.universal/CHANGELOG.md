...
### Fixed
- Fixed an issue with the blend mode in Sprite-Lit-Default shader casuing alpha to overwrite the framebuffer. [case 1331392](https://issuetracker.unity3d.com/product/unity/issues/guid/1331392/)
