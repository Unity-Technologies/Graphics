...
half3 SampleLightmap(float2 lightmapUV, half3 normalWS)
{
    ...
    return SampleDirectionalLightmap(unity_Lightmap, samplerunity_Lightmap,
        unity_LightmapInd, samplerunity_Lightmap,
        lightmapUV, transformCoords, normalWS, encodedLightmap, decodeInstructions);
#elif defined(LIGHTMAP_ON)
    return SampleSingleLightmap(unity_Lightmap, samplerunity_Lightmap, lightmapUV, transformCoords, encodedLightmap, decodeInstructions);
#else
    return half3(0.0, 0.0, 0.0);
#endif
}
