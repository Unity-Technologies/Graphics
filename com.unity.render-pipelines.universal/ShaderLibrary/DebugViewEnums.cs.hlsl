...
#define DEBUGMATERIALMODE_UNLIT (1)
#define DEBUGMATERIALMODE_DIFFUSE (2)
#define DEBUGMATERIALMODE_SPECULAR (3)
#define DEBUGMATERIALMODE_ALPHA (4)
#define DEBUGMATERIALMODE_SMOOTHNESS (5)
#define DEBUGMATERIALMODE_AMBIENT_OCCLUSION (6)
#define DEBUGMATERIALMODE_EMISSION (7)
#define DEBUGMATERIALMODE_NORMAL_WORLD_SPACE (8)
#define DEBUGMATERIALMODE_NORMAL_TANGENT_SPACE (9)
