...
#define unity_SHAr                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHAr)
#define unity_SHAg                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHAg)
#define unity_SHAb                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHAb)
#define unity_SHBr                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHBr)
#define unity_SHBg                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHBg)
#define unity_SHBb                  UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHBb)
#define unity_SHC                   UNITY_ACCESS_DOTS_INSTANCED_PROP_DEFAULT_FROM_SECONDARY(float4,   unity_SHC)
