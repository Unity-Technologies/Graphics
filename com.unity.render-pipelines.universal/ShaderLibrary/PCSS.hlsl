...
real2 ComputeFibonacciSpiralDiskSampleSqrt(const in int sampleIndex, const in real diskRadius, const in real sampleCountInverse, const in real sampleCountBias)
{
...
bool BlockerSearch(inout real averageBlockerDepth, inout real numBlockers, real lightArea, real3 coord, real2 sampleJitter, Texture2D shadowMap, int sampleCount)
{
    real blockerSum = 0.0;
