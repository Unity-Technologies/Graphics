...
namespace UnityEngine.GraphToolsFoundation.CommandStateObserver
{
    public static class DispatcherExtensions
    {
        ...
        public static void RegisterCommandHandler<TCommand>(this Dispatcher self, CommandHandler<TCommand> commandHandler)
        ...
        public static void RegisterCommandHandler<TParam, TCommand>(this Dispatcher self, CommandHandler<TParam, TCommand> commandHandler, TParam handlerParam)
            where TCommand : ICommand
        {
        ...
        public static void RegisterCommandHandler<TParam1, TParam2, TCommand>(this Dispatcher self, CommandHandler<TParam1, TParam2, TCommand> commandHandler, TParam1 handlerParam1, TParam2 handlerParam2)
            where TCommand : ICommand
        {
        ...
        public static void RegisterCommandHandler<TParam1, TParam2, TParam3, TCommand>(this Dispatcher self, CommandHandler<TParam1, TParam2, TParam3, TCommand> commandHandler, TParam1 handlerParam1, TParam2 handlerParam2, TParam3 handlerParam3)
            where TCommand : ICommand
        {
        ...
        public static void RegisterCommandHandler<TParam1, TParam2, TParam3, TParam4, TCommand>(this Dispatcher self, CommandHandler<TParam1, TParam2, TParam3, TParam4, TCommand> commandHandler, TParam1 handlerParam1, TParam2 handlerParam2, TParam3 handlerParam3, TParam4 handlerParam4)
            where TCommand : ICommand
        {
