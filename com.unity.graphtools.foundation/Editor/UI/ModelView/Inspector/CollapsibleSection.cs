...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class CollapsibleSection : ModelView
    {
        ...
        protected override void PostBuildUI()
        {
            ...
            this.AddStylesheet("CollapsibleSection.uss");
        ...
        protected override void UpdateElementFromModel()
        {
            ...
            var isCollapsed = (Model as IInspectorSectionModel)?.Collapsed ?? false;
        ...
        {
            RootView.Dispatch(new CollapseInspectorSectionCommand(Model as IInspectorSectionModel, e.newValue));
        }
    }
}
