...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class DynamicBorder : VisualElement
    {
        ...
        /// </summary>
        public Color SelectionColor { get; private set; } = new Color32(68, 192, 255,255);

        /// <summary>
        /// The color of the outline when the <see cref="GraphElement"/> is only hovered.
        /// </summary>
        public Color HoverOnlyColor { get; private set; }= new Color32(68, 192, 255,128);

        /// <summary>
        /// The color of the outline when the <see cref="GraphElement"/> is highlighted.
        /// </summary>
        public Color HighlightColor { get; private set; }= new Color32(68, 0, 255,128);
        ...
        void OnGenerateVisualContent(MeshGenerationContext mgc)
        {
            ...
            rect.position += Vector2.one * (maxMargin - width -1);
            rect.size -= Vector2.one * (maxMargin - width - 1)* 2 ;

            DrawBorder(mgc, rect, wantedWidth / zoomLevel, s_Colors, corners);
        }
        ...
        /// <param name="rect">The rectangle in local coordinates.</param>
        ...
        protected virtual void DrawBorder(MeshGenerationContext mgc, Rect rect, float wantedWidth, Color[] colors,Vector2[] corners)
        {
