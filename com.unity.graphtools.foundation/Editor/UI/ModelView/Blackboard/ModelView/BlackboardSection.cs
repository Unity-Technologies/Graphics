...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class BlackboardSection : BlackboardGroup
    {
        ...
        public ISectionModel SectionModel => Model as ISectionModel;
        ...
        protected override void BuildElementUI()
        {
            ...
            m_AddButton.clicked += () =>
            {
                ...
                var selectedGroup = BlackboardView.GetSelection().OfType<IGroupModel>().FirstOrDefault(t => ReferenceEquals(t.GetSection(), Model));
        ...
        protected void ScrollViewChange()
        {
            ...
            if (BlackboardView != null && BlackboardView.BlackboardViewModel.ViewState.GetGroupExpanded((IGroupModel) Model))
            {
