...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class BlackboardHeaderPart : BaseModelViewPart
    {
        ...
        public static BlackboardHeaderPart Create(string name, IModel model, IModelView ownerElement, string parentClassName)
        {
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        protected BlackboardHeaderPart(string name, IModel model, IModelView ownerElement, string parentClassName)
