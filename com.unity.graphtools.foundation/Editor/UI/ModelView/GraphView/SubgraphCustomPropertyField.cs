...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    public class SubgraphFieldCustomPropertyField : ICustomPropertyFieldBuilder<SubgraphPropertiesField>
    {
        ...
        public VisualElement Build(ICommandTarget commandTargetView, string label, string tooltip, object obj, string propertyName)
        {
            if (obj is IGraphModel graphModel)
            {
                ...
                m_Container.AddStylesheet("SubgraphPropertiesField.uss");
