...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    class BlockDragInfos
    {
        ...
        internal ModelView DraggedBlockContext { get; set; }
        ...
        public BlockDragInfos(BlockNode draggedBlock)
        {
            ...
            DraggedBlockContext = draggedBlock.BlockNodeModel.ContextNodeModel.GetView<ContextNode>(GraphView);
        }
                ...
                using (var updater = GraphView.GraphViewModel.GraphModelState.UpdateScope)
                {
                    if (SelectedBlocks != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                var context =
                                    ((IBlockNodeModel)block.Model).ContextNodeModel.GetView<ContextNode>(GraphView);
                                if (context == null)
                                    continue;
