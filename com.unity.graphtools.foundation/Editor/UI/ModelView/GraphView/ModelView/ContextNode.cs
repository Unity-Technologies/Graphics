...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class ContextNode : CollapsibleInOutNode, IDisplaySmartSearchUI
    {
        ...
        internal bool DisplaySmartSearch(Vector2 mousePosition, int index)
        {
            ...
            var adapter = stencil.GetSearcherAdapter(GraphView.GraphModel, "Add a block", GraphView.GraphTool.Name, GraphView.GetType());
            ...
            }, dbs, filter, adapter, "create-blocks", GraphView.Window);
