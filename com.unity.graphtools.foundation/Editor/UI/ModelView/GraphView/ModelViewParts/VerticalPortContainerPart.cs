...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    /// </summary>
    public class VerticalPortContainerPart : BaseModelViewPart
    {
        /// <summary>
        ...
        public static VerticalPortContainerPart Create(string name, PortDirection portDirection, IModel model, IModelView ownerUI, string parentClassName)
        {
        ...
        protected VerticalPortContainerPart(string name, PortDirection portDirection, IModel model,
                                            IModelView ownerUI, string parentClassName)
