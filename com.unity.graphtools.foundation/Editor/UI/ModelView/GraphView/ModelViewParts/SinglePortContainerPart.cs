...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    /// </summary>
    public class SinglePortContainerPart : BaseModelViewPart
    {
        /// <summary>
        ...
        public static SinglePortContainerPart Create(string name, IModel model, IModelView ownerElement, string parentClassName)
        {
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        protected SinglePortContainerPart(string name, IModel model, IModelView ownerElement, string parentClassName)
