...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class PortConnectorPart : BaseModelViewPart
    {
        ...
        public static PortConnectorPart Create(string name, IModel model, IModelView ownerElement, string parentClassName)
        {
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        protected PortConnectorPart(string name, IModel model, IModelView ownerElement, string parentClassName)
