...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class NodeCollapseButtonPart : CollapseButtonPart
    {
        ...
        public new static NodeCollapseButtonPart Create(string name, IModel model, IModelView ownerElement, string parentClassName)
        {
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        protected NodeCollapseButtonPart(string name, IModel model, IModelView ownerElement, string parentClassName)
