...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class LoadGraphCommand : ICommand
    {
        ...
        public LoadGraphCommand(IGraphModel graph, GameObject boundObject = null,
        ...
        {
            if (ReferenceEquals(Selection.activeObject, toolState.CurrentGraph.GetGraphAsset()))
        ...
        static bool CheckGraphIntegrity(IGraphModel graphModel)
        {
            if (graphModel == null)
                return true;
