...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class MiniMapView : RootView
    {
            ...
            : base(window, parentGraphView.GraphTool)
        {
            ...
            this.AddStylesheet("MiniMapView.uss");
        ...
        public void UpdateZoomLevel()
        {
            ...
            // Hack to display zoom level in the window toolbar.
            if (Window is GraphViewMinimapWindow minimapWindow)
            {
                minimapWindow.UpdateZoomLevelLabel(zoom);
            }
