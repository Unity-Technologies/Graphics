...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class SelectionDropper : Manipulator
    {
        ...
        static IReadOnlyList<IGraphElementModel> s_EmptyElementList = new List<IGraphElementModel>();
        ...
        protected void OnMouseMove(MouseMoveEvent e)
        {
            if (m_Active && !m_Dragging && m_SelectionContainer != null)
            {
                ...
                var selection = new List<IGraphElementModel>(m_SelectionContainer.GetSelection());
        ...
        public static IReadOnlyList<IGraphElementModel> GetDraggedElements()
        {
            if (DragAndDrop.objectReferences.Length != 0)
                return s_EmptyElementList;

            return DragAndDrop.GetGenericData(k_DragAndDropKey) as IReadOnlyList<IGraphElementModel> ?? s_EmptyElementList;
        }
    }
}
