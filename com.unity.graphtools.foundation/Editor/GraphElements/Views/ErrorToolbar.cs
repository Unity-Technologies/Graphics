...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class ErrorToolbar : Toolbar
    {
        ...
        {
            var errors = GraphProcessingState.RawResults?.Errors;
        ...
        void FrameAndSelectElement(SerializableGUID errorModelGuid)
        {
            ...
            {
                var ui = errorModel.GetUI<GraphElement>(GraphView);
                if (ui != null)
                {
        ...
        public void UpdateUI()
        {
            ...
            int errorCount = GraphProcessingState.RawResults?.Errors?.Count ?? 0;
