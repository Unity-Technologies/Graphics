...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class CreateStickyNoteCommand : UndoableCommand
    {
        ...
        public static void DefaultCommandHandler(UndoStateComponent undoState, GraphViewStateComponent graphViewState, CreateStickyNoteCommand command)
        {
            ...
            {
                var stickyNote = graphViewState.GraphModel.CreateStickyNote(command.Position);
    ...
    public class UpdateStickyNoteCommand : UndoableCommand
    {
        ...
        /// <param name="graphViewState">The graph view state component.</param>
        /// <param name="command">The command.</param>
        public static void DefaultCommandHandler(UndoStateComponent undoState, GraphViewStateComponent graphViewState, UpdateStickyNoteCommand command)
        {
    ...
    public class UpdateStickyNoteThemeCommand : ModelCommand<IStickyNoteModel, string>
    {
        ...
        /// <param name="graphViewState">The graph view state component.</param>
        /// <param name="command">The command.</param>
        public static void DefaultCommandHandler(UndoStateComponent undoState, GraphViewStateComponent graphViewState, UpdateStickyNoteThemeCommand command)
        {
    ...
    public class UpdateStickyNoteTextSizeCommand : ModelCommand<IStickyNoteModel, string>
    {
        ...
        /// <param name="graphViewState">The graph view state component.</param>
        /// <param name="command">The command.</param>
        public static void DefaultCommandHandler(UndoStateComponent undoState, GraphViewStateComponent graphViewState, UpdateStickyNoteTextSizeCommand command)
        {
            if (!command.Models.Any())
                return;
