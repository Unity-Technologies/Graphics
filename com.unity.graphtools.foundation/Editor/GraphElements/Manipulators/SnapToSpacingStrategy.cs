...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    class SnapToSpacingStrategy : SnapStrategy
    {
        ...
        static readonly List<ModelUI> k_GetRectsToConsiderInViewAllUIs = new List<ModelUI>();
        void GetRectsToConsiderInView(GraphElement selectedElement)
        {
            ...
            m_GraphView.GraphModel.GraphElementModels.GetAllUIsInList(m_GraphView, null, k_GetRectsToConsiderInViewAllUIs);
