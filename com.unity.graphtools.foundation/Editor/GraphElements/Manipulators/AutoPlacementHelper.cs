...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    abstract class AutoPlacementHelper
    {
        ...
        void GetSelectedElementModels()
        {
            ...
            m_SelectedElementModels.AddRangeInternal(m_GraphView.GetSelection().Where(element => !(element is IEdgeModel) && element.IsMovable()));
        ...
        static readonly List<ModelUI> k_AdjustPlacematBoundingRectAllUIs = new List<ModelUI>();
        void AdjustPlacematBoundingRect(ref Rect boundingRect, ref List<IGraphElementModel> elementsOnBoundingRect, List<Placemat> placematsOnBoundingRect)
        {
            m_GraphView.GraphModel.GraphElementModels
                ...
                .GetAllUIsInList(m_GraphView, null, k_AdjustPlacematBoundingRectAllUIs);
