...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    class SnapToBordersStrategy : SnapStrategy
    {
        ...
        static readonly List<ModelUI> k_GetNotSelectedElementRectsInViewAllUIs = new List<ModelUI>();
        List<Rect> GetNotSelectedElementRectsInView(GraphElement selectedElement)
        {
            ...
            m_GraphView.GraphModel.GraphElementModels.GetAllUIsInList(m_GraphView, null, k_GetNotSelectedElementRectsInViewAllUIs);
            foreach (ModelUI element in k_GetNotSelectedElementRectsInViewAllUIs)
            {
                ...
                else if (element is GraphElement ge && !ge.IsSelected() && !(ignoredModels.Contains(element.Model)))
                {
                    ...
                    {
                        Rect geometryInContentViewContainerSpace = (element).parent.ChangeCoordinatesTo(m_GraphView.ContentViewContainer, ge.GetPosition());
