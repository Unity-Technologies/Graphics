...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class Edge : GraphElement, IDisplaySmartSearchUI
    {
        ...
        IPortModel m_LastUsedFromPortModel;
        IPortModel m_LastUsedToPortModel;
        ...
        {
            return m_LastUsedFromPortModel != EdgeModel.FromPort || m_LastUsedToPortModel != EdgeModel.ToPort;
        }
        ...
        public override void AddBackwardDependencies()
        {
            ...
            m_LastUsedFromPortModel = EdgeModel.FromPort;
            m_LastUsedToPortModel = EdgeModel.ToPort;
            ...
            void AddDependencies(IPortModel portModel)
            {
                ...
                ui = (portModel.NodeModel.Container as IGraphElementModel)?.GetUI(GraphView);
                if (ui != null)
                {
        ...
        public virtual bool DisplaySmartSearch(Vector2 mousePosition)
        {
            ...
            {
                GraphView.Dispatch(CreateNodeCommand.OnEdge(item, EdgeModel, mousePosition));
            });
