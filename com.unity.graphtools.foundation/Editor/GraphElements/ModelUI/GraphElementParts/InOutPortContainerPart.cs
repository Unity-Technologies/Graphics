...
namespace UnityEditor.GraphToolsFoundation.Overdrive
{
    ...
    public class InOutPortContainerPart : BaseModelUIPart
    {
        ...
        public static InOutPortContainerPart Create(string name, IGraphElementModel model, IModelUI ownerElement, string parentClassName)
        {
        ...
        protected override void UpdatePartFromModel()
        {
            switch (m_Model)
            {
                ...
                case IInputOutputPortsNodeModel portHolder:
                    m_InputPortContainer?.UpdatePorts(portHolder.GetInputPorts().Where(p => p.Orientation == PortOrientation.Horizontal), m_OwnerElement.View);
                    m_OutputPortContainer?.UpdatePorts(portHolder.GetOutputPorts().Where(p => p.Orientation == PortOrientation.Horizontal), m_OwnerElement.View);
                    break;
            }
        }
    }
