...
public class RendererShapeLights
{
    ...
    static public void Initialize(RenderPipeline2DAsset renderPipelineAsset)
    {
        ...
        m_DefaultSpecularColor = renderPipelineAsset.DefaultSpecularColor / k_OverbrightMultiplier;
        m_DefaultAmbientColor = renderPipelineAsset.DefaultAmbientColor / k_OverbrightMultiplier;
        m_DefaultRimColor = renderPipelineAsset.DefaultRimColor / k_OverbrightMultiplier;
    }

    static public void CreateRenderTextures(RenderPipeline2DAsset rpAsset)
    {
        m_FullScreenSpecularLightTexture = rpAsset.GetSpecularRenderTexture(m_RenderTextureFormatToUse);
        m_FullScreenAmbientLightTexture = rpAsset.GetAmbientRenderTexture(m_RenderTextureFormatToUse);
        m_FullScreenRimLightTexture = rpAsset.GetRimRenderTexture(m_RenderTextureFormatToUse);
