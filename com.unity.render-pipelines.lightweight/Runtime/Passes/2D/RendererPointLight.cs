...
public class RendererPointLights
{
    ...
    static RenderPipeline2DAsset m_RenderPipeline2DAsset;
    ...
    static public void Initialize(RenderPipeline2DAsset renderPipelineAsset)
    {
        ...
        m_RenderPipeline2DAsset = renderPipelineAsset;
    ...
    static public void CreateRenderTextures(RenderPipeline2DAsset rpAsset)
    {
    }
    ...
    static void RenderNormals(ScriptableRenderContext renderContext, CullingResults cullResults, DrawingSettings drawSettings, FilteringSettings filterSettings)
    {
        ...
        m_TemporaryCmdBuffer.SetRenderTarget(m_RenderPipeline2DAsset.m_NormalMapRT);
    ...
    static public void RenderLights(CommandBuffer cmdBuffer, ScriptableRenderContext renderContext, CullingResults cullResults, DrawingSettings drawSettings, FilteringSettings filterSettings, int layerToRender, Camera camera)
    {
        ...
        cmdBuffer.SetGlobalTexture("_PointLightingTex", m_RenderPipeline2DAsset.m_PointLightingRT);
        ...
        if (pointLights != null && pointLights.Count > 0)
        {
            ...
            cmdBuffer.SetRenderTarget(m_RenderPipeline2DAsset.m_PointLightingRT);
            ...
            for (int i = 0; i < pointLights.Count; i++)
            {
                ...
                if (light.IsLitLayer(layerToRender) && light.isActiveAndEnabled)
                {
                    ...
                    DrawFullScreenQuad(cmdBuffer, camera, light, m_RenderPipeline2DAsset.m_NormalMapRT, m_RenderPipeline2DAsset.m_PointLightingRT, m_PointLightingMat);
