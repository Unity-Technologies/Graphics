    ...
    public class DebugDisplaySettingsRendering : IDebugDisplaySettingsData
    {
        ...
        private class SettingsPanel : DebugDisplaySettingsPanel
        {
            ...
            public SettingsPanel(DebugDisplaySettingsRendering data)
            {
                ...
                AddWidget(new DebugUI.EnumField { displayName = "Mip Modes", autoEnum = typeof(DebugMipInfo), getter = () => (int)data.mipInfoDebugMode, setter = (value) => { }, getIndex = () => (int)data.mipInfoDebugMode, setIndex = (value) => data.mipInfoDebugMode = (DebugMipInfo)value });
