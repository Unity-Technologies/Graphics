...
namespace UnityEditor.Experimental.Rendering.LWRP
{
    ...
    class LightWeightSpriteLitSubShader : ISpriteLitSubShader
    {
        ...
        {
            Name = "Lit Pass",
            TemplatePath = "lightweightSpriteLitPass.template",
        ...
        {
            Name = "Sprite Normal",
            TemplatePath = "lightweightSpriteNormalPass.template",
            PixelShaderSlots = new List<int>
            {
                SpriteLitMasterNode.ColorSlotId,
        ...
        {
            Name = "Sprite Forward",
            TemplatePath = "lightweightSpriteForwardPass.template",
            PixelShaderSlots = new List<int>
            {
                SpriteLitMasterNode.ColorSlotId,
                SpriteLitMasterNode.NormalSlotId
        ...
        public string GetSubshader(IMasterNode masterNode, GenerationMode mode, List<string> sourceAssetDependencyPaths = null)
        {
            ...
            return LWRPSubShaderUtilities.GetSubShader<SpriteLitMasterNode>(litMasterNode, tags, options, 
