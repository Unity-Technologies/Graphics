...
namespace UnityEngine.Experimental.Rendering.LightweightPipeline
{
    ...
    public class LightweightForwardRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ref ScriptableRenderContext context, ref CullResults cullResults, ref RenderingData renderingData)
        {
            Clear();
