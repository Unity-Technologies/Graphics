...
namespace UnityEditor.Rendering
{
    ...
    public class MaterialUpgrader
    {
        ...
        {
            return GetUpgrader(upgraders, material) == null && !(material.shader.name.Contains(s_PathsWhiteList[0]) || material.shader.name.Contains(s_PathsWhiteList[1]) || material.shader.name.Contains(s_PathsWhiteList[2]));
        }
