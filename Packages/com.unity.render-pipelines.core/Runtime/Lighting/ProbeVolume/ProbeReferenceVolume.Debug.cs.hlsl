...
#define DEBUGPROBESHADINGMODE_INVALIDATED_BY_ADJUSTMENT_VOLUMES (5)
#define DEBUGPROBESHADINGMODE_SIZE (6)
#define DEBUGPROBESHADINGMODE_SKY_OCCLUSION_SH (7)
#define DEBUGPROBESHADINGMODE_SKY_DIRECTION (8)
