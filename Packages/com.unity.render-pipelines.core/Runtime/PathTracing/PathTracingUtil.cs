...
namespace UnityEngine.PathTracing.Core
{
    internal class Util
    {
        ...
        {
            shader.SetKeyword(cmd, shader.CreateLocalKeyword("LIGHT_SAMPLING_UNIFORM"), lightSamplingMode == LightSamplingMode.Uniform);
            shader.SetKeyword(cmd, shader.CreateLocalKeyword("LIGHT_SAMPLING_RIS"), lightSamplingMode == LightSamplingMode.RIS);
            shader.SetKeyword(cmd, shader.CreateLocalKeyword("LIGHT_SAMPLING_ROUND_ROBIN"), lightSamplingMode == LightSamplingMode.RoundRobin);
        }
