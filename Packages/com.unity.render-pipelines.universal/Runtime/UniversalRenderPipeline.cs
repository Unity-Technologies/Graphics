...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void InitializeCameraData(Camera camera, UniversalAdditionalCameraData additionalCameraData, bool resolveFinalTarget, out CameraData cameraData)
        {
            ...
            // Render scale is not intended to affect the scene, preview or reflection cameras so override the scale to 1.0 when it's rendered.
            bool isScenePreviewOrReflectionCamera = camera.cameraType == CameraType.SceneView || cameraData.cameraType == CameraType.Preview || cameraData.cameraType == CameraType.Reflection;
            float renderScale = isScenePreviewOrReflectionCamera ? 1.0f : cameraData.renderScale;
