...
| Property:| Function: |
|:---|:---|
| **Inner/Outer Spot Angle**| The inner and outer angles (in degrees) at the base of a spot light’s cone.<br/><br/>This property is only available when **Type** is set to **Spot**. |
| **Shape** | The shape of the area light.<br/><br/>Available options:<ul><li>**Rectangle**</li><li>**Disc**</li></ul><br/>This property is only available when **Type** is set to **Area**. |
...
| Property:| Function: |
|:---|:---|
| **Render Mode** | Use this drop-down to set the rendering priority of the selected Light. This can affect lighting fidelity and performance (refer to **Performance Considerations** below). |
