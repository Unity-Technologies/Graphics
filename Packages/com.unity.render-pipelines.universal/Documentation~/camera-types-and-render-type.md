...
For information on the properties that Unity exposes in the Inspector for a Base Camera, refer to [Camera component reference](camera-component-reference.md).
...
For information on the properties that Unity exposes in the Inspector of an Overlay Camera, refer to [Camera component reference](camera-component-reference.md).
