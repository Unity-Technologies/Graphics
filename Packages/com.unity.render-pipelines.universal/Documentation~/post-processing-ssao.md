...
For more information on the Source property, refer to the section [Implementation details](#implementation-details).
...
For more information, refer to the section [Implementation details](#implementation-details).
