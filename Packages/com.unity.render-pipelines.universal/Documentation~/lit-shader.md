...
For examples of how to use the Lit Shader, see the [Shaders samples in URP Package Samples](package-sample-urp-package-samples.md#shaders).
...
2. Click **Shader**, and select **Universal Render Pipeline** > **Lit**.
