...
namespace ShaderStrippingAndPrefiltering
{
    class ShaderBuildPreprocessorTests
    {
        ...
        public static void TestGetSupportedShaderFeaturesFromAsset_MainLightShadowCascade()
        {
            ...
            helper.urpAsset.supportsMainLightShadows = true;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures | ShaderFeatures.MainLightShadowsCascade;
            helper.AssertShaderFeaturesAndReset(expected, actual);
        ...
        public static void TestGetSupportedShaderFeaturesFromAsset_SoftShadows()
        {
            ...
            helper.urpAsset.supportsMainLightShadows = true;
            helper.urpAsset.supportsSoftShadows = true;
            expected = helper.defaultURPAssetFeatures | ShaderFeatures.MainLightShadowsCascade | ShaderFeatures.SoftShadows;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            helper.AssertShaderFeaturesAndReset(expected, actual);
            ...
            helper.urpAsset.supportsAdditionalLightShadows = true;
            helper.urpAsset.supportsSoftShadows = true;
            expected = helper.defaultURPAssetFeatures | ShaderFeatures.AdditionalLightsPixel | ShaderFeatures.SoftShadows;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            helper.AssertShaderFeaturesAndReset(expected, actual);
        ...
        [Test]
        public static void TODO_TestGetSupportedShaderFeaturesFromAsset_MixedLighting()
        {
            /*
            TestHelper helper = new ();
            ShaderFeatures actual;
            ...
            helper.urpAsset.supportsMixedLighting = false;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures;
            helper.AssertShaderFeaturesAndReset(expected, shaderFeatures);
        ...
        [Test]
        public static void TODO_TestGetSupportedShaderFeaturesFromAsset_TerrainHoles()
        {
            /*
            TestHelper helper = new ();
            ShaderFeatures actual;
            ...
            helper.urpAsset.supportsTerrainHoles = false;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures;
            helper.AssertShaderFeaturesAndReset(expected, shaderFeatures);
        ...
        [Test]
        public static void TODO_TestGetSupportedShaderFeaturesFromAsset_UseFastSRGBLinearConversion()
        {
            /*
            TestHelper helper = new ();
            ShaderFeatures actual;
            ...
            helper.urpAsset.useFastSRGBLinearConversion = false;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures;
            helper.AssertShaderFeaturesAndReset(expected, shaderFeatures);
        ...
        [Test]
        public static void TODO_TestGetSupportedShaderFeaturesFromAsset_RenderingLayers()
        {
            /*
            TestHelper helper = new ();
            ShaderFeatures actual;
            ...
            helper.urpAsset.useRenderingLayers = false;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures;
            helper.AssertShaderFeaturesAndReset(expected, shaderFeatures);
        ...
        [Test]
        public static void TODO_TestGetSupportedShaderFeaturesFromAsset_LightCookies()
        {
            /*
            TestHelper helper = new ();
            ShaderFeatures actual;
            ...
            helper.urpAsset.supportsLightCookies = false;
            actual = helper.GetSupportedShaderFeaturesFromAsset();
            expected = helper.defaultURPAssetFeatures;
            helper.AssertShaderFeaturesAndReset(expected, shaderFeatures);
