...
namespace ShaderStrippingAndPrefiltering
{
    ...
    class ShaderScriptableStripperTests
    {
        ...
        const string k_ProbeVolumeL1 = "PROBE_VOLUMES_L1";
        const string k_ProbeVolumeL2 = "PROBE_VOLUMES_L2";
        ...
        public void StripUnsupportedVariants_LightmapProbes(Shader shader, bool expectedLightmapProbes)
        {
            ...
            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>{ShaderKeywordStrings.LIGHTMAP_ON, k_ProbeVolumeL1};
            ...
            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>{ShaderKeywordStrings.LIGHTMAP_ON, k_ProbeVolumeL2};
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants_LightmapProbes(ref helper.data));
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants(ref helper.data));
            ...
            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>{ShaderKeywordStrings.DYNAMICLIGHTMAP_ON, k_ProbeVolumeL1};
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants_LightmapProbes(ref helper.data));
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants(ref helper.data));

            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>{ShaderKeywordStrings.DYNAMICLIGHTMAP_ON, k_ProbeVolumeL2};
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants_LightmapProbes(ref helper.data));
            helper.AreEqual(expectedLightmapProbes, helper.stripper.StripUnsupportedVariants(ref helper.data));
        }
        ...
        {
            TestHelper helper;
            List<string> passKeywords = new List<string>() { k_ProbeVolumeL1, k_ProbeVolumeL2 };
            ...
            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>() { k_ProbeVolumeL1 };
            TestHelper.s_PassKeywords = passKeywords;
            helper.AreEqual(shader != null, helper.stripper.StripUnusedFeatures_ProbesVolumes(ref helper.featureStripTool));

            helper = new TestHelper(shader, ShaderFeatures.None);
            TestHelper.s_EnabledKeywords = new List<string>() { k_ProbeVolumeL2 };
            TestHelper.s_PassKeywords = passKeywords;
            helper.AreEqual(shader != null, helper.stripper.StripUnusedFeatures_ProbesVolumes(ref helper.featureStripTool));
