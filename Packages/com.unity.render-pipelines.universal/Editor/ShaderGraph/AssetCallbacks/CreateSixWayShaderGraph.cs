    ...
    internal static class CreateSixWayShaderGraph
    {
        ...
        public static void CreateLitGraph()
        {
            ...
            var blockDescriptors = new[]
            {
                ...
                UniversalSixWaySubTarget.SurfaceDescriptionSixWay.MapRightTopBack,
                UniversalSixWaySubTarget.SurfaceDescriptionSixWay.MapLeftBottomFront,
                UniversalSixWaySubTarget.SurfaceDescriptionSixWay.AbsorptionStrength,
