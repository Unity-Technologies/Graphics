...
When using the **Specular** workflow, supply this value to the **Specular** block in the [Master Stack](Master-Stack.md). When using the **Metallic** workflow, supply it to the **Base Color** block instead.
