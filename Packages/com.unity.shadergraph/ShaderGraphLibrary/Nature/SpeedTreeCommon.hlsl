...
void DoLeafFacing_float(float3 vVertexLocalPosition, float3 vAnchorPosition, out float3 vVertexLocalPositionIn) // SG stub
{
    vVertexLocalPositionIn = DoLeafFacing(vVertexLocalPosition, vAnchorPosition);
}


#if defined(SPEEDTREE_VERSION_8)
...
#endif // SPEEDTREE_VERSION_8

#if defined(SPEEDTREE_VERSION_9)

#endif // SPEEDTREE_VERSION_9
