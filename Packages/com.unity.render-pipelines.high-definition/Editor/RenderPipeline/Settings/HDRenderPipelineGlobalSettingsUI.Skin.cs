...
namespace UnityEditor.Rendering.HighDefinition
{
    internal partial class HDRenderPipelineGlobalSettingsUI
    {
        internal class Styles
        {
            ...
            public static readonly GUIContent renderPipelineGPUResidentDrawerResourcesContent = EditorGUIUtility.TrTextContent("GPU Resident Drawer Resources", "Set of resources that need to be loaded when the GPU Resident Drawer is enabled");
