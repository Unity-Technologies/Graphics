    ...
    static class CreateSixWayShaderGraph
    {
        ...
        public static void CreateSixWayGraph()
        {
            ...
            var blockDescriptors = new[]
            {
                ...
                HDSixWaySubTarget.SurfaceDescriptionSixWay.AbsorptionStrength,
                HDSixWaySubTarget.SurfaceDescriptionSixWay.MapRightTopBack,
                HDSixWaySubTarget.SurfaceDescriptionSixWay.MapLeftBottomFront,
