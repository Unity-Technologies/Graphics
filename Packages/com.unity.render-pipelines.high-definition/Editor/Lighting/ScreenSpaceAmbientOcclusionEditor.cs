...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class ScreenSpaceAmbientOcclusionEditor : VolumeComponentWithQualityEditor
    {
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent occulderMotionRejection = EditorGUIUtility.TrTextContent("Occluder Motion Rejection", "When enabled, the occluder's movement should be considered a valid rejection condition.");
            public static readonly GUIContent receiverMotionRejection = EditorGUIUtility.TrTextContent("Receiver Motion Rejection", "When enabled, the receiver's movement should be considered a valid rejection condition.");
