...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    sealed partial class WaterDeformerEditor : Editor
    {
        ...
        static internal void ResolutionField(SerializedProperty resolution, GUIContent title)
        {
            ...
            BeginProperty(rect, title, resolution);
            GUILayout.BeginHorizontal();
            {
                rect = PrefixLabel(rect, title);
                ...
                {
                    BeginChangeCheck();
                    int value = DelayedIntField(rect, prop.intValue);
                    if (EndChangeCheck())
        ...
        static void ResetWaterDeformer(MenuCommand menuCommand)
        {
            ...
            switch (deformer.type)
            {
                ...
                case WaterDeformerType.Texture:
                    ...
                    break;
                case WaterDeformerType.Material:
                    WaterDeformerPresets.ApplyWaterMaterialDeformerPreset(deformer);
                    break;
                default:
                    break;
            }
