...
- [Decals](Decal.md).
- Vegetation, although you can use [mixed tracing](Override-Screen-Space-Reflection.md#mixed-tracing) to include it in ray traced reflections. HDRP considers vegetation separate from terrain.
