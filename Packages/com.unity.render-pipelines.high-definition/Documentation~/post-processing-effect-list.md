...
The High Definition Render Pipeline (HDRP) includes a variety of post-processing effects you can use to alter the final look of rendered frames in your application. Post-processing effects in HDRP use the [Volume](Volumes.md) framework. The list of effects is as follows:
