# AxF Material Inspector Reference
...
New Materials in HDRP use the [Lit Shader](lit-material.md) by default. To create an AxF Material from scratch, create a Material and then make it use the AxF Shader. To do this:
