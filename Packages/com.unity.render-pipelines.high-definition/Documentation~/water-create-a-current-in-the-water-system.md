...
A current map is a texture that modifies the local swell or agitation of a water surface current.
Current maps are different from flow maps because the water flow can’t stop and it always has a direction.
