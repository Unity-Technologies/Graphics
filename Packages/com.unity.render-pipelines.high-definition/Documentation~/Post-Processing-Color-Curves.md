...
**Color Curves** uses the [Volume](understand-volumes.md) framework, so to enable and modify **Color Curves** properties, you must add a **Color Curves** override to a [Volume](understand-volumes.md) in your Scene. To add **Color Curves** to a Volume:

1. In the Scene or Hierarchy view, select a GameObject that contains a Volume component to view it in the Inspector.
2. In the Inspector, go to **Add Override** > **Post-processing** and select **Color Curves**. HDRP now applies **Color Curves** to any Camera this Volume affects.
