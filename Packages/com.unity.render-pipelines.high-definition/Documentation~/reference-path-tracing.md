...
**Denoising** set to NVIDIA Optix, **Separate Volumetric Fog** set to Off

![](Images/RayTracingPathTracing7.png)

**Denoising** set to NVIDIA Optix, **Separate Volumetric Fog** set to On
