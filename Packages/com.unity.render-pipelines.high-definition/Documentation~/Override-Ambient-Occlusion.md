...
* To enable Ambient Occlusion in your HDRP Asset go to **Lighting** > **Screen Space Ambient Occlusion**.
* To enable Ambient Occlusion in your Frame Settings go to **Edit** > **Project Settings** > **Graphics** > **HDRP Global Settings** > **Frame Settings (Default Values)** > **Camera** > **Lighting** > **Screen Space Ambient Occlusion**.
