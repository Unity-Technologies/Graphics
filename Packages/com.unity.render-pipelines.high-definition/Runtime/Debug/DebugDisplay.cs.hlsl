...
#define FULLSCREENDEBUGMODE_CAPSULE_SHADOWS (11)
#define FULLSCREENDEBUGMODE_PRE_REFRACTION_COLOR_PYRAMID (12)
#define FULLSCREENDEBUGMODE_DEPTH_PYRAMID (13)
#define FULLSCREENDEBUGMODE_FINAL_COLOR_PYRAMID (14)
#define FULLSCREENDEBUGMODE_LIGHT_CLUSTER (15)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_GLOBAL_ILLUMINATION (16)
#define FULLSCREENDEBUGMODE_RECURSIVE_RAY_TRACING (17)
#define FULLSCREENDEBUGMODE_RAY_TRACED_SUB_SURFACE (18)
#define FULLSCREENDEBUGMODE_VOLUMETRIC_CLOUDS (19)
#define FULLSCREENDEBUGMODE_VOLUMETRIC_CLOUDS_SHADOW (20)
