...
#define FULLSCREENDEBUGMODE_LENS_FLARE_SCREEN_SPACE (34)
#define FULLSCREENDEBUGMODE_COMPUTE_THICKNESS (35)
#define FULLSCREENDEBUGMODE_HIGH_QUALITY_LINES (36)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (37)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (38)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (39)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (40)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (41)
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (42)
