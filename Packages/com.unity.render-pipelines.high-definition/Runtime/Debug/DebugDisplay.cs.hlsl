...
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (25)
#define FULLSCREENDEBUGMODE_NAN_TRACKER (26)
#define FULLSCREENDEBUGMODE_COLOR_LOG (27)
#define FULLSCREENDEBUGMODE_DEPTH_OF_FIELD_COC (28)
#define FULLSCREENDEBUGMODE_TRANSPARENCY_OVERDRAW (29)
#define FULLSCREENDEBUGMODE_QUAD_OVERDRAW (30)
#define FULLSCREENDEBUGMODE_LOCAL_VOLUMETRIC_FOG_OVERDRAW (31)
#define FULLSCREENDEBUGMODE_VERTEX_DENSITY (32)
#define FULLSCREENDEBUGMODE_REQUESTED_VIRTUAL_TEXTURE_TILES (33)
#define FULLSCREENDEBUGMODE_LENS_FLARE_DATA_DRIVEN (34)
#define FULLSCREENDEBUGMODE_LENS_FLARE_SCREEN_SPACE (35)
#define FULLSCREENDEBUGMODE_COMPUTE_THICKNESS (36)
#define FULLSCREENDEBUGMODE_HIGH_QUALITY_LINES (37)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (38)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (39)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (40)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (41)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (42)
