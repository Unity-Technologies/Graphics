    ...
    public class HDAdditionalMeshRendererSettings : MonoBehaviour, ILineRenderer
    {
        ...
        internal void OnValidate()
        {
            ...
            if (m_OldMaterial != material)
            {
...
#else
                var library = HDRenderPipelineGlobalSettings.instance.renderPipelineResources.assets.computeMaterialLibrary;
                ...
                if (!library.Get(material.shader, out m_VertexSetupCompute))
                {
