...
namespace UnityEngine.Rendering.HighDefinition
{
    partial class Hair : RenderPipelineMaterial
    {
        ...
        public override void Build(HDRenderPipelineAsset hdAsset, HDRenderPipelineRuntimeResources defaultResources)
        {
            ...
            m_HairAttenuationLUT            = defaultResources.textures.hairAttenuationLUT;
            m_HairAzimuthalScatteringLUT    = defaultResources.textures.hairAzimuthalScatteringLUT;
            m_HairLongitudinalScatteringLUT = defaultResources.textures.hairLongitudinalScatteringLUT;
        }
