...
#define GBUFFERMATERIAL_RENDERING_LAYERS 1
#else
#define GBUFFERMATERIAL_RENDERING_LAYERS 0
#endif
...
#define GBUFFERMATERIAL_COUNT (4 + GBUFFERMATERIAL_VTFEEDBACK + GBUFFERMATERIAL_RENDERING_LAYERS + GBUFFERMATERIAL_SHADOWMASK)
