...
namespace UnityEditor.VFX
{
    partial struct VFXAttribute
    {
        ...
        public static readonly VFXAttribute Seed = new VFXAttribute("seed", VFXValueType.Uint32, "A unique seed used for random number computations.");
        public static readonly VFXAttribute OldPosition = new VFXAttribute("oldPosition", VFXValueType.Float3, "This attribute is a storage helper if you want to back up the current position of a particle, before integrating its velocity.", VFXVariadic.False, SpaceableType.Position);
        public static readonly VFXAttribute Position = new VFXAttribute("position", VFXValueType.Float3, "The position of the particle expressed in the space (World or Local) of its parent system.", VFXVariadic.False, SpaceableType.Position);
        public static readonly VFXAttribute Velocity = new VFXAttribute("velocity", VFXValueType.Float3, "The velocity of the particle expressed as a 3D Vector in the Space (World/Local) of the parent system.", VFXVariadic.False, SpaceableType.Vector);
        public static readonly VFXAttribute Direction = new VFXAttribute("direction", VFXValue.Constant(new Vector3(0.0f, 0.0f, 1.0f)), "A vector3 attribute that can be used to store arbitrary data. By default, this attributes is set by numerous blocks like :Shape Position to store the Shapes’s normals.", VFXVariadic.False, SpaceableType.Vector);
        public static readonly VFXAttribute Color = new VFXAttribute("color", VFXValue.Constant(Vector3.one), "The color of the particle.");
        public static readonly VFXAttribute Alpha = new VFXAttribute("alpha", VFXValue.Constant(1.0f), "The transparency value of the particle. Transparent particles with a value of 0 or less are invisible.");
        public static readonly VFXAttribute Size = new VFXAttribute("size", VFXValue.Constant(kDefaultSize), "The uniform size of the particles expressed in meter. If present, this attribute is multiplied by the scale attribute to get the final size of the rendered particles. The default value is 0.1.");
        ...
        public static readonly VFXAttribute Lifetime = new VFXAttribute("lifetime", VFXValue.Constant(1.0f), "Indicates how long the particle can stay alive. By default, If the particle’s age exceeds its lifetime, then the particle will be destroyed by the Update Context.");
        public static readonly VFXAttribute Age = new VFXAttribute("age", VFXValueType.Float, "The age of the particles since it spawns, expressed in seconds. By default, age is updated by the Update Context that will also destroy the particle if the particle’s age exceeds its lifetime.");
        ...
        public static readonly VFXAttribute ParticleId = new VFXAttribute("particleId", VFXValueType.Uint32, "Outputs the ID of the particle. Each particle gets assigned an incremental unique ID value when it is created.");
        public static readonly VFXAttribute AxisX = new VFXAttribute("axisX", VFXValue.Constant(Vector3.right), "Determines which is the X (right-left) axis of the particle. This is used to properly orient the particle. The Orient Block in the update context is usually used to set up this attribute.", VFXVariadic.False, SpaceableType.Vector);
        public static readonly VFXAttribute AxisY = new VFXAttribute("axisY", VFXValue.Constant(Vector3.up), "Determines which is the Y (up-down) axis of the particle. This is used to properly orient the particle. The Orient Block in the update context is usually used to set up this attribute.", VFXVariadic.False, SpaceableType.Vector);
        public static readonly VFXAttribute AxisZ = new VFXAttribute("axisZ", VFXValue.Constant(Vector3.forward), "Determines which is the Z (forward-back) axis of the particle. This is used to properly orient the particle. The Orient Block in the update context is usually used to set up this attribute.", VFXVariadic.False, SpaceableType.Vector);
        public static readonly VFXAttribute Alive = new VFXAttribute("alive", VFXValue.Constant(true), "Indicates whether a particle is alive or should be destroyed. Can also be used within an output to toggle the rendering of that particle, without destroying it.");
        public static readonly VFXAttribute Mass = new VFXAttribute("mass", VFXValue.Constant(1.0f), "The mass of the particle, which is used in many physics calculations. The value is expressed in Kg/dm^3 and the default mass is 1.0 (1\u00a0kg per liter of water).");
        public static readonly VFXAttribute TargetPosition = new VFXAttribute("targetPosition", VFXValueType.Float3, "The attributes is usually used to store the position where the particle is aiming to go. Blocks like the ‘Position Sequential Shape’ can set it to be use in the output. But this attribute is also used by the line output and can be used as a storage helper.", VFXVariadic.False, SpaceableType.Position);
        public static readonly VFXAttribute EventCount = new VFXAttribute("eventCount", VFXValueType.Uint32, string.Empty);
        public static readonly VFXAttribute SpawnTime = new VFXAttribute("spawnTime", VFXValueType.Float, "Outputs the time since the Spawn context was triggered. To use, add a 'Set Spawn Time' block to the desired Spawn Context.");
        public static readonly VFXAttribute ParticleIndexInStrip = new VFXAttribute("particleIndexInStrip", VFXValueType.Uint32, "Outputs the index of the particle within its particle strip. Each particle gets assigned an incremental index value for the strip within which it is created. This attribute is available in systems using the 'Particle Strip' data type.");
        public static readonly VFXAttribute SpawnIndex = new VFXAttribute("spawnIndex", VFXValueType.Uint32, "The index of the particle within all the particles spawned in the current frame.");
        public static readonly VFXAttribute StripIndex = new VFXAttribute("stripIndex", VFXValueType.Uint32, "The index of the current strip. Each strip gets assigned an incremental value when it is created. This attribute is available in systems using the 'Particle Strip' data type.");
