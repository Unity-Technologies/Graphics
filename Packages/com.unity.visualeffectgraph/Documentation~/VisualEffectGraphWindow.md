...
For more information, refer to [Blackboard](Blackboard.md).
...
* Trigger Events
* Use Debug Modes
* Record the bounds of the visual effect. For more information about bounds recording, refer to [Visual effect bounds](visual-effect-bounds.md).
