...
| **Use as Template** | Marks the asset as a template and displays it in the Templates window. If you activate this option, you must at least fill in the **Template Name** property. |
| **Template Name** | The display name of the template in the Templates window. |
| **Template Category** | The category in which to display the template in the Templates window. |
| **Template Description** | The description of the template, displayed in the detail panel of the Templates window. |
| **Template Icon** | An optional icon to display next to the template name in the Templates window. |
| **Template Thumbnail** | An optional image to showcase the template's VFX in the detail panel of the Templates window. |
