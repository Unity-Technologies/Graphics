...
namespace UnityEditor.VFX
{
    class VFXParameter : VFXSlotContainerModel<VFXModel, VFXModel>
    {
        ...
        public override void OnCopyLinkOtherSlot(VFXSlot mySlot, VFXSlot prevOtherSlot, VFXSlot newOtherSlot)
        {
        ...
        public override void OnCopyLinkMySlot(VFXSlot myPrevSlot, VFXSlot myNewSlot, VFXSlot otherSlot)
        {
            foreach (var node in m_Nodes)
            {
                for (int i = 0; i < node.linkedSlots.Count; ++i)
