...
namespace UnityEditor.VFX
{
    ...
    abstract class VFXOperatorBinaryUintOperationOne : VFXOperator
    {
        public class InputProperties
        {
            static public uint FallbackValue = 1;
            [Tooltip("The first operand.")]
    ...
    abstract class VFXOperatorBinaryUintOperationZero : VFXOperator
    {
        public class InputProperties
        {
    ...
    abstract class VFXOperatorUnaryUintOperation : VFXOperator
    {
        public class InputProperties
        {
            [Tooltip("The operand.")]
