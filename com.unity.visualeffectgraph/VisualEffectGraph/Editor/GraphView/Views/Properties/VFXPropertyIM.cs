...
namespace UnityEditor.VFX.UI
{
    abstract class VFXPropertyIM
    {
        ...
        static Dictionary<Type, Type> m_PropertyIMTypes = new Dictionary<Type, Type>
        {
            ...
            {typeof(Texture2DArray), typeof(VFXObjectPropertyIM<Texture2DArray>) },
            {typeof(Texture3D), typeof(VFXObjectPropertyIM<Texture3D>) },
            {typeof(Cubemap), typeof(VFXObjectPropertyIM<Cubemap>) },
            {typeof(CubemapArray), typeof(VFXObjectPropertyIM<CubemapArray>) },
