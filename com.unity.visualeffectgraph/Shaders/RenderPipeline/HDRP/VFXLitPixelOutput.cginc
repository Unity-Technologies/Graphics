...
{	
	...
	SimpleLightLoop(GetWorldSpaceNormalizeViewDir(i.VFX_VARYING_POSWS), posInput, preLightData, bsdfData, builtinData, featureFlags, diffuseLighting, specularLighting);
	#else
