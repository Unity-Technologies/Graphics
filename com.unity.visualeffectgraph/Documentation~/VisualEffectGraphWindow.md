...
| **Compile** <br/> ![](Images/compile.png)             | **Action** : Recompiles the open Visual Effect Graph.<br/>**Dropdown**:<br/><br/>&#8226; **Auto Compile**: Toggles Auto-compilation of the Visual Effect Graph.<br/>&#8226; **Runtime Mode**: Forces optimized compilation, even when the editor is open.<br/>&#8226; **Shader Validation**: Forces Shader compilation when the effect recompiles, even if no visual effect is visible. This displays the Shader errors in the Scene.|
