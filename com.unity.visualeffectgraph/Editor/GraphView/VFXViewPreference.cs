...
namespace UnityEditor.VFX
{
    static class VFXViewPreference
    {
        ...
        private static string m_userTemplateDirectory = "";
        ...
        public static string userTemplateDirectory
        {
            ...
            {
                LoadIfNeeded();
                return m_userTemplateDirectory;
            }
        }
        ...
        public const string userTemplateDirectoryKey = "VFX.UserTemplateDirectory";
        ...
        private static void LoadIfNeeded()
        {
            if (!m_Loaded)
            {
                ...
                m_userTemplateDirectory = EditorPrefs.GetString(userTemplateDirectoryKey, "");
                m_Loaded = true;
            }
        }
        ...
        class VFXSettingsProvider : SettingsProvider
        {
            ...
            public override void OnGUI(string searchContext)
            {
                using (new SettingsWindow.GUIScope())
                {
                    ...
                    m_userTemplateDirectory = EditorGUILayout.TextField(new GUIContent("User Systems", "Directory for user-generated VFX templates (e.g. Assets/VFX/Templates)"), m_userTemplateDirectory);
                    ...
                    if (GUI.changed)
                    {
                        ...
                        EditorPrefs.SetString(userTemplateDirectoryKey, m_userTemplateDirectory);
                    }
                }
