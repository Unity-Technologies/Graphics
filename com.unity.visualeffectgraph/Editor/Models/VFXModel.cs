...
namespace UnityEditor.VFX
{
    ...
    abstract class VFXModel : VFXObject
    {
        ...
        static public VFXExpression ConvertSpace(VFXExpression input, VFXCoordinateSpace srcSpace, VFXSlot targetSlot, VFXCoordinateSpace space)
        {
            if (targetSlot.spaceable)
            {
                if (targetSlot.space != space)
                {
                    ...
                    input = ConvertSpace(input, srcSpace, spaceType, space);
                }
            }
            return input;
        }
