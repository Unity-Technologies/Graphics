...
namespace UnityEditor.VFX
{
    class VFXOutputUpdate : VFXContext
    {
        ...
        {
            return HasFeature(flags, Features.MotionVector) || HasFeature(flags, Features.LOD);
        }
        ...
        public override VFXTaskType taskType { get { return isPerCamera ? VFXTaskType.CameraUpdate : VFXTaskType.Update; } }
