...
namespace UnityEditor.VFX.Operator
{
    ...
    class SampleSDF : VFXOperator
    {
        ...
        public class OutputProperties
        {
            ...
            [Tooltip("Outputs the outgoing direction of the SDF at the specified position.")]
        ...
        protected override sealed VFXExpression[] BuildExpression(VFXExpression[] inputExpression)
        {
            ...
            VFXExpression normalExpr = new VFXExpressionSampleSDFNormal(inputExpression[0],inverseTRS, uvw, inputExpression[3]);
            return new[] { distanceExpr, normalExpr };
        }
