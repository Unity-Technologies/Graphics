...
namespace UnityEditor.VFX
{
    ...
    struct VFXAttribute
    {
        ...
        [Tooltip("Outputs the total particle count within the current strip. This attribute is available in systems using the 'Particle Strip' data type.")]
        public static readonly VFXAttribute SpanwIndexInStrip       = new VFXAttribute("spawnIndexInStrip", VFXValueType.Uint32);
        ...
        public static readonly VFXAttribute[] AllAttributeReadOnly = new VFXAttribute[] { Seed, ParticleId, SpawnTime, ParticleIndexInStrip, SpawnIndex, StripIndex, ParticleCountInStrip, SpanwIndexInStrip };
