...
{
    class InitializeVariantProviderGTF : VariantProvider
    {
    ...
    [VFXInfoGTF(variantProvider = typeof(InitializeVariantProviderGTF))]
    class VFXBasicInitializeGTF : VFXContext
    {
        public VFXBasicInitializeGTF() : base(VFXContextType.Init, VFXDataType.SpawnEvent, VFXDataType.None) { }
        ...
        private bool hasDynamicSourceCount => GetData() != null && ((VFXDataParticle)GetData()).hasDynamicSourceCount;
