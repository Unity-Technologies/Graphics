...
{
    class InlineTypeProviderGTF : VariantProvider
    {
    ...
    [VFXInfoGTF(category = "Inline", variantProvider = typeof(InlineTypeProviderGTF))]
    class VFXInlineOperatorGTF : VFXOperator
    {
