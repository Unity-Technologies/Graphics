...
namespace UnityEditor.ShaderGraph.UnitTests
{
    ...
    class MessageManagerTests
    {
        ...
        public void Setup()
        {
            ...
            m_ComplexMgr.AddOrAppendError(p0, node0.id, e0);
            m_ComplexMgr.AddOrAppendError(p0, node0.id, e1);
            m_ComplexMgr.AddOrAppendError(p0, node1.id, e2);
            m_ComplexMgr.AddOrAppendError(p1, node0.id, e1);
            m_ComplexMgr.AddOrAppendError(p1, node1.id, e0);
            m_ComplexMgr.AddOrAppendError(p1, node1.id, e1);
            m_ComplexMgr.AddOrAppendError(p1, node2.id, e3);
        }
        ...
        {
            m_EmptyMgr.AddOrAppendError(p0, node0.id, e0);

            var ret = GetListFrom(m_EmptyMgr);
            Assert.IsNotEmpty(ret);
            Assert.AreEqual(node0.id, ret[0].Key);
        ...
        {
            m_EmptyMgr.AddOrAppendError(p0, node0.id, e0);
            m_EmptyMgr.AddOrAppendError(p0, node0.id, e1);
            m_EmptyMgr.AddOrAppendError(p1, node0.id, e2);

            GetListFrom(m_EmptyMgr);

            Assert.AreEqual(2, m_EmptyMgr.Messages[p0][node0.id].Count);
            Assert.AreEqual(e0, m_EmptyMgr.Messages[p0][node0.id][0]);
            Assert.AreEqual(e1, m_EmptyMgr.Messages[p0][node0.id][1]);
            Assert.AreEqual(1, m_EmptyMgr.Messages[p1][node0.id].Count);
            Assert.AreEqual(e2, m_EmptyMgr.Messages[p1][node0.id][0]);
        }
        ...
        public void RemoveNode_DoesNotDirty_IfNodeDoesNotExist()
        {
            ...
            m_EmptyMgr.RemoveNode(node1.id);
        ...
        public void RemoveNode_DirtiesList_IfNodeExists()
        {
            ...
            m_EmptyMgr.RemoveNode(node0.id);
        ...
        {
            m_EmptyMgr.AddOrAppendError(p0, node0.id, e0);
            m_EmptyMgr.AddOrAppendError(p1, node0.id, e1);
            m_EmptyMgr.RemoveNode(node0.id);
        ...
        public void Warnings_SortedAfterErrors()
        {
            ...
            mixedMgr.AddOrAppendError(p0, node0.id, e0);
            mixedMgr.AddOrAppendError(p0, node0.id, w0);
            mixedMgr.AddOrAppendError(p0, node0.id, e1);
            mixedMgr.AddOrAppendError(p0, node0.id, w1);
        ...
        public void Warnings_FromDifferentProviders_SortedAfterErrors()
        {
            ...
            mixedMgr.AddOrAppendError(p0, node0.id, e0);
            mixedMgr.AddOrAppendError(p0, node0.id, w0);
            mixedMgr.AddOrAppendError(p1, node0.id, e1);
            mixedMgr.AddOrAppendError(p1, node0.id, w1);
        ...
        {
            m_EmptyMgr.AddOrAppendError(p0, node0.id, e0);
            m_EmptyMgr.AddOrAppendError(p0, node1.id, e1);

            var ret = GetListFrom(m_EmptyMgr);
            Assert.AreEqual(2, ret.Count);
            Assert.AreEqual(node0.id, ret[0].Key);
            Assert.AreEqual(e0, ret[0].Value[0]);
            Assert.AreEqual(node1.id, ret[1].Key);
        ...
        public void ClearAllFromProvider_ZerosMessageLists()
        {
            ...
            Assert.AreEqual(node2.id, ret[2].Key);
        ...
        public void GetList_RemovesZeroLengthLists()
        {
            m_ComplexMgr.ClearAllFromProvider(p1);
            var ret = GetListFrom(m_ComplexMgr);
            Assert.IsNotEmpty(ret.Where(kvp => kvp.Key.Equals(node2.id)));
            Assert.IsEmpty(ret.First(kvp => kvp.Key.Equals(node2.id)).Value);

            ret = GetListFrom(m_ComplexMgr);
            Assert.IsEmpty(ret.Where(kvp => kvp.Key.Equals(node2.id)));
        }
        ...
        public void ClearNodesFromProvider_ClearsNodes()
        {
            ...
            var ret = GetListFrom(m_ComplexMgr);
            Assert.AreEqual(2, ret.Find(kpv => kpv.Key.Equals(node0.id)).Value.Count);
            Assert.IsEmpty(ret.Find(kvp => kvp.Key.Equals(node2.id)).Value);
        }
        ...
        public void ClearNodesFromProvider_LeavesOtherNodes()
        {
            ...
            var ret = GetListFrom(m_ComplexMgr);
            Assert.AreEqual(3, ret.Find(kpv => kpv.Key.Equals(node1.id)).Value.Count);
        }
    }
}
