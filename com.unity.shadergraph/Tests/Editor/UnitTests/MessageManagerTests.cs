...
namespace UnityEditor.ShaderGraph.UnitTests
{
    ...
    {
        public Dictionary<object, Dictionary<AbstractMaterialNode, List<ShaderMessage>>> Messages
        {
    ...
    class MessageManagerTests
    {
        ...
        AbstractMaterialNode node0 = new AddNode();
        AbstractMaterialNode node1 = new AddNode();
        AbstractMaterialNode node2 = new AddNode();
        ...
        static List<KeyValuePair<AbstractMaterialNode, List<ShaderMessage>>> GetListFrom(MessageManager mgr)
        {
            return new List<KeyValuePair<AbstractMaterialNode, List<ShaderMessage>>>(mgr.GetNodeMessages());
        }
