...
namespace UnityEditor.Graphing.UnitTests
{
    ...
    public class BaseMaterialGraphTests
    {
        ...
        public void TestRemoveNodeFromBaseMaterialGraphCleansEdges()
        {
            ...
            var createdEdge = graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), inputNode.FindSlot<MaterialSlot>(TestableNode.Input0));
        ...
        public void TestCanFindNodeInBaseMaterialGraph()
        {
            ...
            Assert.AreEqual(1, graph.GetNodes<AbstractMaterialNode>().Count());
            Assert.IsTrue(graph.GetNodes<AbstractMaterialNode>().Contains(node));
        }
        ...
        public void TestCanAddSlotToTestNode()
        {
            ...
            Assert.AreEqual(1, found.GetInputSlots<MaterialSlot>().FirstOrDefault().slotId);
            Assert.AreEqual(1, found.GetOutputSlots<MaterialSlot>().Count());
            Assert.AreEqual(0, found.GetOutputSlots<MaterialSlot>().FirstOrDefault().slotId);
        ...
        public void TestCanFindSlotReferenceOnTestNode()
        {
            ...
            Assert.IsNotNull(node.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.IsNotNull(node.FindSlot<MaterialSlot>(TestableNode.Output0));
            Assert.Throws<ArgumentException>(() => node.FindSlot<MaterialSlot>(555));
        }
        ...
        public void TestCanConnectAndTraverseTwoNodesOnBaseMaterialGraph()
        {
            ...
            var foundOutputNode = edge.outputSlot.owner;
            ...
            var foundInputNode = edge.inputSlot.owner;
        ...
        public void TestCanConnectAndTraverseThreeNodesOnBaseMaterialGraph()
        {
            ...
            graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), middleNode.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.AreEqual(1, graph.edges.Count());

            graph.Connect(middleNode.FindSlot<MaterialSlot>(TestableNode.Output0), inputNode.FindSlot<MaterialSlot>(TestableNode.Input0));
        ...
        public void TestConectionToSameInputReplacesOldInput()
        {
            ...
            var createdEdge2 = graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), inputNode.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.AreEqual(1, graph.edges.Count());
        ...
        public void TestRemovingSlotRemovesConnectedEdges()
        {
            ...
            graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), inputNode.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.AreEqual(1, graph.edges.Count());
        ...
        public void TestCanNotConnectToNullSlot()
        {
            ...
            var createdEdge2 = graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), null);
            Assert.AreEqual(0, graph.edges.Count());
        ...
        public void TestCanNotConnectTwoOuputSlotsOnBaseMaterialGraph()
        {
            ...
            var createdEdge = graph.Connect(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0), outputNode2.FindSlot<MaterialSlot>(TestableNode.Output0));
        ...
        public void TestCanNotConnectTwoInputSlotsOnBaseMaterialGraph()
        {
            ...
            var createdEdge = graph.Connect(inputNode.FindSlot<MaterialSlot>(TestableNode.Input0), inputNode2.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.IsNull(createdEdge);
            Assert.AreEqual(0, graph.edges.Count());
        }
        ...
        public void TestCanGetEdgesOnBaseMaterialGraphFromSlotReference()
        {
            ...
            Assert.AreEqual(1, graph.GetEdges(inputNode.FindSlot<MaterialSlot>(TestableNode.Input0)).Count());
            Assert.AreEqual(1, graph.GetEdges(outputNode.FindSlot<MaterialSlot>(TestableNode.Output0)).Count());
            Assert.Throws<ArgumentException>(() => outputNode.FindSlot<MaterialSlot>(666));
        }
        ...
        public void TestGetInputsWithNoConnection()
        {
            ...
            CollectionAssert.AreEqual(new[] { TestableNode.Input1, TestableNode.Input2 }, slots.Select(x => x.slotId));
        }
        ...
        public void TestCyclicConnectionsAreNotAllowedOnGraph()
        {
            ...
            Assert.AreEqual(2, graph.GetNodes<AbstractMaterialNode>().Count());
            graph.Connect(nodeA.FindSlot<MaterialSlot>(TestableNode.Output0), nodeB.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.AreEqual(1, graph.edges.Count());

            var edge = graph.Connect(nodeB.FindSlot<MaterialSlot>(TestableNode.Output0), nodeA.FindSlot<MaterialSlot>(TestableNode.Input0));
            Assert.IsNull(edge);
            Assert.AreEqual(1, graph.edges.Count());
        }
    }
