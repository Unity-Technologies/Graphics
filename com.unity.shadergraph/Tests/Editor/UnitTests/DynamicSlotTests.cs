...
namespace UnityEditor.ShaderGraph.UnitTests
{
    ...
    class DynamicSlotTests
    {
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn2));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
            Assert.AreEqual(ConcreteSlotValueType.Vector1, dynOut1.concreteValueType);
        }
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V2Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn2));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V3Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn2));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V1Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V4Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn2));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V2Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
            Assert.AreEqual(ConcreteSlotValueType.Vector2, dynOut1.concreteValueType);
        }
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V3Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
            Assert.AreEqual(ConcreteSlotValueType.Vector3, dynOut1.concreteValueType);
        }
        ...
        {
            m_Graph.Connect(m_StaticNode.FindSlot<MaterialSlot>(TestNode.V4Out), m_DynamicNode.FindSlot<MaterialSlot>(DynamicNode.DynIn1));
            var dynOut1 = m_DynamicNode.FindOutputSlot<MaterialSlot>(DynamicNode.DynOut);
            Assert.AreEqual(ConcreteSlotValueType.Vector4, dynOut1.concreteValueType);
        }
