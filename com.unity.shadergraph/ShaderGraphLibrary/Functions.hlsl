...
#ifndef SHADERGRAPH_LOAD_POST_PROCESS_INPUT
#define SHADERGRAPH_LOAD_POST_PROCESS_INPUT(uv) shadergraph_LoadPostProcessInput(uv)
#endif
...
float4 shadergraph_LoadPostProcessInput(float2 uv)
{
    return 0;
}
