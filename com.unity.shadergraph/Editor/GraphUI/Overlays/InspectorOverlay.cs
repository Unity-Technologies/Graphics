...
namespace UnityEditor.ShaderGraph.GraphUI.GraphElements.Views
{
    ...
    class InspectorOverlay : GraphSubWindowOverlay<ModelInspectorView>
    {
        public const string k_OverlayID = "Inspector";
        protected override string elementName => "Inspector";
        protected override string ussRootClassName => "inspector";
