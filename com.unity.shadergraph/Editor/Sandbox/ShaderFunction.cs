...
public class ShaderFunctionSignature : JsonObject
{
    ...
    public struct Parameter
    {
        ...
        //[SerializeField]
        //JsonRef<JsonObject> defaultValue;
...
public class ShaderFunction : ShaderFunctionSignature
{
    ...
    // state
    [SerializeField]
    List<JsonRef<ShaderFunctionSignature>> functions;
    [SerializeField]
    ...
    // constructor is internal, public must use the Builder class instead
    internal ShaderFunction(string name, List<Parameter> parameters, string body, List<JsonRef<ShaderFunctionSignature>> functions, List<string> includePaths) : base(name, parameters)
    {
    ...
    public new class Builder : ShaderFunctionSignature.Builder
    {
        ...
        {
            if (functions == null)
                functions = new List<JsonRef<ShaderFunctionSignature>>();
            functions.Add(func);
