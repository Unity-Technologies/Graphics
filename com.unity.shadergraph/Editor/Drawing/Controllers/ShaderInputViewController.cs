        ...
        void ChangePropertyValue(GraphData graphData)
        {
            ...
            switch (shaderInputReference)
            {
                case BooleanShaderProperty booleanProperty:
                    ...
                    if (graphData.material) graphData.material.SetFloat(shaderInputReference.referenceName, booleanProperty.value ? 1.0f : 0.0f);
                    break;
                case Vector1ShaderProperty vector1Property:
                    vector1Property.value = (float)newShaderInputValue;
                    if (graphData.material) graphData.material.SetFloat(shaderInputReference.referenceName, vector1Property.value);
                    break;
                case Vector2ShaderProperty vector2Property:
                    vector2Property.value = (Vector2)newShaderInputValue;
                    if (graphData.material) graphData.material.SetVector(shaderInputReference.referenceName, vector2Property.value);
                    break;
                case Vector3ShaderProperty vector3Property:
                    vector3Property.value = (Vector3)newShaderInputValue;
                    if (graphData.material) graphData.material.SetVector(shaderInputReference.referenceName, vector3Property.value);
                    break;
                case Vector4ShaderProperty vector4Property:
                    vector4Property.value = (Vector4)newShaderInputValue;
                    if (graphData.material) graphData.material.SetVector(shaderInputReference.referenceName, vector4Property.value);
                    break;
                case ColorShaderProperty colorProperty:
                    colorProperty.value = (Color)newShaderInputValue;
                    if (graphData.material) graphData.material.SetColor(shaderInputReference.referenceName, colorProperty.value);
                    break;
                case Texture2DShaderProperty texture2DProperty:
                    texture2DProperty.value.texture = (Texture)newShaderInputValue;
                    if (graphData.material) graphData.material.SetTexture(shaderInputReference.referenceName, texture2DProperty.value.texture);
                    break;
                case Texture2DArrayShaderProperty texture2DArrayProperty:
                    texture2DArrayProperty.value.textureArray = (Texture2DArray)newShaderInputValue;
                    if (graphData.material) graphData.material.SetTexture(shaderInputReference.referenceName, texture2DArrayProperty.value.textureArray);
                    break;
                case Texture3DShaderProperty texture3DProperty:
                    texture3DProperty.value.texture = (Texture3D)newShaderInputValue;
                    if (graphData.material) graphData.material.SetTexture(shaderInputReference.referenceName, texture3DProperty.value.texture);
                    break;
                case CubemapShaderProperty cubemapProperty:
                    cubemapProperty.value.cubemap = (Cubemap)newShaderInputValue;
                    if (graphData.material) graphData.material.SetTexture(shaderInputReference.referenceName, cubemapProperty.value.cubemap);
                    break;
