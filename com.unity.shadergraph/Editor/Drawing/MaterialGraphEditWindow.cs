...
namespace UnityEditor.ShaderGraph.Drawing
{
    public class MaterialGraphEditWindow : EditorWindow
    {
        ...
        public void ToSubGraph()
        {
            ...
            var externalInputNeedingConnection = new List<KeyValuePair<EdgeData, IShaderProperty>>();
            foreach (var group in uniqueIncomingEdges)
            {
                ...
                if (prop != null)
                {
                    ...
                    foreach (var edge in group.edges)
                    {
                        ...
                        externalInputNeedingConnection.Add(new KeyValuePair<EdgeData, IShaderProperty>(edge, prop));
                    }
                }
            }
        ...
        public void Initialize(string assetGuid)
        {
            try
            {
                ...
                graphEditorView = new GraphEditorView(this, m_GraphObject.graph, asset.name) { persistenceKey = selectedGuid };
