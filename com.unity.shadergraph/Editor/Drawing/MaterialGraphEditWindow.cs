...
namespace UnityEditor.ShaderGraph.Drawing
{
    class MaterialGraphEditWindow : EditorWindow
    {
        ...
        public void ToSubGraph()
        {
            ...
            //         graphView.selection.OfType<Edge>().Select(x => x.userData as EdgeData),
            //         graphInputs,
            //         metaProperties,
            //         metaKeywords,
            ...
            //
            //     if (!groupGuids.Contains(node.group))
            //     {
            //         groupGuids.Add(node.group);
            //     }
            //
            //     // Checking if the group guid is also being copied.
            //     // If not then nullify that guid
            //     if (node.group != Guid.Empty)
            //     {
            //         node.group = !groupGuidMap.ContainsKey(node.group) ? Guid.Empty : groupGuidMap[node.group];
            //     }
            //
            ...
            // var externalOutputSlots = new List<EdgeData>();
            // var externalInputSlots = new List<EdgeData>();
            ...
            //
            // var externalInputNeedingConnection = new List<KeyValuePair<EdgeData, AbstractShaderProperty>>();
            //
            ...
            //     var fromNode = graphObject.sr.owner;
            ...
            //             externalInputNeedingConnection.Add(new KeyValuePair<EdgeData, AbstractShaderProperty>(edge, prop));
            //         }
            //     }
            // }
            //
            ...
            //
            // var externalOutputsNeedingConnection = new List<KeyValuePair<EdgeData, EdgeData>>();
            // foreach (var group in uniqueOutgoingEdges)
            // {
            //     var outputNode = subGraph.outputNode as SubGraphOutputNode;
            //
            //     AbstractMaterialNode node = graphView.group.edges[0].outputSlot.owner;
            ...
            //         externalOutputsNeedingConnection.Add(new KeyValuePair<EdgeData, EdgeData>(edge, newEdge));
            //     }
            // }
            //
