...
{
    static class PreviewSubShaderResources
    {
        public static string s_ResourceClassName => typeof(PreviewSubShaderResources).FullName;

        public static string s_AssemblyName => typeof(PreviewSubShaderResources).Assembly.FullName.ToString();
