...
namespace UnityEditor.ShaderGraph
{
    ...
    class ShaderSubGraphImporter : ScriptedImporter
    {
        ...
        static void ProcessSubGraph(SubGraphAsset asset, GraphData graph)
        {
            ...
            // TODO: why are there two different precisions here?
            asset.graphPrecision = graph.concretePrecision;         // is this assumed input precision?
            ...
            // NOTE: actual concrete precision here shouldn't matter, it's irrelevant when building subgraph asset
            registry.ProvideFunction(asset.functionName, asset.subGraphGraphPrecision, asset.outputPrecision, sb =>
            {
                ...
                {
                    // this is really "inject" graph precision for "inherit"
                ...
                using (sb.BlockScope())
                {
                    ...
                    foreach (var node in nodes)
                    {
                        if (node is IGeneratesBodyCode generatesBodyCode)
                        {
                            ...
                            // wait wait -- this gets rid of ALL $precision tokens in generated SubGraph function
                            // but we want to preserve them when the node is set to inherit...
