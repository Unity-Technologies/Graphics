...
namespace UnityEditor.ShaderGraph.GraphDelta
{
    ...
    public class HeadlessPreviewManager
    {
        ...
        /// </summary>
        /// <returns> List of GUIDs describing all nodes that were affected by this change </returns>
        /// <remarks> Dirties the preview render state of all nodes downstream of any references to the changed property </remarks>
        public List<string> SetGlobalProperty(string propertyGUID, object newPropertyValue)
		{
			return null;
		}
        ...
        /// <returns> List of GUIDs describing all nodes that were affected by this change </returns>
        /// <remarks> Dirties the preview render state of all nodes downstream of any references to the changed property </remarks>
        public List<string> SetLocalProperty(string nodeGUID, string portGUID, object newPropertyValue)
		{
			return null;
		}
        ...
        public List<string> NotifyNodeFlowChanged(string nodeGUID)
		{
			return null;
		}
        ...
        /// </summary>
        /// <returns> Texture that contains the current preview output of a node </returns>
        public Texture GetNodePreviewImage(string nodeGUID, PreviewRenderMode nodePreviewMode = PreviewRenderMode.Preview2D)
		{
            if (m_CachedPreviewData.ContainsKey(nodeGUID))
            {

            }
            else
            {
                AddNodePreviewData(nodeGUID);
            }
        ...
        public Material GetNodePreviewMaterial(string nodeGUID)
		{
			return null;
		}
        ...
        public string GetNodePreviewShaderCode(string nodeGUID)
		{
			return null;
		}
        ...
        public Material GetMasterPreviewMaterial()
		{
			return null;
		}
        ...
        public string GetMasterPreviewShaderCode()
		{
			return null;
		}

        void AddNodePreviewData(string nodeGUID)
        {
