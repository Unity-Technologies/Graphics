...
namespace UnityEditor.ShaderGraph.GraphDelta
{
    public static class GraphDeltaExtensions
    {
        ...
        public static RegistryKey GetRegistryKey(this INodeReader node)
        {
        ...
        public static RegistryKey GetRegistryKey(this IPortReader port)
        {
        ...
        public static RegistryKey GetRegistryKey(this IFieldReader field)
        {
        ...
        public static IEnumerable<string> GetReferences(this GraphHandler handler)
        {
            HashSet<string> references = new();
            foreach(var context in handler.GetNodes().Where(n => n.GetRegistryKey().Equals(ContextBuilder.kRegistryKey)))
        ...
        internal static void SetupContext(this GraphHandler handler, IEnumerable<IContextDescriptor> contexts, Registry registry)
        {
            ...
            INodeWriter previousContextNode = null;
        ...
        //public static void ProcessGraph(this IGraphHandler handler, ShaderFoundry.ShaderContainer container, Registry registry)
        //{
        ...
        //private static ShaderFoundry.Block ProcessContextNode(INodeReader contextNode, IGraphHandler handler, ShaderFoundry.ShaderContainer container, Registry registry)
        //{
        ...
        //        var shaderType = registry.GetTypeBuilder(port.GetRegistryKey()).GetShaderType((IFieldReader)port, container, registry);
        ...
        //        else
        //        {
        //            var init = registry.GetTypeBuilder(port.GetRegistryKey()).GetInitializerList((IFieldReader)port, registry);
        ...
        //private static void ProcessFuncNode(INodeReader node, IGraphHandler handler, HashSet<string> visitedList, ShaderFoundry.ShaderFunction.Builder funcBuilder, ShaderFoundry.ShaderContainer container, Registry registry)
        //{
        ...
        //                var initValue = registry.GetTypeBuilder(port.GetRegistryKey()).GetInitializerList((IFieldReader)port, registry);
        ...
        public static void SetPortField<T>(this INodeWriter node, string portName, string fieldName, T value)
        {
        ...
        public static void SetField<T>(this INodeWriter node, string fieldName, T value)
        {
            IFieldWriter<T> fieldWriter;
            if (!node.TryGetField(fieldName, out fieldWriter))
                node.TryAddField(fieldName, out fieldWriter);
            fieldWriter.TryWriteData(value);
        }
        public static void SetField<T>(this IPortWriter port, string fieldName, T value)
        {
            IFieldWriter<T> fieldWriter;
        ...
        public static void SetField<T>(this IFieldWriter field, string fieldName, T value)
        {
            IFieldWriter<T> fieldWriter;
        ...
        public static bool GetField<T>(this INodeReader node, string fieldName, out T value)
        {
        ...
        public static bool GetField<T>(this IPortReader port, string fieldName, out T value)
        {
        ...
        public static bool GetField<T>(this IFieldReader field, string fieldName, out T value)
        {
        ...
        internal static IPortWriter AddPort<T>(this INodeWriter node, INodeReader userData, string name, bool isInput, Registry registry) where T : ITypeDefinitionBuilder
        {
            return AddPort(node, userData, name, isInput, Registry.ResolveKey<T>(), registry);
        }

        public static IPortWriter AddPort(this INodeWriter node, INodeReader userData, string name, bool isInput, RegistryKey key, Registry registry)
        {
            ...
            builder.BuildType((IFieldReader)userPort, (IFieldWriter)portWriter, registry);
            return portWriter;
        }
    }
}
