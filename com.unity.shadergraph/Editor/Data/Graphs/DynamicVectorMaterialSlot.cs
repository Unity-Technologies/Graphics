...
{
    interface IDynamicDimensionSlot : ISlot
    {
        bool isDynamic { get; }
        string dynamicDimensionGroup { get; } // dimensions must be the same within one group.
        ConcreteSlotValueType concreteValueType { get; }
        bool IsShrank { get; }
        void SetConcreteType(ConcreteSlotValueType concreteType);
    }

    [Serializable]
    class DynamicVectorMaterialSlot : Vector4MaterialSlot
    {
