...
namespace UnityEditor.ShaderGraph.Internal
{
    ...
    public sealed class ColorShaderProperty : AbstractShaderProperty<Color>
    {
        ...
        {
            return $"{hdrTagString}{referenceName}(\"{displayName}\", Color) = ({NodeUtils.FloatToShaderValue(value.r)}, {NodeUtils.FloatToShaderValue(value.g)}, {NodeUtils.FloatToShaderValue(value.b)}, {NodeUtils.FloatToShaderValue(value.a)})";
        }
