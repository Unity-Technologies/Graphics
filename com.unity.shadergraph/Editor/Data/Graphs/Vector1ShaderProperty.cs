        ...
        internal override string GetPropertyBlockString()
        {
            ...
            switch(floatType)
            {
                case FloatType.Slider:
                    return $"{referenceName}(\"{displayName}\", Range({NodeUtils.FloatToShaderValue(m_RangeValues.x)}, {NodeUtils.FloatToShaderValue(m_RangeValues.y)})) = {valueString}";
                case FloatType.Integer:
                    return $"{referenceName}(\"{displayName}\", Int) = {valueString}";
                case FloatType.Enum:
                    return $"{enumTagString}{referenceName}(\"{displayName}\", Float) = {valueString}";
                default:
                    return $"{referenceName}(\"{displayName}\", Float) = {valueString}";
            }
        }
