...
namespace UnityEditor.ShaderGraph
{
    ...
    public struct NodeRef
    {
        ...
        void Validate()
        {
            ...
            {
                throw new InvalidOperationException($"{nameof(NodeRef)} is only valid during the call to {nameof(IShaderNode)}.{nameof(IShaderNode.OnChange)} it was provided for.");
            }
        }
    }
}
