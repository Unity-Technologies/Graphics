...
{
    [Title("Splat", "Splat Min")]
    class SplatMinNode : AbstractMaterialNode, IGeneratesBodyCode, ISplatLoopNode
    {
        public SplatMinNode()
        {
            name = "Splat Max";
        ...
        {
            sb.AppendLine($"{GetVariableNameForSlot(kOutputSlotId)} = min({GetVariableNameForSlot(kOutputSlotId)}, {GetSlotValue(kInputSlotId, generationMode)});");
        }
