...
{
    [Title("Splat", "Splat Max")]
    class SplatMaxNode : AbstractMaterialNode, IGeneratesBodyCode, ISplatLoopNode
    {
        public SplatMaxNode()
        {
            name = "Splat Max";
        ...
        {
            sb.AppendLine($"{GetVariableNameForSlot(kOutputSlotId)} = max({GetVariableNameForSlot(kOutputSlotId)}, {GetSlotValue(kInputSlotId, generationMode)});");
        }
