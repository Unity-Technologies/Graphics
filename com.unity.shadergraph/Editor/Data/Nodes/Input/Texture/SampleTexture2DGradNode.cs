...
{
    [Title("Input", "Texture", "Sample Texture 2D Grad")]
    class SampleTexture2DGradNode : AbstractMaterialNode, IGeneratesBodyCode, IMayRequireMeshUV
    {
        ...
        public const int DDXInputId = 4;
        public const int DDYInputId = 5;
        ...
        const string kDDXInputName = "DDX";
        const string kDDYInputName = "DDY";

        public override bool hasPreview { get { return true; } }

        public SampleTexture2DGradNode()
        {
            name = "Sample Texture 2D Grad";
            synonyms = new string[] { "tex2dgrad" };
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            AddSlot(new Vector2MaterialSlot(DDXInputId, kDDXInputName, kDDXInputName, SlotType.Input, Vector2.zero));
            AddSlot(new Vector2MaterialSlot(DDYInputId, kDDYInputName, kDDYInputName, SlotType.Input, Vector2.zero));
            RemoveSlotsNameNotMatching(new[] { OutputSlotRGBAId, OutputSlotRId, OutputSlotGId, OutputSlotBId, OutputSlotAId, TextureInputId, UVInputId, SamplerInputId, DDXInputId, DDYInputId });
        }
        ...
        public virtual void GenerateNodeCode(ShaderStringBuilder sb, GenerationMode generationMode)
        {
            ...
            var ddxSlot = GetSlotValue(DDXInputId, generationMode);
            var ddySlot = GetSlotValue(DDYInputId, generationMode);
            ...
            sb.AppendLine("#else");
            {
                var result = string.Format("  $precision4 {0} = SAMPLE_TEXTURE2D_GRAD({1}.tex, {2}.samplerstate, {1}.GetTransformedUV({3}), {4}, {5});"
