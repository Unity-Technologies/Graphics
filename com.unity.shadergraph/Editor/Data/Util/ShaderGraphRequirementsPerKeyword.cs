...
namespace Data.Util
{
    sealed class ShaderGraphRequirementsPerKeyword: KeywordDependentCollection<
        ...
        ShaderGraphRequirementsPerKeyword.NoPermutation,
    ...
    >
    {
        ...
        public struct NoPermutation : IRequirements, IRequirementsSet
        {
            private ShaderGraphRequirementsPerKeyword m_Source;
            ...
            public ShaderGraphRequirements requirements
            {
                get => m_Source.noPermutationsStorage;
                set => m_Source.noPermutationsStorage = value;
            }

            public void SetRequirements(ShaderGraphRequirements value) => requirements = value;

            internal NoPermutation(ShaderGraphRequirementsPerKeyword source)
            {
                m_Source = source;
            }
        }
        ...
        public void UnionWith(ShaderGraphRequirementsPerKeyword other)
        {
            ...
            noPermutationsStorage = noPermutationsStorage.Union(other.noPermutationsStorage);
