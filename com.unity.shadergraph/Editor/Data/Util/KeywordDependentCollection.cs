...
namespace Data.Util
{
    ...
    public abstract class KeywordDependentCollection<TStorage, TAll, TAllPermutations, TForPermutation, TNoPermutation, TBase, TIInstance, TISet>
        where TAll: TISet
        where TAllPermutations: TISet
        where TForPermutation: TISet, TIInstance
        where TNoPermutation: TISet, TIInstance
        ...
        where TStorage: new()
    {
        ...
        TStorage m_NoPermutations = new TStorage();
        ...
        public TNoPermutation noPermutation => CreateNoPermutationSmartPointer();
        ...
        protected TStorage noPermutationsStorage
        {
            get => m_NoPermutations;
            set => m_NoPermutations = value;
        }
        ...
        protected abstract TNoPermutation CreateNoPermutationSmartPointer();
