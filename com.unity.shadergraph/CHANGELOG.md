...
- Fixed a bug where the View Direction node did not properly normalize when using Universal Render Pipeline. [1217639](https://issuetracker.unity3d.com/issues/shadergraph-view-direction-node-does-not-output-normalized-vector-in-universal-rp)
