	...
	size = clampedSize;
			...
			ps_input vert (uint id : SV_VertexID, uint instanceID : SV_InstanceID)
			{
				...
				if (flags[index] == 1)
				{
					...
					VFXBlockOrientAlongVelocity( local_front,local_side,local_up,attrib1.velocity,attrib2.position);
					...
					VFXBlockSubPixelAA( local_alpha,attrib2.position,attrib4.size);
