...
namespace UnityEngine.Experimental.ScriptableRenderLoop
{
    ...
    public class TilePass : LightLoop
    {
        ...
        public class LightList
        {
            ...
            public List<SFiniteLightData> bounds;
            ...
            public void Allocate()
            {
                ...
                bounds = new SFiniteLightData();
                lightVolumes = new LightVolumeData();
            }
        }
        ...
        public void GetEnvLightVolumeDataAndBound(VisibleReflectionProbe probe, LightVolumeType lightVolumeType)
        { 
            var bound = new SFiniteLightBound();
            var ligthVolumeData = new LightVolumeData();
        ...
        public void PrepareLightsForGPU(CullResults cullResults, Camera camera, ref ShadowOutput shadowOutput)
        {
            m_lightList.Clear();
            ...
            for (int sortIndex = 0; sortIndex < sortCount; ++sortIndex)
            {
                ...
                GetLightVolumeDataAndBound(gpuLightType, lightVolumeType, light, m_lightList.lights[m_lightList.lights.Count - 1] , worldToView);
            }
            ...
            for (int sortIndex = 0; sortIndex < sortCount; ++sortIndex)
            {
                ...
                GetEnvLightVolumeDataAndBound(probe, lightVolumeType);
            }
        ...
        public override void RenderForward(CullResults cullResults, Camera camera, RenderLoop renderLoop, bool renderOpaque)
        {
