...
static const uint kFeatureVariantFlags[NUM_FEATURE_VARIANTS] =
{
    ...
    /*  0 */ (MATERIAL_FEATURE_MASK_FLAGS & ~MATERIALFEATUREFLAGS_LIT_CLEAR_COAT) | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV,

    // Standard/Specular
    /*  1 */ MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL,
    /*  2 */ MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL | LIGHTFEATUREFLAGS_PUNCTUAL,
    /*  3 */ MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHT_FEATURE_MASK_FLAGS_OPAQUE,

    // SSS + Standard/Specular
    /*  4 */ MATERIALFEATUREFLAGS_LIT_SSS | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL,
    /*  5 */ MATERIALFEATUREFLAGS_LIT_SSS | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL | LIGHTFEATUREFLAGS_PUNCTUAL,
    /*  6 */ MATERIALFEATUREFLAGS_LIT_SSS | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHT_FEATURE_MASK_FLAGS_OPAQUE,

    // Aniso + Standard/Specular
    /*  7 */ MATERIALFEATUREFLAGS_LIT_ANISO | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL,
    /*  8 */ MATERIALFEATUREFLAGS_LIT_ANISO | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL | LIGHTFEATUREFLAGS_PUNCTUAL,
    /*  9 */ MATERIALFEATUREFLAGS_LIT_ANISO | MATERIALFEATUREFLAGS_LIT_STANDARD | LIGHT_FEATURE_MASK_FLAGS_OPAQUE,

    // ClearCoat
    /* 10 */ MATERIALFEATUREFLAGS_LIT_CLEAR_COAT | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL,
    /* 11 */ MATERIALFEATUREFLAGS_LIT_CLEAR_COAT | LIGHTFEATUREFLAGS_SKY | LIGHTFEATUREFLAGS_ENV | LIGHTFEATUREFLAGS_DIRECTIONAL | LIGHTFEATUREFLAGS_PUNCTUAL,
    /* 12 */ MATERIALFEATUREFLAGS_LIT_CLEAR_COAT | LIGHT_FEATURE_MASK_FLAGS_OPAQUE,

    /* 13 */ LIGHT_FEATURE_MASK_FLAGS_OPAQUE | MATERIAL_FEATURE_MASK_FLAGS, // Catch all case with MATERIAL_FEATURE_MASK_FLAGS is needed in case we disable material classification
};
