...
void GetSurfaceAndBuiltinData(FragInputs input, float3 V, inout PositionInputs posInput, out SurfaceData surfaceData, out BuiltinData builtinData)
{
	...
	//---------------------
	float3 normalTS;
	GetSurfaceData(input, layerTexCoord, surfaceData, normalTS);
	input.texCoord0 = EyeUvs(input.texCoord0, _IrisDepth, _IrisRadius, _Ior, input.worldToTangent[2].xyz, V);
	//---------------------
